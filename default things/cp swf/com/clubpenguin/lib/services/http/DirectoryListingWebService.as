...
package com.clubpenguin.lib.services.http
{
    ...
    public class DirectoryListingWebService extends HTTPServiceRequest 
    {
        ...
        private static const DIRECTORY_SERVICE_LIVE:String = "/services";//"http://directory.clubpenguin.com/services"
        private static const DIRECTORY_SERVICE_STAGE:String = "/services";//"http://stage-directory.clubpenguin.com/services"
        private static const DIRECTORY_SERVICE_QA:String = "/services";//"http://n7vgq2clubpdir.general.disney.private/services"
        private static const DIRECTORY_SERVICE_DEV:String = "/services";//"http://n7vgi1clubpdir.general.disney.private/services"
