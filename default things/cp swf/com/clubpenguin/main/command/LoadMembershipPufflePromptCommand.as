...
package com.clubpenguin.main.command
{
    ...
    public class LoadMembershipPufflePromptCommand extends SignalCommand 
    {
        ...
        private var overlayVO:MembershipOverlayVO = new MembershipOverlayVO();
        ...
        private function showOverlay(displayObject:DisplayObject):void
        {
            ...
            Signal(this.signalBus.showMembershipPufflePrompt).dispatch(this.overlayVO);
            this.overlayVO = null;
        }
