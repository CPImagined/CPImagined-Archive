//Created by Action Script Viewer - https://www.buraks.com/asv
    class com.clubpenguin.world.rooms.CaveMine extends com.clubpenguin.world.rooms.BaseRoom
    {
        ...
        function onRevealGoldPuffleTrigger() {
            ...
            } else if (isMaxPuffles() || (isNotEnoughGoldNuggets())) {
        ...
        function isNotEnoughGoldNuggets() {
            var _local_2 = _SHELL.getMyPlayerObject();
            if ((_local_2.currencies[_SHELL.CURRENCY_TYPE_GOLD_NUGGETS] == undefined) || (_local_2.currencies[_SHELL.CURRENCY_TYPE_GOLD_NUGGETS] == null)) {
                return(true);
            }
            return(_local_2.currencies[_SHELL.CURRENCY_TYPE_GOLD_NUGGETS] < TOTAL_GOLD_NUGGETS_TO_COLLECT);
        }
        function destroy() {
