//Created by Action Script Viewer - https://www.buraks.com/asv
    class com.clubpenguin.world.rooms2014.frozen.party.FrozenParty_InterfaceOverrides
    {
        ...
        function updateAvatarCard(_arg_5) {
            ...
            if (_local_4.hasCustomPlayerCard) {
                ...
                if (_local_4.dynamicPlayerCardLabelFunc != null) {
                    _local_3.PLAYER_WIDGET.art_mc.avatarCard.gotoAndStop(_local_4.dynamicPlayerCardLabelFunc(_arg_5));
                } else {
                    _local_3.PLAYER_WIDGET.art_mc.avatarCard.gotoAndStop("id" + _arg_5.avatarVO.avatar_id);
                }
                if (_local_3.PLAYER_WIDGET.art_mc.avatarCard.avatarClip._totalFrames > 1) {
                    _local_3.PLAYER_WIDGET.art_mc.avatarCard.avatarClip.gotoAndStop(_arg_5.colour_id + 1);
                }
                if (_arg_5.player_id == _local_3.SHELL.getMyPlayerId()) {
            ...
            if (_local_3.SHELL.isMyPlayer(_arg_5.player_id)) {
        ...
        function sendEmote(_arg_6) {
            var _local_7 = _global.getCurrentShell();
            var _local_9 = _global.getCurrentEngine();
            var _local_4 = _global.getCurrentParty();
            var _local_8 = this;
            _local_7.sendEmote(_arg_6);
            _local_8.showEmoteBalloon(_local_8.getPlayerId(), _arg_6);
            ...
            if (((_local_3 > 0) && (_local_3 != undefined)) && (_arg_6 == _local_4.FrozenParty.CONSTANTS.HEART_EMOTE_ID)) {
