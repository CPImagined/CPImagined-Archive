//Created by Action Script Viewer - https://www.buraks.com/asv
    class com.clubpenguin.util.Vector
    {
        var x, y;
        ...
        function getClone() {
            return(new com.clubpenguin.util.Vector(x, y));
        }
        function plus(v) {
            x = x + v.x;
            y = y + v.y;
        ...
        function plusNew(v) {
            return(new com.clubpenguin.util.Vector(x + v.x, y + v.y));
        }
        function minus(v) {
            x = x - v.x;
            y = y - v.y;
        ...
        function scaleNew(s) {
            return(new com.clubpenguin.util.Vector(x * s, y * s));
        }
        function get length() {
        ...
        function rotateNew(ang) {
            var _local_2 = new com.clubpenguin.util.Vector(x, y);
            _local_2.rotate(ang);
            return(_local_2);
        }
        ...
        function getNormal() {
            return(new com.clubpenguin.util.Vector(-y, x));
        }
