//Created by Action Script Viewer - https://www.buraks.com/asv
    class com.clubpenguin.util.Line
    {
        ...
        function getVector() {
            return(new com.clubpenguin.util.Vector(x2 - x1, y2 - y1));
        }
        function draw(mc) {
            mc.lineStyle(1, 0);
            mc.moveTo(x1, y1);
        ...
        static function getGlobalIntersect(line1, line2) {
            ...
            if (!_local_7) {
                return(new com.clubpenguin.util.Vector(_local_1, (_local_5 * (_local_1 - _local_2)) + _local_8));
            } else if (!_local_6) {
                return(new com.clubpenguin.util.Vector(_local_2, (_local_4 * (_local_2 - _local_1)) + _local_3));
            }
            ...
            return(new com.clubpenguin.util.Vector(_local_11, _local_12));
        }
