//Created by Action Script Viewer - https://www.buraks.com/asv
    class com.clubpenguin.world.rooms.StadiumSoccer extends com.clubpenguin.world.rooms.Stadium
    {
        var _SHELL, _AIRTOWER, _ENGINE, _stage, _GAME, localize, showContent, setupNavigationButtons, _handleGameMoveDoneDelegate, _handlePlayerMoveDelegate, _handlePlayerMoveDoneDelegate, _handleGetGameDelegate, _handleGameMoveDelegate, exit, wem, _destroyDelegate;
        function StadiumSoccer (stageReference) {
        ...
        function init() {
            ...
            localize([_stage.fishdog_mc, _stage.stadium_mc.banner_mc, _stage.snacks_mc.snackssign_mc, _stage.sports_mc.sportssign_mc, _stage.interface_mc.sports_btn_states, _stage.walls_mc.boards_mc, _stage.wallsoccer_mc]);
            showContent([new com.clubpenguin.world.rooms.common.PopupContentVO(_stage.interface_mc.sports_btn_states.sports_btn, true, "sport_catalogue", "")]);
            setupNavigationButtons([new com.clubpenguin.world.rooms.common.NavigationButtonVO(_stage.door_mc.forts_btn, 390, 190), new com.clubpenguin.world.rooms.common.NavigationButtonVO(_stage.sports_mc.sportdoor_btn, 665, 120), new com.clubpenguin.world.rooms.common.NavigationButtonVO(_stage.fishdog_mc.fishdog_btn, 69, 113), new com.clubpenguin.world.rooms.common.NavigationButtonVO(_stage.bleachers_mc.chair1_btn, 202, 66), new com.clubpenguin.world.rooms.common.NavigationButtonVO(_stage.bleachers_mc.chair2_btn, 238, 63), new com.clubpenguin.world.rooms.common.NavigationButtonVO(_stage.bleachers_mc.chair3_btn, 269, 59), new com.clubpenguin.world.rooms.common.NavigationButtonVO(_stage.bleachers_mc.chair4_btn, 302, 53), new com.clubpenguin.world.rooms.common.NavigationButtonVO(_stage.snacks_mc.snackdoor_btn, 571, 93)]);
            _stage.fishdog_mc.fishdog_btn.useHandCursor = false;
            _stage.bleachers_mc.chair1_btn.useHandCursor = false;
            _stage.bleachers_mc.chair2_btn.useHandCursor = false;
            _stage.bleachers_mc.chair3_btn.useHandCursor = false;
            _stage.bleachers_mc.chair4_btn.useHandCursor = false;
        ...
        static var CLASS_NAME = "StadiumSoccer";
    }
