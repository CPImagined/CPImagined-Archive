...
//Created by Action Script Viewer - http://www.buraks.com/asv
    class com.clubpenguin.achievements.AchievementResult
    {
        ...
        function AchievementResult (shell, descriptor, debug) {
            ...
            debugTrace(((("Constructor - command:" + _local3) + " params:'") + descriptor) + "'");
            switch (_local3) {
                case "trace" : 
                    _callbackFunc = trace;
                ...
                case ACHIEVEMENTRESULT_STAMPEARNED : 
                    ...
                    break;
                default : 
                    throw new com.clubpenguin.achievements.AchievementException(("Result command not recognised:\"" + _local3) + "\"");
                    break;
            }
        }
        function fire() {
