    ...
    class com.clubpenguin.text.TextResize
    {
        ...
        static function scaleDown(_arg_1, _arg_13, _arg_3) {
            if (_arg_1.autoSize != "none") {
                trace("(TextResize): Error, cannont resize fields that have autoSize enabled!\r(textResize): Error occured at " + _arg_1);
                return(undefined);
            }
            ...
            while (_local_4) {
                ...
                if ((_arg_1._width > _local_7) || (_arg_1._height > _local_5)) {
                    ...
                    if (_local_2.size < _arg_3) {
                        trace((((("(TextResize): Error, font size is < " + _arg_3) + "!") + newline) + "(textResize): Error occured at ") + _arg_1);
