class com.disney.dlearning.managers.DLSManager
{
   ...
   function pushOpcode(opcode, guid, callback, register1, register2, register3, register4)
   {
      ...
      _loc3_ = "http://" + com.disney.dlearning.managers.DLSManager.__host + "/v1/opcode/pushOpcode/" + opcode + "/" + com.disney.dlearning.managers.DLSManager.__learnerID + "/" + _loc4_ + "/" + guid + "/" + register1 + "/" + register2 + "/" + register3 + "/" + register4 + "/";
      var _loc7_ = this.encryptURL(_loc3_,_loc4_.toString(),com.disney.dlearning.managers.DLSManager.__developerID) + "|" + this.encryptTime(_loc4_.toString());
      ...
      _loc2_.addRequestHeader("DLSNetwork-Request-Key",_loc7_);
      ...
      {
         trace("Sending debug information over local connection");
   ...
   function pushOpcodeToHost(host, opcode, guid, callback, register1, register2, register3, register4)
   {
      ...
      var _loc4_ = Math.round(_loc6_.getTime() / 1000);
      var _loc3_ = undefined;
      var _loc9_ = this.__URLLoaderCookieId++;
      if(com.disney.dlearning.managers.DLSManager.__learnerID == "")
      {
         com.disney.dlearning.managers.DLSManager.__learnerID = "-1";
      }
      ...
      _loc3_ = "http://" + host + "/v1/opcode/pushOpcode/" + opcode + "/" + com.disney.dlearning.managers.DLSManager.__learnerID + "/" + _loc4_ + "/" + guid + "/" + register1 + "/" + register2 + "/" + register3 + "/" + register4 + "/";
      var _loc7_ = this.encryptURL(_loc3_,_loc4_.toString(),com.disney.dlearning.managers.DLSManager.__developerID) + "|" + this.encryptTime(_loc4_.toString());
      var _loc2_ = new LoadVars();
      _loc2_.callback = callback;
      this.configureListeners(_loc2_);
   ...
   {
      var _loc1_ = opcode.toLowerCase();
      if(_loc1_ == com.disney.dlearning.managers.DLSManager.LEARNER_SCORE.toLowerCase() || _loc1_ == com.disney.dlearning.managers.DLSManager.GAME_SCORE.toLowerCase() || _loc1_ == com.disney.dlearning.managers.DLSManager.START.toLowerCase() || _loc1_ == com.disney.dlearning.managers.DLSManager.STOP.toLowerCase() || _loc1_ == com.disney.dlearning.managers.DLSManager.SELECTED.toLowerCase() || _loc1_ == com.disney.dlearning.managers.DLSManager.PRESENTED.toLowerCase() || _loc1_ == com.disney.dlearning.managers.DLSManager.NOTIFY.toLowerCase() || _loc1_ == com.disney.dlearning.managers.DLSManager.USED.toLowerCase())
      {
         return true;
      }
      return false;
