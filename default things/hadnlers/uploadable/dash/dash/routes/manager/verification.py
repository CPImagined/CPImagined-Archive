...
async def approve_request(request, penguin_id):
    ...
    if language == 'en':
        await Penguin.update.values(approval_en=True,rejection_en=False).where(Penguin.id == penguin.id).gino.status()
        unverified_penguins = await Penguin.query.where(
            (Penguin.approval_en == False) & (Penguin.rejection_en == False)
        ).gino.all()
    elif language == 'de':
        await Penguin.update.values(approval_de=True,rejection_de=False).where(Penguin.id == penguin.id).gino.status()
        unverified_penguins = await Penguin.query.where(
            (Penguin.approval_de == False) & (Penguin.rejection_de == False)
        ).gino.all()
    elif language == 'es':
        await Penguin.update.values(approval_es=True,rejection_es=False).where(Penguin.id == penguin.id).gino.status()
        unverified_penguins = await Penguin.query.where(
            (Penguin.approval_es == False) & (Penguin.rejection_es == False)
        ).gino.all()
    elif language == 'fr':
        await Penguin.update.values(approval_fr=True,rejection_fr=False).where(Penguin.id == penguin.id).gino.status()
        unverified_penguins = await Penguin.query.where(
            (Penguin.approval_fr == False) & (Penguin.rejection_fr == False)
        ).gino.all()
    elif language == 'pt':
        await Penguin.update.values(approval_pt=True,rejection_pt=False).where(Penguin.id == penguin.id).gino.status()
        unverified_penguins = await Penguin.query.where(
            (Penguin.approval_pt == False) & (Penguin.rejection_pt == False)
        ).gino.all()
    elif language == 'ru':
        await Penguin.update.values(approval_ru=True,rejection_ru=False).where(Penguin.id == penguin.id).gino.status()
        unverified_penguins = await Penguin.query.where(
            (Penguin.approval_ru == False) & (Penguin.rejection_ru == False)
        ).gino.all()
    else:
...
async def reject_request(request, penguin_id):
    ...
    if not penguin:
        return response.text('You must provide a valid penguin ID.')
    if language == 'en':
        await Penguin.update.values(rejection_en=True,approval_en=False).where(Penguin.id == penguin.id).gino.status()
        unverified_penguins = await Penguin.query.where(
            (Penguin.approval_en == False) & (Penguin.rejection_en == False)
        ).gino.all()
    elif language == 'de':
        await Penguin.update.values(rejection_de=True,approval_de=False).where(Penguin.id == penguin.id).gino.status()
        unverified_penguins = await Penguin.query.where(
            (Penguin.approval_de == False) & (Penguin.rejection_de == False)
        ).gino.all()
    elif language == 'es':
        await Penguin.update.values(rejection_es=True,approval_es=False).where(Penguin.id == penguin.id).gino.status()
        unverified_penguins = await Penguin.query.where(
            (Penguin.approval_es == False) & (Penguin.rejection_es == False)
        ).gino.all()
    elif language == 'fr':
        await Penguin.update.values(rejection_fr=True,approval_fr=False).where(Penguin.id == penguin.id).gino.status()
        unverified_penguins = await Penguin.query.where(
            (Penguin.approval_fr == False) & (Penguin.rejection_fr == False)
        ).gino.all()
    elif language == 'pt':
        await Penguin.update.values(rejection_pt=True,approval_pt=False).where(Penguin.id == penguin.id).gino.status()
        unverified_penguins = await Penguin.query.where(
            (Penguin.approval_pt == False) & (Penguin.rejection_pt == False)
        ).gino.all()
    elif language == 'ru':
        await Penguin.update.values(rejection_ru=True,approval_ru=False).where(Penguin.id == penguin.id).gino.status()
        unverified_penguins = await Penguin.query.where(
            (Penguin.approval_ru == False) & (Penguin.rejection_ru == False)
        ).gino.all()
    else:
