//Created by Action Script Viewer - https://www.buraks.com/asv
    class com.clubpenguin.net.Airtower
    {
        ...
        function handleOnLogin(serverResponse) {
            ...
            loginObject.languageApproved = _local_3[5];
            loginObject.languageRejected = _local_3[6];
            loginObject.friendsLoginKey = serverResponse[3];
            loginObject.confirmationHash = serverResponse[2];
            loginObject.emailAddress = serverResponse[6];
            if (serverResponse[7] != null) {
                var _local_4 = serverResponse[7].split("|");
                loginObject.remaining_hours = _local_4[0];
                loginObject.trialMax = _local_4[1];
                loginObject.max_grace_hours = _local_4[2];
                var _local_5 = new Object();
                _local_5.modalBackgroundEnbaled = true;
                _local_5.blockPuffleNotifications = true;
                _local_5.hideLoadingDialog = true;
                var _local_6 = new Object();
                _local_6.state = FRAME_LABEL_WELCOME;
                _local_6.trialRemaining = _local_4[0];
                _local_6.trialMax = _local_4[1];
                _local_6.graceMax = _local_4[2];
                _local_6.confirmationHash = loginObject.confirmationHash;
                _local_6.loginDataRaw = loginObject.loginDataRaw;
                shell.sendOpenAS3Module("preactivation", _local_6, _local_5);
                flash.external.ExternalInterface.call("showActivationBanner", _local_4[0]);
            }
            ...
            shell.setWorldsWithBuddies(serverResponse[5]);
