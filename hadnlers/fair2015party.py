...
StartParty = datetime(2022, 2, 11, 00, 00, 0)#date[year month day hour minute sec] for start party
EndParty = datetime(2022, 2, 27, 00, 00, 0)#date[year month day hour minute sec] for end party
