...
StartParty = datetime(2020, 10, 17, 00, 0, 0)#date[year month day hour minute sec] for start party
EndParty = datetime(2020, 11, 20, 00, 0, 0)#date[year month day hour minute sec] for end party

CookieHandlerName = "party"
PartyCacheCurrent = "halloween"
