...
StartParty = datetime(2020, 11, 30, 00, 0, 0)#date[year month day hour minute sec] for start party
EndParty = datetime(2021, 1, 10, 00, 0, 0)#date[year month day hour minute sec] for end party

CookieHandlerName = "party"
PartyCacheCurrent = "holidayparty"
