...
CookieHandlerId = 20151101

StartParty = datetime(2021, 9, 14, 00, 0, 0)#date[year month day hour minute sec] for start party
EndParty = datetime(2021, 12, 1, 00, 0, 0)#date[year month day hour minute sec] for end party

CookieHandlerName = "party"
PartyCacheCurrent = "operationcrustacean"

DefaultPartyCookie = {
    'msgViewedArray': [0] * 20,
    'communicatorMsgArray': [0] * 20,
    'questTaskStatus': [0] * 20
}
