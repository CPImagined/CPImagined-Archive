...
package com.clubpenguin.newspaper.events
{
    ...
    import com.disney.disneylearning.managers.NewsPaperDLSManager;
    ...
    public class ContentButtonEvent extends Event 
    {
        ...
        private function buttonNavigationCheck(_arg_1:String):void
        {
            ...
            {
                case TOPTIPS:
                    NewsPaperDLSManager.instance.pushOpcode(OpcodeJournal.SELECTEDSTATUS, OpcodeJournal.NEWSPAPERTOCTOPTIPS, this.dlsmcallback, "0", null);
                    return;
                case FEATURESTORY:
                    NewsPaperDLSManager.instance.pushOpcode(OpcodeJournal.SELECTEDSTATUS, OpcodeJournal.NEWSPAPERTOCFEATURESTORY, this.dlsmcallback, "0", null);
                    return;
                case JOKESANDRIDDLES:
                    NewsPaperDLSManager.instance.pushOpcode(OpcodeJournal.SELECTEDSTATUS, OpcodeJournal.NEWSPAPERTOCJOKESANDRIDDLES, this.dlsmcallback, "0", null);
                    return;
                case UPCOMINGEVENTS:
                    NewsPaperDLSManager.instance.pushOpcode(OpcodeJournal.SELECTEDSTATUS, OpcodeJournal.NEWSPAPERTOCUPCOMINGEVENTS, this.dlsmcallback, "0", null);
                    return;
                case SUBMITYOURCONTENT:
                    NewsPaperDLSManager.instance.pushOpcode(OpcodeJournal.SELECTEDSTATUS, OpcodeJournal.NEWSPAPERSUBMIT, this.dlsmcallback, "0", null);
                    return;
                case SUBMITCONTENTFORM:
                    NewsPaperDLSManager.instance.pushOpcode(OpcodeJournal.SELECTEDSTATUS, OpcodeJournal.NEWSPAPERSUBMIT, this.dlsmcallback, "0", null);
                    return;
                case RIDDLEANSWERS:
                    NewsPaperDLSManager.instance.pushOpcode(OpcodeJournal.SELECTEDSTATUS, OpcodeJournal.RIDDLEANSWERS, this.dlsmcallback, "0", null);
                    return;
                case CONTINUEONNEXTPAGE:
                    NewsPaperDLSManager.instance.pushOpcode(OpcodeJournal.SELECTEDSTATUS, OpcodeJournal.NEWSPAPERTURNPAGE, this.dlsmcallback, "0", null);
                    return;
                default:
