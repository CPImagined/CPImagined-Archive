...
CookieHandlerId = 20170201

CookieHandlerName = "party"
PartyCacheCurrent = "waddleonparty"
...
async def handle_get_partysettings(p):
    if (IsPartyEnabled !=False) :
        ...
        await p.send_partypacket('partyservice', '{"partySettings":{"unlockDayIndex":16,"numOfDaysInParty":16},"partyStartDate":"2017-01-01 00:00:00","partyEndDate":"2017-03-30 00:00:00"}')
