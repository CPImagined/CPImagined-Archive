//Created by Action Script Viewer - https://www.buraks.com/asv
    class com.clubpenguin.world.rooms.BaseRoom
    {
        ...
        var _stage, _AIRTOWER, _SHELL, _ENGINE, _INTERFACE, _destroyFunc, roomEnvironmentManager, _invitationManager, soundManagerReady, _soundManager;
        ...
        function localize(globalAssets) {
            ...
            while (_local_2 < globalAssets.length) {
                com.clubpenguin.util.Log.info((("globalAssets[" + _local_2) + "]: ") + globalAssets[_local_2]);
        ...
        function setupNavigationButtons(navigationButtons) {
            ...
            while (_local_2 < navigationButtons.length) {
                com.clubpenguin.util.Log.info((("setupNavigationButtons navigationButtons[" + _local_2) + "]: ") + navigationButtons[_local_2]["button"]);
        ...
        function showContent(content) {
            ...
            while (_local_2 < content.length) {
                com.clubpenguin.util.Log.info((("showContent.content[" + _local_2) + "]: ") + content[_local_2]["button"]);
        ...
        function setupHint(hints) {
            ...
            while (_local_2 < hints.length) {
                com.clubpenguin.util.Log.info((("setupHint.hints[" + _local_2) + "].button: ") + hints[_local_2]["button"]);
                com.clubpenguin.util.Log.info("\t\t\t\t   anchor: " + hints[_local_2].anchor);
        ...
        function setupTableGame(stage, tableObjects) {
            ...
            while (_local_2 < tableObjects.length) {
                com.clubpenguin.util.Log.info((("setupTableGame.tableObjects[" + _local_2) + "]: ") + tableObjects[_local_2].tableClip);
