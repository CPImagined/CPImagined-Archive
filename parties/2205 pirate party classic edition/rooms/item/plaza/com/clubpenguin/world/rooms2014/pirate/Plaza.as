//Created by Action Script Viewer - https://www.buraks.com/asv
    ...
    {
        var _stage, _INTERFACE, _AIRTOWER, _SHELL, _destroyDelegate, _triggerWatcher, setupNavigationButtons, localize, _triggerWatcherInterval;
        ...
        function init() {
			...
			showContent([new com.clubpenguin.world.rooms.common.PopupContentVO(_stage.lore_btn, true, "christmasposter", "")]);
		...
		function chest() {
            _INTERFACE.showContent("piratechestplaza");
        }
