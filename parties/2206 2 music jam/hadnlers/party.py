...
StartParty = datetime(2022, 6, 15, 00, 0, 0)#date[year month day hour minute sec] for start party
EndParty = datetime(2022, 7, 5, 00, 0, 0)#date[year month day hour minute sec] for end party

CookieHandlerName = "party"
PartyCacheCurrent = "musicjam2022"
