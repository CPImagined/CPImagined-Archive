...
StartParty = datetime(2022, 6, 27, 00, 00, 0)#date[year month day hour minute sec] for start party
EndParty = datetime(2023, 7, 30, 00, 00, 0)#date[year month day hour minute sec] for end party

CookieHandlerName = "halloween"
PartyCacheCurrent = "halloween22" #if you have a repeated party, it is advisable to make a different name every time
