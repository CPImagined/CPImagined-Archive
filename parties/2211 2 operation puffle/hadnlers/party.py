...
StartParty = datetime(2022, 11, 18, 00, 00, 0)#date[year month day hour minute sec] for start party
EndParty = datetime(2023, 11, 20, 00, 00, 0)#date[year month day hour minute sec] for end party

CookieHandlerName = "epfparty"
PartyCacheCurrent = "operationpuffle22" #if you have a repeated party, it is advisable to make a different name every time
