//Created by Action Script Viewer - https://www.buraks.com/asv
    class as_files.Coffee extends com.clubpenguin.world.rooms.BaseRoom
    {
        ...
        function init() {
            ...
            _stage.yearBook_btn.onRelease = com.clubpenguin.util.Delegate.create(this, showYearBook);
            _stage.yearBook_btn.onRollOver = com.clubpenguin.util.Delegate.create(this, bookLightUp);
            _stage.yearBook_btn.onRollOut = com.clubpenguin.util.Delegate.create(this, bookLightOff);
			...
			_stage.triggers_mc.bob_mc.triggerFunction = com.clubpenguin.util.Delegate.create(this, pickUpRedNose);
        ...
        function bookLightUp() {
            _stage.book_mc.gotoAndStop(2);
        }
        function bookLightOff() {
            _stage.book_mc.gotoAndStop(1);
        }
        function hatLightUp() {
            _stage.hat1_mc.gotoAndStop(2);
        }
        function hatLightOff() {
            _stage.hat1_mc.gotoAndStop(1);
        }
        function getFreeItem() {
            _INTERFACE.buyInventory("90010");
        }
        function showYearBook() {
            _INTERFACE.showContent("year2122_book");
        }
