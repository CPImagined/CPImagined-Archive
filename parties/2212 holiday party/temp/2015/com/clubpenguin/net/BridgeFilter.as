class com.clubpenguin.net.BridgeFilter
{
   ...
   static function messageIsSentToAS3(airtower, eventType)
   {
      switch(eventType)
      {
         ...
         case com.clubpenguin.net.BridgeFilter.CHECK_PUFFLE_NAME_WITH_RESPONSE:
         case com.clubpenguin.net.BridgeFilter.REQUEST_NAME_SUGGESTION:
         case com.clubpenguin.net.BridgeFilter.GET_DIG_COOLDOWN:
         ...
         case com.clubpenguin.net.BridgeFilter.MUSIC_DELETE_TRACK:
         case com.clubpenguin.net.BridgeFilter.MUSIC_GET_TRACK:
         case com.clubpenguin.net.BridgeFilter.MUSIC_GET_MY_TRACKS:
         case com.clubpenguin.net.BridgeFilter.MUSIC_GET_SHARED_TRACKS:
         case com.clubpenguin.net.BridgeFilter.MUSIC_SHARE_TRACK:
         case com.clubpenguin.net.BridgeFilter.MUSIC_SAVE_TRACK:
         case com.clubpenguin.net.BridgeFilter.MUSIC_BROADCAST_MUSIC_TRACKS:
         case com.clubpenguin.net.BridgeFilter.MUSIC_LIKES_CAN_LIKE_TRACK:
         case com.clubpenguin.net.BridgeFilter.MUSIC_LIKES_SEND_LIKE:
         case com.clubpenguin.net.BridgeFilter.MUSIC_LIKES_ON_LIKE_COUNT:
         case com.clubpenguin.net.BridgeFilter.MUSIC_LIKES_REFRESH:
         case com.clubpenguin.net.BridgeFilter.SOCCER_GAME:
