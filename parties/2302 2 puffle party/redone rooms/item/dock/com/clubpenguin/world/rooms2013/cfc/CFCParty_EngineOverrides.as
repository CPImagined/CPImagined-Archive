//Created by Action Script Viewer - https://www.buraks.com/asv
    class com.clubpenguin.world.rooms2013.cfc.CFCParty_EngineOverrides
    {
        ...
        function sendPlayerFrame(frame) {
            var _local_3 = this;
            trace((("HSF CFC _this = " + _local_3) + " ENGINE:sendUpdateFrame:") + frame);
            var _local_7 = _local_3.SHELL.getMyPlayerId();
            if (_local_3.validateUpdateFrame(_local_7, frame)) {
                ...
                _local_3.updatePlayerFrame(_local_7, frame);
