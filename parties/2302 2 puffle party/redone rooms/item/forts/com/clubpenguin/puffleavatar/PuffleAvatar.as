//Created by Action Script Viewer - https://www.buraks.com/asv
    ...
    {
        var _SHELL, _ENGINE, _frameUpdateEnabled, _isShowPuffle, _puffleModel, _puffleEffectManager, _onPlayerFrameUpdateDelegate, _onPlayerStopMoveDelegate, _onRoomDestroyedDelegate, _puffleClip, _playerId, _roomPuffleHatManager, _playerClip, _assetLoader, _previousFrame;
        ...
        function update() {
            if (puffleAbleToUpdate()) {
                if (_puffleCanMove) {
                    ...
                    if (_puffleModel.hasHat()) {
                        _roomPuffleHatManager.syncHatToPuffle();
                    }
        ...
        function onLoadAssetLoaderInit(loadEvent) {
            ...
            _frameUpdateEnabled = true;
            if (_puffleModel.hasHat()) {
                loadPuffleHat(_puffleModel.hat);
            }
        ...
        function loadPuffleHat(puffleHatVO) {
            _roomPuffleHatManager = new com.clubpenguin.engine.PuffleHatManager(_SHELL, _puffleClip, puffleHatVO, com.clubpenguin.engine.PuffleHatLocEnum.WORLD_HAT_LOC);
            _puffleClip.onEnterFrame = null;
        }
