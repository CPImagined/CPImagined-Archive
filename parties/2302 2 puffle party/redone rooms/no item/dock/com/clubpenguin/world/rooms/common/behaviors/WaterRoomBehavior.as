        ...
        function applyEffect(playerID) {
            ...
            if (_puffleModel) {
                ...
                if (_local_3 < 1) {
                    ...
                    var _local_4 = new com.clubpenguin.engine.puffles.animations.PuffleAnimationLoader(playerID, _puffleModel.id, _SHELL, _ENGINE, true);
                    ...
                    _local_2 = com.clubpenguin.util.StringUtils.replaceString("%color%", _local_6, _local_2);
