    ...
    class com.clubpenguin.world.rooms2013.cfc.trains.TrainController
    {
        ...
        function initTrain() {
            ...
            if (_isLocalPlayerTrain && (_train.driverId != _shell.getMyPlayerId())) {
                trace("HSF DISABLE MOUSE MOVEMENT for " + _shell.getMyPlayerObject().nickname);
            ...
            if (_shell.getMyPlayerId() != _train.driverId) {
                ...
                if ((_local_3._x == 0) && (_local_3._y == 0)) {
                    trace("HSF TrainController: Driver is at 0,0... move driver to myself.");
        ...
        function onPassengersAdded(newPassengers) {
            trace("HSF onPassengersAdded = " + newPassengers);
            var _local_3 = _isLocalPlayerTrain;
            checkIsLocalPlayerTrain();
            if (_isLocalPlayerTrain && (!_local_3)) {
                _engine.disableMouseMovement();
            }
        ...
        function onPassengersRemoved(removedPassengers, removedPassengerSlots) {
            trace("HSF onPassengersRemoved");
            trace("HSF removedPassengers = " + removedPassengers);
            trace("HSF removedPassengerSlots = " + removedPassengerSlots);
        ...
        function addPassengersToMovement(passengers) {
            trace("HSF addPassengersToMovement " + passengers);
            var _local_3 = 0;
        ...
        function removePassengersFromMovement(passengerSlots) {
            trace("HSF removePassengersFromMovement");
            trace("HSF passengerSlots = " + passengerSlots);
            var _local_2 = 0;
