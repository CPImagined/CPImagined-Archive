//Created by Action Script Viewer - https://www.buraks.com/asv
    class com.clubpenguin.world.rooms2013.cfc.trains.TrainLoader
    {
        ...
        static function loadTrainPart(TrainPart, playerObj) {
            ...
            var _local_1 = _local_2.art_mc.getDepth();
            trace("HSF playerDepth = " + _local_1);
            var _local_8 = _local_2.head_mc.getDepth();
            _local_1 = (isFrontTrainPart(TrainPart) ? (Number(_local_8 + 1)) : (Number(_local_1 - 1)));
            var _local_7 = (isFrontTrainPart(TrainPart) ? "trainfront" : "trainback");
            _local_3 = _local_2.createEmptyMovieClip((_local_7 + "_") + playerObj.player_id, _local_1);
