//Created by Action Script Viewer - https://www.buraks.com/asv
    class com.clubpenguin.world.rooms2013.cfc.trains.states.BoardingState extends com.clubpenguin.world.rooms2013.cfc.trains.states.BaseTrainState
    {
        ...
        function onJoinButtonClicked() {
            trace("HSF onJoinButtonClicked");
            trace("HSF _controller.isLocalPlayerTrain = " + _controller.isLocalPlayerTrain);
            trace("HSF _controller = " + _controller);
            if (!_controller.isLocalPlayerTrain) {
                trace("HSF REQUEST JOIN");
                trace("HSF _controller.requestJoinTrain = " + _controller.requestJoinTrain);
