//Created by Action Script Viewer - https://www.buraks.com/asv
    class com.clubpenguin.world.rooms2015.may.CurrentController
    {
        ...
        function CurrentController () {
            com.clubpenguin.world.rooms2015.may.party.MayParty.pebug("!!!!! CREATING CURRENT CONTROLLER ");
        ...
        static function addListeners() {
            com.clubpenguin.world.rooms2015.may.party.MayParty.pebug("[CURRENT CONTROLLER] add listeners");
            _SHELL = _global.getCurrentShell();
            _ENGINE = _global.getCurrentEngine();
            _joinRoomDelegate = com.clubpenguin.util.Delegate.create(com.clubpenguin.world.rooms2015.may.CurrentController, handleJoinRoom);
            _ENGINE.penguinTransformComplete.add(_joinRoomDelegate);
            handleRoomDestroyedDelegate = com.clubpenguin.util.Delegate.create(com.clubpenguin.world.rooms2015.may.CurrentController, handleRoomDestroyed);
            _SHELL.addListener(_SHELL.ROOM_DESTROYED, handleRoomDestroyedDelegate);
            _playerTeleportDelegate = com.clubpenguin.util.Delegate.create(com.clubpenguin.world.rooms2015.may.CurrentController, handlePlayerTeleport);
        ...
        static function handlePlayerTeleport(playerObj) {
            com.clubpenguin.world.rooms2015.may.party.MayParty.pebug("[CURRENT CONTROLLER] handlePlayerTeleport playerObj.player_id " + playerObj.player_id);
            var _local_1 = _ENGINE.getPlayerMovieClip(playerObj.player_id);
            com.clubpenguin.world.rooms2015.may.party.MayParty.pebug("[CURRENT CONTROLLER] handlePlayerTeleport is touching current? " + _triggerArea.hitTest(_local_1._x, _local_1._y, true));
        ...
        static function createCurrentTrigger(triggerArea, roomTriggerWatcher, waypointMC) {
            com.clubpenguin.world.rooms2015.may.party.MayParty.pebug("[CurrentController] createCurrentTrigger ");
            ...
            _local_1.playersAdded.add(com.clubpenguin.util.Delegate.create(com.clubpenguin.world.rooms2015.may.CurrentController, penguinsOnWaterTrigger));
            _local_1.playersRemoved.add(com.clubpenguin.util.Delegate.create(com.clubpenguin.world.rooms2015.may.CurrentController, penguinsRemovedFromWaterTrigger));
        ...
        static function setUpWayPointDetection() {
            ...
            com.clubpenguin.world.rooms2015.may.party.MayParty.pebug("[CurrentController] NUM_WAYPOINTS " + NUM_WAYPOINTS);
        }
        ...
        static function penguinsRemovedFromWaterTrigger(playerList) {
            var _local_1 = 0;
            while (_local_1 < playerList.length) {
                com.clubpenguin.world.rooms2015.may.party.MayParty.pebug("[CurrentController] penguinsRemovedFromWaterTrigger playerList " + playerList[_local_1]);
        ...
        static function sendPlayerToNextWaypoint(player_id) {
            ...
            if ((!isPlayerOnCurrent(player_id)) || (_local_1 >= NUM_WAYPOINTS)) {
                com.clubpenguin.world.rooms2015.may.party.MayParty.pebug("[CurrentController] sendPlayerToNextWaypoint: Player has reached last waypoint ");
                return(undefined);
            }
            var _local_2 = _ENGINE.getPlayerMovieClip(player_id);
            ...
            com.clubpenguin.world.rooms2015.may.party.MayParty.pebug("[CurrentController] addPenguinToCurrent destinationAngle " + _local_3);
            _local_2.onEnterFrame = com.clubpenguin.util.Delegate.create(com.clubpenguin.world.rooms2015.may.CurrentController, movePenguinTowardsNextWaypoint, player_id, _local_4, _local_3, Number(_local_1 + 1));
            frameCounter = 0;
        }
        static function handlePlayerMoveComplete(playerObj) {
            com.clubpenguin.world.rooms2015.may.party.MayParty.pebug("[CurrentController] handlePlayerMoveComplete " + playerObj.player_id);
        ...
        static function movePenguinTowardsNextWaypoint(player_id, destinationPoint, destinationAngle, currentWaypoint) {
            ...
            if ((!isPlayerOnCurrent(player_id)) || ((_SHELL.getMyPlayerId() == player_id) && (_ENGINE.getPlayerAction() == "move"))) {
                ...
                _playerMoveCompleteDelegate = com.clubpenguin.util.Delegate.create(com.clubpenguin.world.rooms2015.may.CurrentController, handlePlayerMoveComplete);
            ...
            if (flash.geom.Point.distance(destinationPoint, new flash.geom.Point(_local_1._x, _local_1._y)) <= 20) {
                delete _local_1.onEnterFrame;
                com.clubpenguin.world.rooms2015.may.party.MayParty.pebug("[CurrentController] movePenguinTowardsNextWaypoint Destination reached " + flash.geom.Point.distance(destinationPoint, new flash.geom.Point(_local_1._x, _local_1._y)));
        ...
        static function handleRoomDestroyed() {
            ...
            com.clubpenguin.world.rooms2015.may.party.MayParty.pebug("[CurrentController] handleRoomDestroyed ");
