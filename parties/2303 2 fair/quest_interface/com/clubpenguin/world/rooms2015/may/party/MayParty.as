//Created by Action Script Viewer - https://www.buraks.com/asv
    class com.clubpenguin.world.rooms2015.may.party.MayParty
    {
        ...
        static function init() {
            ...
            _boatController = new com.clubpenguin.world.rooms2015.may.BoatController();
            _currentController = new com.clubpenguin.world.rooms2015.may.CurrentController();
            initPartyAvatars();
            com.clubpenguin.world.rooms2015.may.party.MayPurchasePartyItems.init();
        ...
        static function get numSilverTickets() {
            pebug("partyCookie.silverTicket : " + partyCookie.silverTicket, "May Party");
            return(((partyCookie.silverTicket >= 1) ? (partyCookie.silverTicket) : 0));
        }
        ...
        static function get isFairRoom() {
            ...
            if (((_local_1 != undefined) && (_local_1 >= 851)) && (_local_1 <= 862)) {
                return(true);
            }
            return(false);
        }
        ...
        static function checkEntry(roomName, x, y) {
            ...
            if (!_shell.isMyPlayerMember()) {
                if (numSilverTickets > 0) {
                    setRideSelected(roomName, x, y);
                    _interface.showContent(CONSTANTS.RIDE_PROMPT_PATH);
                } else {
                    showRideOopsMessage();
                }
            } else {
        ...
        static function sendTicketsEarned(tickets) {
            pebug("MayParty.sendTicketsEarned() - tickets : " + tickets, CLASS_NAME);
        ...
        static function sendEndMidwayGame(tickets) {
            pebug("MayParty.sendEndMidwayGame() - tickets : " + tickets, CLASS_NAME);
            var _local_1 = _shell.getCurrentServerRoomId();
            var _local_2;
            pebug("MayParty.sendEndMidwayGame() - serverRoom : " + _local_1, CLASS_NAME);
            if (_local_1 == 91) {
                _local_2 = "Soaker";
            }
            if (_local_1 == 92) {
            ...
            if (_local_1 == 98) {
                _local_2 = "Lunar_Launch";
            }
            if (_local_1 == 99) {
                _local_2 = "Feed_A_Puffle";
            }
            if (_local_1 == 95) {
                _local_2 = "Memory";
            }
            ...
            if (_local_2 != undefined) {
                sendBITicketsEarned(_local_2, tickets);
            }
        ...
        static function sendSilverTicketJoinRoom(room, x, y) {
            var _local_3 = Number(room.substr(room.lastIndexOf("y") + 1));
            var _local_2 = Number(850 + _local_3);
            var _local_1;
            if (_local_2 == CONSTANTS.EIGHTBIT_ROOM_ID) {
                _local_1 = "8_bit_game";
            }
            if (_local_2 == CONSTANTS.SHOOTING_RANGE_ROOM_ID) {
                _local_1 = "Shooting_Range_game";
            }
            if (_local_2 == CONSTANTS.MAROONED_LAGOON_ROOM_ID) {
                _local_1 = "Marooned_Lagoon_game";
            }
            if (_local_2 == CONSTANTS.BUMPER_BOATS_ROOM_ID) {
                _local_1 = "Bumper_Boats_game";
            }
            if (_local_2 == CONSTANTS.FERRI_WHEEL_ROOM_ID) {
                _local_1 = "Ferris_Wheel_room";
            }
            if (_local_2 == CONSTANTS.COASTER_ROOM_ID) {
                _local_1 = "Space_Coaster_room";
            }
            if (_local_1 != undefined) {
                sendSilverTicketUsedForRoom(_local_1);
            }
            _airtower.send(_airtower.PLAY_EXT, (com.clubpenguin.world.rooms2015.may.vo.MayPartyCookieVO.MAY_COOKIE_HANDLER_NAME + "#") + CONSTANTS.SILVERTICKET_JR_COMMAND_NAME, [_local_2, x, y], "str", _shell.getCurrentServerRoomId());
        }
        ...
        static function sendSilverTicketUsedForRoom(roomName) {
            com.clubpenguin.util.TrackerAS2.getInstance().trackRewardEarned("silver_ticket", -1, roomName, "silver_ticket");
        }
