//Created by Action Script Viewer - https://www.buraks.com/asv
    class com.clubpenguin.world.rooms2015.may.party.MayPartySnowballManager extends com.clubpenguin.engine.projectiles.SnowballManager
    {
        var _SHELL, _ENGINE, _INTERFACE, snowballHitController, maxSnowballs, resetData, onBallLand, throwItemCounter, snowballData;
        function MayPartySnowballManager (shell, engine, _interface) {
            super();
            _SHELL = shell;
            _ENGINE = engine;
        ...
        function throwBall(playerId, target_x, target_y, snowballVO) {
            if ((playerId == _SHELL.getMyPlayerId()) && (!_global.getCurrentParty().MayParty.isSnowballEnabled)) {
                return(undefined);
            }
            ...
            if (playerId == _SHELL.getMyPlayerId()) {
                _global.getCurrentParty().MayParty.startSnowballCoolDown();
            }
        }
    }
