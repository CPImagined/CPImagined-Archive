//Created by Action Script Viewer - https://www.buraks.com/asv
    ...
    {
        var _stage, _SHELL, _INTERFACE, localize, setupNavigationButtons, _destroyDelegate, _abductionDelegate, aliendAbduction;
        function Plaza (stageReference) {
			...
			_stage.triggers_mc.item_mc.triggerFunction = com.clubpenguin.util.Delegate.create(this, itemPickup);
        }
		function itemPickup() {
			_INTERFACE.buyInventory(5113);
		}
