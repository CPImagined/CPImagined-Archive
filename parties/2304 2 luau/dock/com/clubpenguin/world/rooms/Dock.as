//Created by Action Script Viewer - https://www.buraks.com/asv
    class com.clubpenguin.world.rooms.Dock extends com.clubpenguin.world.rooms.BaseRoom
    {
        ...
        function Dock (stageReference) {
			...
			_stage.triggers_mc.item1_mc.triggerFunction = com.clubpenguin.util.Delegate.create(this, item1);
			_stage.triggers_mc.item2_mc.triggerFunction = com.clubpenguin.util.Delegate.create(this, item2);
            _stage.triggers_mc.hydro_mc.triggerFunction = com.clubpenguin.util.Delegate.create(this, launchHydroGame);
        }
		function item1() {
			if(!_SHELL.isItemInMyInventory(171)) {
				_INTERFACE.buyInventory(171);
			};
		}
		function item2() {
