...
{
   var _stage, localize, setupNavigationButtons, _SHELL, _INTERFACE, _destroyDelegate, wem, _abductionDelegate, aliendAbduction, _liveEvent;
   function Beach(stageReference)
   {
      ...
      setupNavigationButtons([new com.clubpenguin.world.rooms.common.NavigationButtonVO(_stage.background_mc.light_btn,220,200), new com.clubpenguin.world.rooms.common.NavigationButtonVO(_stage.centre_mc.recycle_mc.recycledoor_btn,708,238)]);
