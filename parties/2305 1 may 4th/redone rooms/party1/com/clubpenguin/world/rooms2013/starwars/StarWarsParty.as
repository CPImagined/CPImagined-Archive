//Created by Action Script Viewer - https://www.buraks.com/asv
    class com.clubpenguin.world.rooms2013.starwars.StarWarsParty
    {
        ...
        function waitForPlayerLoadComplete(callback) {
            _airtower = _global.getCurrentAirtower();
            _joinRoomDelegate = com.clubpenguin.util.Delegate.create(this, handleJoinRoom, callback);
        }
        function handleJoinRoom(playerObj, callback) {
        }
