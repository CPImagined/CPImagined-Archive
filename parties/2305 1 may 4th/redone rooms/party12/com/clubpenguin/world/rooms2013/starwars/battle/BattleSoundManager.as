//Created by Action Script Viewer - https://www.buraks.com/asv
    class com.clubpenguin.world.rooms2013.starwars.battle.BattleSoundManager
    {
        var _layers, _target, _defaultLayer;
        function BattleSoundManager (target) {
            _layers = new Array();
            _target = target;
            _defaultLayer = new com.clubpenguin.world.rooms2013.starwars.battle.SoundLayer("default", -1);
        ...
        function addLayer(layerName, maxConcurrent) {
            if (getLayer(layerName) == null) {
                _layers.push(new com.clubpenguin.world.rooms2013.starwars.battle.SoundLayer(layerName, maxConcurrent));
            }
        }
