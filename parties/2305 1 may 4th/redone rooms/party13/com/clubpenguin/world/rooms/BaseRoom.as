//Created by Action Script Viewer - https://www.buraks.com/asv
    ...
    {
        static var _current;
        var _stage, _SHELL, _ENGINE, _INTERFACE, _destroyFunc, _partySoundsClip, _starWarsBattleManager, _soundManager;
        function BaseRoom (stageReference) {
            ...
            _partySoundsClip = _stage.createEmptyMovieClip("party_sounds", 700001);
            var _local_4 = _SHELL.getGlobalContentPath() + "rooms/effects/party_sounds.swf";
            var _local_3 = new com.clubpenguin.hybrid.HybridMovieClipLoader();
            _local_3.addEventListener(com.clubpenguin.hybrid.HybridMovieClipLoader.EVENT_ON_LOAD_ERROR, com.clubpenguin.util.Delegate.create(this, handlePartySoundsLoaded));
            _local_3.addEventListener(com.clubpenguin.hybrid.HybridMovieClipLoader.EVENT_ON_LOAD_INIT, com.clubpenguin.util.Delegate.create(this, handlePartySoundsLoaded));
            _local_3.loadClip(_local_4, _partySoundsClip, "BaseRoom load party_sounds");
        }
        static function get current() {
            return(_current);
        }
        function get starWarsBattleManager() {
            return(_starWarsBattleManager);
        }
        function get soundManager() {
            return(_soundManager);
        }
        function get partySoundsClip() {
            return(_partySoundsClip);
        }
        function handlePartySoundsLoaded(event) {
            _starWarsBattleManager = new com.clubpenguin.world.rooms2013.starwars.battle.BattleManager(this);
            _soundManager = new com.clubpenguin.world.rooms2013.starwars.battle.BattleSoundManager(_partySoundsClip);
        }
        function onDestroy() {
            _SHELL.removeListener(_SHELL.ROOM_DESTROYED, _destroyFunc);
            _starWarsBattleManager.destroy();
            _current = null;
        }
        function getStage() {
            return(_stage);
