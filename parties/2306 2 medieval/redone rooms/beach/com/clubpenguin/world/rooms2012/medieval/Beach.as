//Created by Action Script Viewer - https://www.buraks.com/asv
    ...
    {
        var _stage, _INTERFACE, _mushroomClips, _destroyDelegate, _SHELL, setupNavigationButtons, _triggerWatcher, _wizardLabTrigger, _roomUpdateInterval, _opcodeJournal;
        ...
        function init() {
            ...
            if (com.clubpenguin.world.rooms2012.medieval.MedievalParty.canAccessMemberExperience()) {
                if (_INTERFACE.scavengerHunt.isItemFound(com.clubpenguin.world.rooms2012.medieval.MedievalParty.SCAVENGER_HUNT_ORBS)) {
            ...
            _stage.wateringcan_mc.wateringCan.water_btn.onRelease = com.clubpenguin.util.Delegate.create(this, onWateringCanClick);
        ...
        function pickUpScavengerHuntItem() {
            if (!_INTERFACE.scavengerHunt.isItemFound(com.clubpenguin.world.rooms2012.medieval.MedievalParty.SCAVENGER_HUNT_ORBS)) {
                ...
                _stage.sunbeam.gotoAndStop(2);
                _stage.orbs.gotoAndStop(2);
                _INTERFACE.scavengerHunt.itemFound(com.clubpenguin.world.rooms2012.medieval.MedievalParty.SCAVENGER_HUNT_ORBS);
                _INTERFACE.showContent(com.clubpenguin.world.rooms2012.medieval.MedievalParty.CONTENT_SCAVENGER_HUNT);
                com.clubpenguin.world.rooms2012.medieval.MedievalParty.track("orbsScavengerHuntItem");
            }
        }
