//Created by Action Script Viewer - https://www.buraks.com/asv
    ...
    {
        var _stage, _destroyDelegate, _SHELL, _parallaxClips, _originalParallaxClipXPos, _originalParallaxClipYPos, setupNavigationButtons, localize, _triggerWatcher, _ropeSnapTrigger, _plankSnaptrigger, _roomUpdateInterval, _ENGINE, _INTERFACE;
        ...
        function init() {
            ...
            _stage.triggers_mc.exits_mountain_mc.triggerFunction = com.clubpenguin.util.Delegate.create(this, exit, "party26", 620, 250);
            _stage.triggers_mc.exit_boss_mc.triggerFunction = com.clubpenguin.util.Delegate.create(this, exit, "party28", 660, 415);
