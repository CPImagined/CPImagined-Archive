//Created by Action Script Viewer - https://www.buraks.com/asv
    ...
    {
        var _stage, _destroyDelegate, _SHELL, setupNavigationButtons, _INTERFACE, _triggerWatcher, _talkingTreeTrigger1, _talkingTreeTrigger2, _roomUpdateInterval, _playerTalkDelegate, _opcodeJournal, _ENGINE;
        ...
        function init() {
            ...
            if (com.clubpenguin.world.rooms2012.medieval.MedievalParty.canAccessMemberExperience()) {
                if (_INTERFACE.scavengerHunt.isItemFound(com.clubpenguin.world.rooms2012.medieval.MedievalParty.SCAVENGER_HUNT_SLINGSHOT)) {
            ...
            _stage.interface_mc.catalogue_Btn.onRelease = com.clubpenguin.util.Delegate.create(this, showPartyCatalog);
        ...
        function pickUpScavengerHuntItem() {
            if (!_INTERFACE.scavengerHunt.isItemFound(com.clubpenguin.world.rooms2012.medieval.MedievalParty.SCAVENGER_HUNT_SLINGSHOT)) {
                ...
                _stage.lightbeam_mc.gotoAndStop(2);
                _stage.slingshot_mc.gotoAndStop(2);
                _INTERFACE.scavengerHunt.itemFound(com.clubpenguin.world.rooms2012.medieval.MedievalParty.SCAVENGER_HUNT_SLINGSHOT);
                _INTERFACE.showContent(com.clubpenguin.world.rooms2012.medieval.MedievalParty.CONTENT_SCAVENGER_HUNT);
                com.clubpenguin.world.rooms2012.medieval.MedievalParty.track("slingshotScavengerHuntItem");
            }
        }
        function showHydroHopperHint() {
            _INTERFACE.showHint(this, "hydro_hint");
        }
        function hideHint() {
