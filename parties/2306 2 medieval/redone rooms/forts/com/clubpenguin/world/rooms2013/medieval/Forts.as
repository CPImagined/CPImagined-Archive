//Created by Action Script Viewer - https://www.buraks.com/asv
    ...
    {
        var _stage, _SHELL, _destroyDelegate, setupNavigationButtons, _airtower, _waterSlideHandlerDelegate, IS_24_HOUR_CLOCK, _now, _secondCheckIntervalID, _ct_minutes, _ct_hours, _pm_trigger, _ct_day, _today, _triggerWatcher, _triggerWatcherInterval, _waterSlideTrigger, _ENGINE;
        ...
        function init() {
			...
			setupNavigationButtons([new com.clubpenguin.world.rooms.common.NavigationButtonVO(_stage.nav_party19, 718, 397)]);
        ...
        function configureTriggers() {
			...
			_stage.triggers_mc.trekker_mc.triggerFunction = com.clubpenguin.util.Delegate.create(this, exit, "party24", 377, 352);
        }
		...
		function rollOverParty19() {
			_stage.trekker_mc.timeMachine_mc.gotoAndStop(3);
		}
		function rollOutParty19()
		{
			_stage.trekker_mc.timeMachine_mc.gotoAndStop(2);
		}
