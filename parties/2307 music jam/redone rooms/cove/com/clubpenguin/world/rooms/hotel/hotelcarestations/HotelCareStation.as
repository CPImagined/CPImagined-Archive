    ...
    class com.clubpenguin.world.rooms.hotel.hotelcarestations.HotelCareStation
    {
        ...
        function beginActivity(players) {
            ...
            while (_local_2 < players.length) {
                ...
                var _local_3 = _local_8.attachedPuffle.id;
                if (((_puffleCareQuest.isPuffleEquipped(players[_local_2]) && (_local_8.avatarVO.avatar_id != 1)) && (_ENGINE.puffleAvatarController.isPuffleVisible(_local_3))) && (_ENGINE.puffleAvatarController.getPuffleCanMove(_local_3))) {
                    ...
                    if (_animationLoadsExternally) {
                        _puffleAnimationLoader = new com.clubpenguin.engine.puffles.animations.PuffleAnimationLoader(players[_local_2], _local_3, _SHELL, _ENGINE);
                        ...
                        _ENGINE.puffleAvatarController.setFrameUpdateEnabled(_local_3, false);
                        if (_hideHat) {
                            _ENGINE.puffleAvatarController.hideHat(_local_3);
                        }
                        _ENGINE.puffleAvatarController.updatePuffleFrame(_local_3, _puffleFrame);
                    }
