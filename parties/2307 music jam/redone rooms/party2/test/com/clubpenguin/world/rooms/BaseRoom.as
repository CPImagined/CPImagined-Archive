...
{
    var _stage, _SHELL, _ENGINE, _INTERFACE, _destroyFunc, roomEnvironmentManager, soundManagerReady, _performanceManager, __get__performanceManager, _soundManager, __set__performanceManager, __get__soundManager;
    ...
    function set performanceManager(performanceManager)
    {
    ...
    function disablePuffleActivities()
    {
        ...
        _loc2.playerId = _loc3.player_id;
        _SHELL.updateListeners(_SHELL.DISABLE_PUFFLE_TREASURE_HUNTING, _loc3.player_id);
