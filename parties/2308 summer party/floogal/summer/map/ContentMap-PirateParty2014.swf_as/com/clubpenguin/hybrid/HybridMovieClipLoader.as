dynamic class com.clubpenguin.hybrid.HybridMovieClipLoader extends mx.events.EventDispatcher
{
    ...
    function loadClip(url, container, callerName, isCDNCache)
    {
        ...
        trace("HybridMovieClipLoader _url: " + this._url);
    ...
    function logLoadError(_context, _errorCode, _httpStatus)
    {
        ...
        {
            com.clubpenguin.util.TrackerAS2.getInstance().sendToAS3LogMovieClipLoadError(_context, this._trackerReason, this._url, _errorCode, _httpStatus);
        }
    }
    ...
    function logLoadTimeout(_context)
    {
        if (_global.getCurrentShell()) 
        {
            com.clubpenguin.util.TrackerAS2.getInstance().sendToAS3LogMovieClipTimeout(_context, this._trackerReason, this._url);
        }
    }
    ...
    function logParamError(_context, _caller)
    {
        if (_global.getCurrentShell()) 
        {
            com.clubpenguin.util.TrackerAS2.getInstance().sendToAS3LogMovieClipParamError(_context, this._trackerReason, this._url, _caller);
        }
    }
