dynamic class com.clubpenguin.net.BridgeFilter
{
    ...
    static var MUSIC_DELETE_TRACK: String = "deletetrack";
    static var MUSIC_GET_TRACK: String = "loadmusictrack";
    static var MUSIC_GET_MY_TRACKS: String = "getmymusictracks";
    static var MUSIC_GET_SHARED_TRACKS: String = "getsharedmusictracks";
    static var MUSIC_SHARE_TRACK: String = "sharemymusictrack";
    static var MUSIC_SAVE_TRACK: String = "savemymusictrack";
    static var MUSIC_BROADCAST_MUSIC_TRACKS: String = "broadcastingmusictracks";
    static var MUSIC_LIKES_CAN_LIKE_TRACK: String = "canliketrack";
    static var MUSIC_LIKES_SEND_LIKE: String = "liketrack";
    static var MUSIC_LIKES_ON_LIKE_COUNT: String = "getlikecountfortrack";
    static var MUSIC_LIKES_REFRESH: String = "refreshmytracklikes";
    var airtower;
    ...
    static function messageIsSentToAS3(airtower, eventType)
    {
        ...
        else if (__reg0 === com.clubpenguin.net.BridgeFilter.MUSIC_DELETE_TRACK) 
        {
            return true;
        }
        else if (__reg0 === com.clubpenguin.net.BridgeFilter.MUSIC_GET_TRACK) 
        {
            return true;
        }
        else if (__reg0 === com.clubpenguin.net.BridgeFilter.MUSIC_GET_MY_TRACKS) 
        {
            return true;
        }
        else if (__reg0 === com.clubpenguin.net.BridgeFilter.MUSIC_GET_SHARED_TRACKS) 
        {
            return true;
        }
        else if (__reg0 === com.clubpenguin.net.BridgeFilter.MUSIC_SHARE_TRACK) 
        {
            return true;
        }
        else if (__reg0 === com.clubpenguin.net.BridgeFilter.MUSIC_SAVE_TRACK) 
        {
            return true;
        }
        else if (__reg0 === com.clubpenguin.net.BridgeFilter.MUSIC_BROADCAST_MUSIC_TRACKS) 
        {
            return true;
        }
        else if (__reg0 === com.clubpenguin.net.BridgeFilter.MUSIC_LIKES_CAN_LIKE_TRACK) 
        {
            return true;
        }
        else if (__reg0 === com.clubpenguin.net.BridgeFilter.MUSIC_LIKES_SEND_LIKE) 
        {
            return true;
        }
        else if (__reg0 === com.clubpenguin.net.BridgeFilter.MUSIC_LIKES_ON_LIKE_COUNT) 
        {
            return true;
        }
        else if (__reg0 === com.clubpenguin.net.BridgeFilter.MUSIC_LIKES_REFRESH) 
        {
            return true;
        }
