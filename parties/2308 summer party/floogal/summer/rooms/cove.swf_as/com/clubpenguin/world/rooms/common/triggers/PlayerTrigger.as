dynamic class com.clubpenguin.world.rooms.common.triggers.PlayerTrigger
{
    ...
    function endSnapshot()
    {
        for (var __reg6 in this._prevPlayerSnapshot) 
        {
            ...
            {
                if ((this._prevPlayerSnapshot[__reg6] == com.clubpenguin.world.rooms.common.triggers.PlayerTrigger.STOPPED || this._prevPlayerSnapshot[__reg6] == com.clubpenguin.world.rooms.common.triggers.PlayerTrigger.STANDING) && this._playerSnapshot[__reg6] == com.clubpenguin.world.rooms.common.triggers.PlayerTrigger.STOPPED) 
                {
                    this._playerSnapshot[__reg6] = com.clubpenguin.world.rooms.common.triggers.PlayerTrigger.STANDING;
                }
            }
            else 
            {
                this._playerSnapshot[__reg6] = com.clubpenguin.world.rooms.common.triggers.PlayerTrigger.GONE;
                continue;
            }
        }
        var __reg5 = [];
        ...
        {
            if ((__reg0 = this._playerSnapshot[__reg6]) === com.clubpenguin.world.rooms.common.triggers.PlayerTrigger.WALKING) 
            {
                ++this._playerCount;
                __reg5.push(__reg6);
            }
