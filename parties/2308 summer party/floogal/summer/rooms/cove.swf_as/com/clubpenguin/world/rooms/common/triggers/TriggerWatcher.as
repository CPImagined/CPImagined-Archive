dynamic class com.clubpenguin.world.rooms.common.triggers.TriggerWatcher
{
    ...
    function addTrigger(triggerToAdd)
    {
        if (triggerToAdd.__get__isValid()) 
        {
            ...
            var __reg9 = Math.floor(Math.floor(__reg10.xMin) / com.clubpenguin.world.rooms.common.triggers.TriggerWatcher.GRID_SIZE);
            var __reg7 = Math.floor(Math.floor(__reg10.yMin) / com.clubpenguin.world.rooms.common.triggers.TriggerWatcher.GRID_SIZE);
            var __reg8 = Math.floor(Math.floor(__reg10.xMax) / com.clubpenguin.world.rooms.common.triggers.TriggerWatcher.GRID_SIZE);
            var __reg6 = Math.floor(Math.floor(__reg10.yMax) / com.clubpenguin.world.rooms.common.triggers.TriggerWatcher.GRID_SIZE);
            var __reg3 = __reg9;
            for (;;) 
            {
                if (__reg3 > __reg8) 
    ...
    function checkTriggers(object)
    {
        ...
        var __reg4 = Math.floor(__reg2._x / com.clubpenguin.world.rooms.common.triggers.TriggerWatcher.GRID_SIZE);
        var __reg3 = Math.floor(__reg2._y / com.clubpenguin.world.rooms.common.triggers.TriggerWatcher.GRID_SIZE);
        if (this._targetGrid[__reg4][__reg3]) 
        {
            this._targetGrid[__reg4][__reg3].hitTest(object, __reg2);
        }
    }
