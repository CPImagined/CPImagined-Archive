dynamic class com.clubpenguin.login.LoginFloodManager
{
    ...
    static function setLoginAttempt()
    {
        ...
        trace("so.data[LOGIN_ATTEMPTS] : " + __reg2.data[com.clubpenguin.login.LoginFloodManager.LOGIN_ATTEMPTS]);
        trace("so.data[NEXT_LOGIN_TIME] : " + __reg2.data[com.clubpenguin.login.LoginFloodManager.NEXT_LOGIN_TIME]);
        __reg4 = __reg2.flush();
        trace("soResult : " + __reg4);
        return true;
    }
