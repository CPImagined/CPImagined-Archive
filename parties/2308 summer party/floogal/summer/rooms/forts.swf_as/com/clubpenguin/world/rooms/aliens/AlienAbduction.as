class com.clubpenguin.world.rooms.aliens.AlienAbduction
{
    ...
    function startBeam()
    {
        var _loc2 = _penguin_mc._y / 2;
        _roomMC.tractorBeam_mc.gotoAndPlay(2);
        com.greensock.TweenMax.to(_penguin_mc, 3.460000, {_y: _loc2, _rotation: -30, delay: 0.700000, ease: com.greensock.easing.Sine.easeIn, onComplete: tween1Complete, onCompleteParams: [_penguin_mc], onCompleteScope: this});
    ...
    {
        com.greensock.TweenMax.to(player, 0.500000, {_y: -50, _rotation: -30, delay: 0, ease: com.greensock.easing.Back.easeIn, onComplete: tween2Complete, onCompleteScope: this});
    } // End of the function
    ...
    {
        var _loc3 = new flash.geom.ColorTransform(1, 1, 1, 1, 0, 55, 0, 0);
        var _loc2 = new flash.geom.Transform(_penguin_mc);
