dynamic class com.clubpenguin.login.LoginFloodManager
{
    ...
    static function setLoginAttempt()
    {
        ...
        __reg2.data[com.clubpenguin.login.LoginFloodManager.NEXT_LOGIN_TIME] = Number(__reg4.getTime() + (com.clubpenguin.login.LoginFloodManager.LOGIN_DELAYS[__reg1] + com.clubpenguin.math.MathHelper.getRandomNumberInRange(__reg3, com.clubpenguin.login.LoginFloodManager.RANDOM_RANGE)) * com.clubpenguin.login.LoginFloodManager.ONE_SECOND);
        __reg5 = __reg2.flush();
        return true;
    }
