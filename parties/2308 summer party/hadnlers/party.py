...
PartyCacheCurrent = "summerparty23" #if you have a repeated party, it is advisable to make a different name every time
...
@handlers.handler(XTPacket('tnbch', 'tnbchslide'))
async def handle_slide(p, slide: int):
    await p.send_packet('tnbchslide', p.id, slide)
