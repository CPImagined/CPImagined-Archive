class com.clubpenguin.world.rooms.Beach extends com.clubpenguin.world.rooms.BaseRoom
{
   ...
   function Beach(stageReference)
   {
      ...
      setupNavigationButtons([new com.clubpenguin.world.rooms.common.NavigationButtonVO(_stage.background_mc.light_btn,220,200), new com.clubpenguin.world.rooms.common.NavigationButtonVO(_stage.buoy_mc.buoy_btn, 74, 426)]);
	  ...
	  _stage.triggers_mc.piffle_mc.triggerFunction = com.clubpenguin.util.Delegate.create(this, adoptPiffle);
	  _stage.triggers_mc.apron_mc.triggerFunction = com.clubpenguin.util.Delegate.create(this, pickUpApron);
	  _stage.triggers_mc.surf_mc.triggerFunction = com.clubpenguin.util.Delegate.create(this, exit, "party3", 110, 260);
   ...
   function adoptPiffle()
   {
	   _INTERFACE.showContent("snowmanAdopt");
   }
   function pickUpApron()
   {
	   if(!_SHELL.isItemInMyInventory(25)) {
			_INTERFACE.buyInventory(250);
	   }
   }
