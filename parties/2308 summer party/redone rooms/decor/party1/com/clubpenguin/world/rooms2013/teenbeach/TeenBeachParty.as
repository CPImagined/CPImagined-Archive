//Created by Action Script Viewer - https://www.buraks.com/asv
    class com.clubpenguin.world.rooms2013.teenbeach.TeenBeachParty
    {
        ...
        var _shell, _airtower, _interface, _engine, _party, _serverCookie, opcodeJournal, _concertHandlerDelegate, countdownSignal, _onInventoryBoughtDelegate, _engineOverrides, _isPlayerMascot, _getABTestDataDelegate, _currentRoom, _millisecondsTillStart, _timeBetweenConcertsInMilliSeconds;
        ...
        function init() {
            ...
            _getABTestDataDelegate = com.clubpenguin.util.Delegate.create(this, handleGetABTestData);
            _airtower.addListener(_airtower.GET_AB_TEST_DATA, _getABTestDataDelegate);
        }
        function handleGetABTestData() {
            _airtower.removeListener(_airtower.GET_AB_TEST_DATA, _getABTestDataDelegate);
            var _local_2 = _shell.abTestModel.getTestDataByName(AB_TEST_NAME);
            var _local_3 = ((Number(_local_2[AB_TEST_CATALOGUE_VERSION]) == 0) ? 1 : 0);
            trace((("catalogue version " + _local_2[AB_TEST_CATALOGUE_VERSION]) + " is this control? ") + _local_3);
            _shell._trackerAS2.trackTestImpression(AB_TEST_NAME, _local_2[AB_TEST_CATALOGUE_VERSION], _local_3, _shell.isMyPlayerMember());
        }
        ...
        function checkShowFirstTimeLogin() {
            trace("TeenBeachParty: is login screen viewed " + _serverCookie.isLoginScreenViewed);
        ...
        static var MAC_AND_BRADY_GIVEAWAY_ITEM_ID = 9212;
