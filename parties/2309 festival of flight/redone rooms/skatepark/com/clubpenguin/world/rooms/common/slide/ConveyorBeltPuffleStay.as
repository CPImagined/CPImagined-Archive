//Created by Action Script Viewer - https://www.buraks.com/asv
    class com.clubpenguin.world.rooms.common.slide.ConveyorBeltPuffleStay
    {
        var endOfConveyorBeltReached, _ENGINE, _SHELL, frameTriggersList;
        function ConveyorBeltPuffleStay () {
            init();
        }
        function init() {
        ...
        function addPenguintoConveyorPather(linkageName, player_id, conveyorBeltContainer, movePuffle) {
            ...
            var _local_7 = _ENGINE.puffleAvatarController.getPuffleAvatar(_SHELL.getPlayerObjectById(player_id).attachedPuffle.id);
            _local_7.stopPuffleUpdates();
            ...
            _local_2.play();
            _local_2.onEnterFrame = com.clubpenguin.util.Delegate.create(this, updatePenguinConveyorPosition, player_id, _local_2, movePuffle);
        }
        function updatePenguinConveyorPosition(player_id, patherMC, movePuffle) {
            ...
            if (patherMC._currentframe == patherMC._totalframes) {
                ...
                if (movePuffle) {
                    var _local_9 = _ENGINE.puffleAvatarController.getPuffleAvatar(_SHELL.getPlayerObjectById(player_id).attachedPuffle.id);
                    _local_9.startPuffleUpdates();
                }
