//Created by Action Script Viewer - https://www.buraks.com/asv
    class com.clubpenguin.world.rooms2014.holiday.DonationStation extends MovieClip
    {
        var _INTERFACE, _ENGINE, _SHELL, triggerMC, _navigationDelegate, cfc_button, handlePlayerMoveCompleteDelegate, _x, _y, _parent;
        ...
        function handlePlayerMoveComplete(event) {
            ...
            trace("DonationStation.handlePlayerMoveComplete() - PLAYER IS IN CORRECT POSITION");
            _INTERFACE.showContent(_global.getCurrentParty().HolidayParty.CONSTANTS.CFC_UI_PATH);
        }
