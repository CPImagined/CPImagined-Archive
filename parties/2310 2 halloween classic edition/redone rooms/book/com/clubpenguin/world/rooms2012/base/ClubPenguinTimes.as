//Created by Action Script Viewer - https://www.buraks.com/asv
    class com.clubpenguin.world.rooms2012.base.ClubPenguinTimes extends com.clubpenguin.world.rooms.BaseRoom
    {
        ...
        function init() {
			...
			_stage.triggers_mc.party_mc.triggerFunction = com.clubpenguin.util.Delegate.create(this, exit, "party", 685, 380);
            ...
            setupNavigationButtons([new com.clubpenguin.world.rooms.common.NavigationButtonVO(_stage.door_btn, 631, 206), new com.clubpenguin.world.rooms.common.NavigationButtonVO(_stage.partybtn_mc.party_btn, 240, 200)]);
