//Created by Action Script Viewer - https://www.buraks.com/asv
    class com.clubpenguin.world.rooms.Dock extends com.clubpenguin.world.rooms.BaseRoom
    {
        ...
        function Dock (stageReference) {
			...
			_stage.puffle_mc.adopt_btn.onRollOver = com.clubpenguin.util.Delegate.create(this, ghostPuffleRollOver);
			_stage.puffle_mc.adopt_btn.onRollOut = com.clubpenguin.util.Delegate.create(this, ghostPuffleRollOut);
			_stage.puffle_mc.adopt_btn.onReleaseOutside = com.clubpenguin.util.Delegate.create(this, ghostPuffleRollOut);
			_stage.puffle_mc.adopt_btn.onRelease = com.clubpenguin.util.Delegate.create(this, ghostPuffleRelease);
		...
		function ghostPuffleRollOver() {
			_stage.puffle_mc.adoptContainer_mc.adopt_mc.gotoAndStop(2);
		}
		function ghostPuffleRollOut() {
			_stage.puffle_mc.adoptContainer_mc.adopt_mc.gotoAndStop(1);
		}
		function ghostPuffleRelease() {
			showContent("ghostAdopt");
		}
