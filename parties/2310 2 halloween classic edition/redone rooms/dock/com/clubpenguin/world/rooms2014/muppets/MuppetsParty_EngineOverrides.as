        ...
        function sendPlayerFrame(frame) {
            ...
            if (_local_3.validateUpdateFrame(_local_5, frame)) {
                if (frame == _local_3.SHELL.DANCE_FRAME) {
                    ...
                    var _local_7 = _local_3.SHELL.getMyPlayerId();
                    if (_local_4.isPlayerAHost(_local_7)) {
                        var _local_8 = _local_4.getPlayerPerformance(_local_7);
                        if (_local_8 == null) {
                            _local_4.service.sendOpenPerformance();
                            return(undefined);
                        } else if (_local_8.state == com.clubpenguin.world.rooms2014.muppets.performance.states.PerformanceStateEnum.BOARDING) {
