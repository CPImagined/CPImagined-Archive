//Created by Action Script Viewer - https://www.buraks.com/asv
    class com.clubpenguin.world.rooms2013.halloween.HalloweenParty_InterfaceOverrides
    {
        var _shell, _airtower, _interface, _engine, _party;
        function HalloweenParty_InterfaceOverrides () {
        }
        function init() {
        ...
        function showPartyIcon(partyIcon) {
            ...
            if (_interface.PARTY_ICON) {
                _party.HalloweenParty.instance.halloweenPartyIconState();
