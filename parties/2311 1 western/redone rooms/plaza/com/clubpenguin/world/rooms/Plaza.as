//Created by Action Script Viewer - https://www.buraks.com/asv
    ...
    {
        var _stage, _SHELL, localize, _caveMineDigging, setupNavigationButtons, _destroyDelegate, _abductionDelegate, aliendAbduction;
        function Plaza (stageReference) {
            ...
            setupNavigationButtons([new com.clubpenguin.world.rooms.common.NavigationButtonVO(_stage.forts_btn, 35, 290), new com.clubpenguin.world.rooms.common.NavigationButtonVO(_stage.park_btn, 85, 265), new com.clubpenguin.world.rooms.common.NavigationButtonVO(_stage.navPet, 213, 245), new com.clubpenguin.world.rooms.common.NavigationButtonVO(_stage.navHotel, 330, 237), new com.clubpenguin.world.rooms.common.NavigationButtonVO(_stage.manhole_mc.manhole_btn, 270, 275), new com.clubpenguin.world.rooms.common.NavigationButtonVO(_stage.navMall, 464, 205), new com.clubpenguin.world.rooms.common.NavigationButtonVO(_stage.navPizza, 627, 245), new com.clubpenguin.world.rooms.common.NavigationButtonVO(_stage.forest_btn, 720, 280)]);
			...
			_stage.horse_btn.onRollOver = com.clubpenguin.util.Delegate.create(this, horseRollOver);
