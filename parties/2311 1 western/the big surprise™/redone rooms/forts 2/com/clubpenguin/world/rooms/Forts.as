//Created by Action Script Viewer - https://www.buraks.com/asv
    ...
    {
        var _stage, _SHELL, localize, setupNavigationButtons, _caveMineDigging, IS_24_HOUR_CLOCK, _now, _secondCheckIntervalID, _destroyDelegate, _checkClockTagetDelegate, showContent, wem, _abductionDelegate, aliendAbduction, _ct_minutes, _ct_hours, _pm_trigger, _ct_day, _today;
        ...
        function init() {
            ...
            setupNavigationButtons([new com.clubpenguin.world.rooms.common.NavigationButtonVO(_stage.navMazeEntrance_btn, 380, 288), new com.clubpenguin.world.rooms.common.NavigationButtonVO(_stage.background_mc.town_btn, 80, 250), new com.clubpenguin.world.rooms.common.NavigationButtonVO(_stage.background_mc.rink_btn, 245, 200), new com.clubpenguin.world.rooms.common.NavigationButtonVO(_stage.background_mc.plaza_btn, 685, 225)]);
			...
			_stage.navMazeEntrance_btn.onRollOver = com.clubpenguin.util.Delegate.create(this, entranceRollOver);
			_stage.navMazeEntrance_btn.onRollOut = com.clubpenguin.util.Delegate.create(this, entranceRollOut);
			_stage.navMazeEntrance_btn.onReleaseOutside = com.clubpenguin.util.Delegate.create(this, entranceRollOut);
			...
			_stage.triggers_mc.bullseye_mc.triggerFunction = com.clubpenguin.util.Delegate.create(this, exit, "party14", 194, 428);
			_stage.triggers_mc.mazeEntrance_mc.triggerFunction = com.clubpenguin.util.Delegate.create(this, exit, "party10", 193, 270);
		...
		function entranceRollOver() {
			_stage.mazeEntrance_mc.gotoAndStop(2);
		}
		function entranceRollOut() {
