//Created by Action Script Viewer - https://www.buraks.com/asv
    ...
    {
        var _stage, localize, setupNavigationButtons, _caveMineDigging, _INTERFACE, _SHELL, _destroyDelegate, wem, _abductionDelegate, aliendAbduction;
        function Town (stageReference) {
			...
			_stage.triggers_mc.jacket_mc.triggerFunction = com.clubpenguin.util.Delegate.create(this, pickUpJacket);
        }
		function pickUpJacket() {
			_INTERFACE.buyInventory(90021);
		}
