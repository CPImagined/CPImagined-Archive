//Created by Action Script Viewer - https://www.buraks.com/asv
    ...
    {
        var _stage, _SHELL, _destroyDelegate, _triggerWatcher, setupNavigationButtons, localize, _triggerWatcherInterval, _escalatorHandlerDelegate, _slide1, _slide2, _slide1Trigger, _slide2Trigger, _checkTargetDelegate;
        ...
        function init() {
            ...
            _stage.triggers_mc.plaza_mc.triggerFunction = com.clubpenguin.util.Delegate.create(this, exit, "plaza", 440, 275);
            ...
            setupNavigationButtons([new com.clubpenguin.world.rooms.common.NavigationButtonVO(_stage.plaza_btn, 115, 335), new com.clubpenguin.world.rooms.common.NavigationButtonVO(_stage.berry_btn, 132, 173), new com.clubpenguin.world.rooms.common.NavigationButtonVO(_stage.costumes_btn, 625, 180)]);
            localize([_stage.langAnvils_mc, _stage.langFragile_mc, _stage.costumeTrunk_mc, _stage.foreground_mc.annBanner_mc]);
        ...
        function onSnowballLand(snowballInfo) {
            var _local_5 = _global.getCurrentParty().BaseParty.CURRENT_PARTY;
            var _local_4 = snowballInfo.player_id;
            if (_SHELL.getMyPlayerId() == _local_4) {
                if (_stage.foreground_mc.fountain_collider.hitTest(snowballInfo.x, snowballInfo.y, true) == true) {
                    _local_5 = _global.getCurrentParty().BaseParty.CURRENT_PARTY;
                    _local_5.playSound(_stage, "sfx_coin_water_" + Math.ceil(Math.random() * 3));
                } else {
