//Created by Action Script Viewer - https://www.buraks.com/asv
    class com.clubpenguin.world.rooms.Forts extends com.clubpenguin.world.rooms.BaseRoom
    {
        ...
        function init() {
            ...
            setupNavigationButtons([new com.clubpenguin.world.rooms.common.NavigationButtonVO(_stage.nav_party19, 583, 386), new com.clubpenguin.world.rooms.common.NavigationButtonVO(_stage.background_mc.town_btn, 80, 250), new com.clubpenguin.world.rooms.common.NavigationButtonVO(_stage.background_mc.rink_btn, 245, 200), new com.clubpenguin.world.rooms.common.NavigationButtonVO(_stage.background_mc.plaza_btn, 685, 225)]);
			...
			_stage.nav_party19.onRollOver = com.clubpenguin.util.Delegate.create(this, rollOverParty19);
			_stage.nav_party19.onRollOut = com.clubpenguin.util.Delegate.create(this, rollOutParty19);
			_stage.nav_party19.onReleaseOutside = com.clubpenguin.util.Delegate.create(this, rollOutParty19);
			_stage.triggers_mc.trekker_mc.triggerFunction = com.clubpenguin.util.Delegate.create(this, exit, "party1", 377, 352);
		...
		function rollOverParty19() {
			_stage.timeMachine_mc.gotoAndStop(3);
		}
		function rollOutParty19() {
			_stage.timeMachine_mc.gotoAndStop(2);
		}
