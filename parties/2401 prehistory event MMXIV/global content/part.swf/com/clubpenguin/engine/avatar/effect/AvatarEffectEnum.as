...
//Created by Action Script Viewer - http://www.buraks.com/asv
    class com.clubpenguin.engine.avatar.effect.AvatarEffectEnum
    {
        ...
        function AvatarEffectEnum (_arg_6, _arg_5, _arg_3, _arg_7, _arg_4) {
            super();
            if (_arg_3 != undefined) {
                _flags = _arg_3;
            } else {
            ...
            _swfName = _arg_6;
            _symbolName = _arg_5;
            _tweenDuration = _arg_7;
            _tweenOptions = _arg_4;
        }
        ...
        static function fromString(_arg_1) {
            if (!(_arg_1 === "QuestFoundItem")) {
            } else {
        ...
        static var QUEST_FOUND_ICON = new com.clubpenguin.engine.avatar.effect.AvatarEffectEnum(LIB_AVATAR_NAME, "QuestFoundItem", FLAG_NONE, 2, {_x:50, _y:490});
        static var CFC_TRAIN_JOIN_ICON = new com.clubpenguin.engine.avatar.effect.AvatarEffectEnum(LIB_AVATAR_NAME, "trainJoinIcon", FLAG_ATTACH_TO_PLAYER | FLAG_STOP_ON_LAST_FRAME);
