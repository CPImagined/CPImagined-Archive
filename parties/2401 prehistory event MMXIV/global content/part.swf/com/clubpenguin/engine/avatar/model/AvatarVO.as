...
//Created by Action Script Viewer - http://www.buraks.com/asv
    class com.clubpenguin.engine.avatar.model.AvatarVO
    {
        ...
        function setEffectTransition(_arg_3, _arg_2) {
            effectTransitionsMap[_arg_3] = ((_arg_2 != null) ? (_arg_2) : (com.clubpenguin.engine.avatar.effect.AvatarEffectEnum.NO_EFFECT));
        }
        function getEffectTransition(_arg_3) {
            var _local_2 = effectTransitionsMap[_arg_3];
            if (_local_2 != null) {
                return(_local_2);
            } else {
        ...
        function initializeAttributesFromString(_arg_3) {
            if (_arg_3 != undefined) {
                try {
                    var _local_2 = com.clubpenguin.util.JSONParser.parse(_arg_3);
        ...
        function clone() {
            ...
            _local_2.defaultRevertEffect = defaultRevertEffect;
            ...
            _local_2.revertSoundEffectSymbol = revertSoundEffectSymbol;
        ...
        function toString() {
            ...
            _local_2 = _local_2 + (", defaultRevertEffect: " + defaultRevertEffect);
            ...
            _local_2 = _local_2 + (", revertSoundEffectSymbol: " + revertSoundEffectSymbol);
            _local_2 = _local_2 + (", shadowScaleX: " + shadowScaleX);
            _local_2 = _local_2 + (", shadowScaleY: " + shadowScaleY);
