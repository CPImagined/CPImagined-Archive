    ...
    class com.clubpenguin.engine.projectiles.SnowballManager
    {
        ...
        function throwBall(_arg_8, _arg_12, _arg_13, _arg_6) {
            ...
            if (_SHELL.getIsRoomIgloo() || (_ENGINE.playerHostedRoomType == com.clubpenguin.world.rooms.common.RoomConstants.PLAYER_HOSTED_ROOM_BACKYARD)) {
                ...
                var _local_14 = _local_10.attachMovie(_arg_6.__get__type().__get__symbolName(), "testSnowball", 1);
            ...
            if (_local_3.is_ready && (!_local_3.is_moving)) {
                ...
                } else if (_arg_6.__get__type().__get__originAtHead()) {
                    _local_9 = {x:_local_3._x, y:Number(_local_3._y - (_local_3.art_mc._height / 2))};
                } else if (_arg_6.__get__type().__get__originAtCenter()) {
                ...
                _local_2.max_height = _local_2.start_height + _arg_6.__get__maxHeightOffset();
                ...
                _local_2.w = 0;
                _local_2.t = 0;
                _local_11 = _arg_6.__get__type().__get__symbolName() + throwItemCounter;
                snowballData[_local_11] = _local_2;
                if (_local_10[_local_11] != undefined) {
                    _local_10[_local_11].removeMovieClip();
                }
                _local_5 = _local_10.attachMovie(_arg_6.__get__type().__get__symbolName(), _local_11, Number(1000200 + throwItemCounter), {_x:_local_2.start_x, _y:_local_2.start_y});
                ...
                if (_arg_6.__get__type().__get__hasTail()) {
                    _local_5.art._rotation = com.clubpenguin["math"].MathHelper.getAngleBetweenCoordinates(_local_9.x, _local_9.y, _arg_12, _arg_13);
                }
                if (_arg_6.__get__type().__get__playAbovePlayer() && (_local_5.getDepth() < _local_3.getDepth())) {
                    _local_5.swapDepths(_local_3.getDepth() + 1);
                }
                if (_arg_6.__get__type().__get__intelligentSort()) {
                ...
                if (_arg_6.__get__type().__get__delayAnimStart()) {
                    _local_5.art.gotoAndStop(1);
                }
                if (_arg_6.__get__type().__get__playerInvisible()) {
