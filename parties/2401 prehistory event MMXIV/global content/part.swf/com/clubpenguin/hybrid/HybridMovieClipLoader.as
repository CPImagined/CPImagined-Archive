...
//Created by Action Script Viewer - http://www.buraks.com/asv
    class com.clubpenguin.hybrid.HybridMovieClipLoader extends mx.events.EventDispatcher
    {
        ...
        function loadClip(_arg_3, _arg_9, _arg_7) {
            var _local_4;
            if ((_arg_3 == undefined) || (_arg_3.indexOf("undefined") >= 0)) {
                ...
                _local_4 = (((_global.getCacheVersion() == undefined) || (_global.getCacheVersion() == "")) ? "" : ("?cacheVersion=" + _global.getCacheVersion()));
                _url = ((cacheVersion != null) ? ((_arg_3 + "?cacheVersion=") + cacheVersion) : (_arg_3 + _local_4));
                _container = _arg_9;
                _startTime = getTimer();
