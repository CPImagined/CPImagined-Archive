...
//Created by Action Script Viewer - http://www.buraks.com/asv
    class com.clubpenguin.world.rooms2014.prehistoric.PrehistoricParty_EngineOverrides
    {
        ...
        function updatePlayerFrame(player_id, _arg_6, _arg_14) {
            var _this = this;
            ...
            var _local_3;
            if (_arg_6 == _this.SHELL.WAVE_FRAME) {
            ...
            } else if (_arg_6 == _this.SHELL.DANCE_FRAME) {
            ...
            } else if ((_arg_6 >= _this.MIN_SITTING_FRAME) && (_arg_6 <= _this.MAX_SITTING_FRAME)) {
            ...
            if ((_arg_14 && (_local_3 >= _this.SHELL.CJ_BOW_RIGHT_FRAME)) && (_local_3 <= _this.SHELL.CJ_BOW_RIGHT_FRAME_ANGLE_UP)) {
                ...
                var _local_5 = mc.hand_mc.puffle;
                PrehistoricParty.pebug("puffleHandMC.dinoEggAnimating=" + _local_5.dinoEggAnimating);
                PrehistoricParty.pebug("puffleHandMC['dinoEggAnimating']=" + _local_5.dinoEggAnimating);
                PrehistoricParty.pebug("puffleHandMC[\"dinoEggAnimating\"]=" + _local_5.dinoEggAnimating);
                if (!_local_5.dinoEggAnimating) {
                ...
                if ((player_id == _this.SHELL.getMyPlayerId()) && (PrehistoricParty.isDinoPuffleEggEquipped(player_id))) {
                    ...
                    var _local_7 = PrehistoricParty.getStateOfDinoPuffle(_local_10);
                    if (((_local_3 >= 9) && (_local_3 <= 16)) || (_local_3 == _this.SHELL.DANCE_FRAME)) {
                        PrehistoricParty.pebug("Check what the state of the puffle is " + _local_7);
                        mc.hand_mc.puffle_onecrack._visible = false;
                        mc.hand_mc.puffle_twocracks._visible = false;
                        if ((_local_7 == 2) && (!_local_5.dinoEggAnimating)) {
                            mc.hand_mc.puffle_onecrack._visible = true;
                        }
                        if ((_local_7 == 3) && (!_local_5.dinoEggAnimating)) {
                            mc.hand_mc.puffle_twocracks._visible = true;
                        }
                    } else {
                        PrehistoricParty.pebug("f < 9 || f>16");
                        if ((_local_7 == 2) && (!_local_5.dinoEggAnimating)) {
