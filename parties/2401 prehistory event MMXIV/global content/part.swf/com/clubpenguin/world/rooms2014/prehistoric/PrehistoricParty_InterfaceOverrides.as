...
//Created by Action Script Viewer - http://www.buraks.com/asv
    class com.clubpenguin.world.rooms2014.prehistoric.PrehistoricParty_InterfaceOverrides
    {
        ...
        function updateQuestRewardsReady(_arg_4) {
            var _local_3 = this;
            _local_3.currentRewardCount = _arg_4;
            if ((_arg_4 > 0) && (!_global.getCurrentParty().PrehistoricParty.isPrehistoricRoom)) {
                _local_3.MAP_ICON.readyRewards._visible = true;
                if (_arg_4 > _local_3.ONE_DIGIT_MAX) {
                ...
                _local_3.MAP_ICON.readyRewards.amount.text = _arg_4;
            } else {
