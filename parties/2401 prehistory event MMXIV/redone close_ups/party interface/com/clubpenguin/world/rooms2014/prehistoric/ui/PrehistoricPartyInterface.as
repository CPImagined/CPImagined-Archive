//Created by Action Script Viewer - https://www.buraks.com/asv
    class com.clubpenguin.world.rooms2014.prehistoric.ui.PrehistoricPartyInterface
    {
        ...
        function PrehistoricPartyInterface (view) {
            _view = view;
        ...
        function setDefaultTransformEggState() {
            var _local_5 = com.clubpenguin.world.rooms2014.prehistoric.PrehistoricParty.partyCookie.trans;
        ...
        function onTransformationEggSelected(eggMC, eggKey) {
            com.clubpenguin.world.rooms2014.prehistoric.PrehistoricParty.playSound(_view, SFX_SELECT);
            setDefaultTransformEggState();
            eggMC.gotoAndStop("choose");
            _view.dinoDetails_mc.gotoAndStop(eggKey);
            var _local_2 = Number(dinosaurTransformsMapping[eggKey] + com.clubpenguin.world.rooms2014.prehistoric.PrehistoricParty.CONSTANTS.PARTYCOOKIE_TO_AVATAR_ID_OFFSET);
        ...
        function sendDinoTransformation(transformNum) {
            ...
            _local_2.start(0, 1);
            com.clubpenguin.world.rooms2014.prehistoric.PrehistoricParty.sendDinosaurTransformation(transformNum);
        ...
        function unlockDinoPuffleReward(itemMC, puffleNum) {
            itemMC.nextFrame();
            com.clubpenguin.party.BaseParty.configurePurchaseableItem(itemMC, com.clubpenguin.world.rooms2014.prehistoric.PrehistoricParty.CONSTANTS.PUFFLE_REWARDS_IDS[puffleNum], com.clubpenguin.party.BaseParty.PAPER_ITEM_TAG, false, false);
        }
        function sendEquipPuffleEgg(puffleIndex) {
            com.clubpenguin.world.rooms2014.prehistoric.PrehistoricParty.playSound(_view, SFX_EQUIP_COLLECT);
            setTimeout(com.clubpenguin.util.Delegate.create(this, sendEquipPuffleEggTimeout, puffleIndex), 500);
        }
        function sendEquipPuffleEggTimeout(puffleIndex) {
            com.clubpenguin.world.rooms2014.prehistoric.PrehistoricParty.pebug("sendEquipPuffleEggTimeout:puffleIndex=" + puffleIndex);
            com.clubpenguin.world.rooms2014.prehistoric.PrehistoricParty.playSound(_view, SFX_EQUIP_COLLECT);
            com.clubpenguin.world.rooms2014.prehistoric.PrehistoricParty.sendEquipPuffleEgg(puffleIndex);
            _INTERFACE.closeContent();
        }
        function closeUI() {
