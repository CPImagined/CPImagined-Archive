//Created by Action Script Viewer - https://www.buraks.com/asv
    class com.clubpenguin.engine.projectiles.SnowballManager
    {
        ...
        function throwBall(playerId, target_x, target_y, snowballVO) {
            trace("ENTERING SNOWBALL MANAGER THROW THE BALL");
            ...
            if (_SHELL.getIsRoomIgloo() || (_ENGINE.playerHostedRoomType == com.clubpenguin.world.rooms.common.RoomConstants.PLAYER_HOSTED_ROOM_BACKYARD)) {
                ...
                var _local_14 = _local_10.attachMovie(snowballVO.type.symbolName, "testSnowball", 1);
            ...
            if (_local_3.is_ready && (!_local_3.is_moving)) {
                ...
                _local_5 = _local_10.attachMovie(snowballVO.type.symbolName, _local_11, Number(1000200 + throwItemCounter), {_x:_local_2.start_x, _y:_local_2.start_y});
        ...
        function update() {
            ...
            for (var _local_9 in snowballData) {
                ...
                if (_local_2.w > _local_2.wait) {
                    ...
                    trace("SnowballManager.update: Is animation delayed " + _local_2.snowballType.delayAnimStart);
                    trace("SnowballManager.update: Is animation delayed " + _local_3.art._currentframe);
                    if (_local_2.snowballType.delayAnimStart && (_local_3.art._currentframe == 1)) {
                        trace("SnowballManager.play snowball animation");
