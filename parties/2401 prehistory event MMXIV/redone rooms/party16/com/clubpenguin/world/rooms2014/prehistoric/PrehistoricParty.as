//Created by Action Script Viewer - https://www.buraks.com/asv
    ...
    {
        static var _shell, _airtower, _interface, _engine, _party, _serverCookieService, _serverCookie, _purchaseItemThrottler, _joinRoomDelegate, _prehistoricDinoHitCheck, eggTypeFoundInGame, _interfaceOverrides, _engineOverrides, handlePuffleHatchingBroadcastReceivedDelegate;
        ...
        static function sendWalkDinoPuffle(puffleId) {
            ...
            pebug("sendWalkDinoPuffle " + puffleId, CLASS_NAME);
        }
        ...
        static function puffleHatchBroadcastReceived(data) {
            ...
            var _local_5 = _shell.getPlayerObjectById(_local_2).hand;
            switch (_local_3) {
                case 1 : 
                    var _local_6 = new com.clubpenguin.world.rooms2013.common.CallbackAnimation(_local_1.hand_mc.puffle, com.clubpenguin.util.Delegate.create(_this, stopDinoEggAnimating, _local_1.hand_mc.puffle), 15, 37);
                    break;
                case 2 : 
                    _local_6 = new com.clubpenguin.world.rooms2013.common.CallbackAnimation(_local_1.hand_mc.puffle, com.clubpenguin.util.Delegate.create(_this, stopDinoEggAnimating, _local_1.hand_mc.puffle), 38, 57);
                    break;
                case 3 : 
                    _local_1.hand_mc.puffle.dinoEggAnimating = true;
                    var _local_4 = _local_1.hand_mc.puffle._totalframes;
                    pebug("state = 3, lastFrame = " + _local_4);
                    _local_6 = new com.clubpenguin.world.rooms2013.common.CallbackAnimation(_local_1.hand_mc.puffle, com.clubpenguin.util.Delegate.create(_this, showDinoPuffleAdoption, _local_5, _local_2, _local_1.hand_mc.puffle), CONSTANTS.PUFFLE_HATCH_FRAME, _local_1.hand_mc.puffle._totalframes);
                    pebug("animCallback= " + _local_6);
                    break;
                default : 
        ...
        static function showDinoPuffleAdoption(puffleNum, playerID, puffleHandMC) {
            if (playerID == _shell.getMyPlayerId()) {
                ...
                _interface.showContent("puffle_adoption", null, null, {puffleAdoptionType:_local_2}, true);
                _shell.sendUpdatePlayerHand(0);
                com.clubpenguin.util.TrackerAS2.getInstance().trackRewardEarned("coins", -1, "puffle_adoption", _local_2, _global.getCurrentShell().getMyPlayerTotalCoins());
            } else {
                puffleHandMC.dinoEggAnimating = false;
            }
        }
        ...
        static function onPuffleCareStationFeed(playerID) {
            trace("onPuffleCareStationFeed " + playerID);
            var _local_6 = "w.puffle.sprite.eat";
            var _local_1 = _shell.getPlayerObjectById(playerID).attachedPuffle;
            if (_local_1) {
                var _local_5 = new com.clubpenguin.engine.puffles.animations.PuffleAnimationLoader(playerID, _local_1.id, _shell, _engine, true);
                _local_5.addEventListener(com.clubpenguin.engine.puffles.animations.PuffleAnimationLoader.PUFFLE_ANIMATION_EVENT, com.clubpenguin.util.Delegate.create(_this, onEatAnimationDone, playerID));
                var _local_4 = _local_1["color"];
                var _local_2 = _shell.getPath(_local_6);
                _local_2 = com.clubpenguin.util.StringUtils.replaceString("%color%", _local_4, _local_2);
                _local_5.playPuffleAnimation(_local_2);
            }
            com.clubpenguin.util.TrackerAS2.getInstance().trackGameAction("feed", "puffle_station", {message:"station_type=prehistoric_feeding|puffle_color=" + _local_4});
        }
