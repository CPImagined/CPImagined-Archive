...
class com.clubpenguin.world.rooms2024.trailblazer.Trailblazer {
	...
	static function setServerCookie() {
		_serverCookie = new com.clubpenguin.world.rooms2024.trailblazer.vo.TrailblazerCookieVO(PARTY_COOKIE_ID);
	}
    ...
    static function get partyCookie() {
        return (com.clubpenguin.world.rooms2024.trailblazer.vo.TrailblazerCookieVO(_serverCookie));
    }
	...
	*/
    ...
    static function get interfaceOverrides() {
        if (_interfaceOverrides == null) {
            _interfaceOverrides = new com.clubpenguin.world.rooms2024.trailblazer.Trailblazer_InterfaceOverrides();
        }
        return (_interfaceOverrides);
    }
    static function get engineOverrides() {
        if (_engineOverrides == null) {
            _engineOverrides = new com.clubpenguin.world.rooms2024.trailblazer.Trailblazer_EngineOverrides();
        }
    ...
    static function get questCom() {
        return com.clubpenguin.world.rooms2024.trailblazer.TrailblazerQuestCom;
    }
    ...
    static var CONSTANTS = com.clubpenguin.world.rooms2024.trailblazer.TrailblazerConstants;
    static var CLASS_NAME = "Trailblazer";
    static var PARTY_COOKIE_ID = CONSTANTS.PARTY_COOKIE_ID;
    static var _this = com.clubpenguin.world.rooms2024.trailblazer.Trailblazer;
