class com.disney.dlearning.security.Md5
{
    ...
    {
        return (this.md5_cmn(b & c | (b ^ 4294967295.000000) & d, a, b, x, s, t));
    } // End of the function
    function md5_gg(a, b, c, d, x, s, t)
    {
        return (this.md5_cmn(b & d | c & (d ^ 4294967295.000000), a, b, x, s, t));
    } // End of the function
    ...
    {
        return (this.md5_cmn(c ^ (b | d ^ 4294967295.000000), a, b, x, s, t));
    } // End of the function
