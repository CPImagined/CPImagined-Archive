...
//Created by Action Script Viewer - http://www.buraks.com/asv
    class com.clubpenguin.shell.PuffleModel
    {
        ...
        static function formatAssetURL(_arg_1, _arg_4, _arg_3) {
            var _local_2 = (isNaN(_arg_3) ? "" : (_arg_3));
            _arg_1 = com.clubpenguin.util.StringUtils.replaceString("%color%", _arg_4, _arg_1);
            _arg_1 = com.clubpenguin.util.StringUtils.replaceString("%wildTypeId%", _local_2, _arg_1);
            return(_arg_1);
        }
        var id = -1;
        var typeID = -1;
