...
class com.clubpenguin.world.rooms2024.snow.SnowParty {
	...
	static function setServerCookie() {
		_serverCookie = new com.clubpenguin.world.rooms2024.snow.vo.SnowPartyCookieVO(PARTY_COOKIE_ID);
	}
    ...
    static function get partyCookie() {
        return (com.clubpenguin.world.rooms2024.snow.vo.SnowPartyCookieVO(_serverCookie));
    }
    ...
    static function get interfaceOverrides() {
        if (_interfaceOverrides == null) {
            _interfaceOverrides = new com.clubpenguin.world.rooms2024.snow.SnowParty_InterfaceOverrides();
        }
        return (_interfaceOverrides);
    }
    static function get engineOverrides() {
        if (_engineOverrides == null) {
            _engineOverrides = new com.clubpenguin.world.rooms2024.snow.SnowParty_EngineOverrides();
        }
    ...
    static function get questCom() {
        return com.clubpenguin.world.rooms2024.snow.SnowPartyQuestCom;
    }
    ...
    static var CONSTANTS = com.clubpenguin.world.rooms2024.snow.SnowPartyConstants;
    static var CLASS_NAME = "TemplatedParty";
    static var PARTY_COOKIE_ID = CONSTANTS.PARTY_COOKIE_ID;
    static var _this = com.clubpenguin.world.rooms2024.snow.SnowParty;
