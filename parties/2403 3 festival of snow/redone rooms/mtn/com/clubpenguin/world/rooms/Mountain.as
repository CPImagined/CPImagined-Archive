//Created by Action Script Viewer - https://www.buraks.com/asv
    ...
    {
        var _stage, _SHELL, _destroyDelegate, _INTERFACE, _triggerWatcher, _triggerWatcherInterval, _abductionDelegate, aliendAbduction, setupNavigationButtons, showContent, setupHint, wem, _ENGINE;
        ...
        function configureTriggers() {
			...
			_stage.triggers_mc.freeItem_mc.triggerFunction = com.clubpenguin.util.Delegate.create(this,this.pickUpSnowShirt);
        }
		function pickUpSnowShirt() {
			_INTERFACE.buyInventory(207);
		}
        function configureNavigation() {
            setupNavigationButtons([new com.clubpenguin.world.rooms.common.NavigationButtonVO(_stage.background_mc.exit_btn, 630, 253), new com.clubpenguin.world.rooms.common.NavigationButtonVO(_stage.navFreeItem_btn, 205, 190), new com.clubpenguin.world.rooms.common.NavigationButtonVO(_stage.background_mc.hut_btn, 522, 153), new com.clubpenguin.world.rooms.common.NavigationButtonVO(_stage.waddle100_mc.game_btn, 152, 270), new com.clubpenguin.world.rooms.common.NavigationButtonVO(_stage.waddle101_mc.game_btn, 322, 314), new com.clubpenguin.world.rooms.common.NavigationButtonVO(_stage.waddle102_mc.game_btn, 433, 314), new com.clubpenguin.world.rooms.common.NavigationButtonVO(_stage.waddle103_mc.game_btn, 538, 300)]);
        }
