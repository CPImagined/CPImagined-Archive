...
class com.clubpenguin.world.rooms2024.fools.FoolsParty {
	...
	static function setServerCookie() {
		_serverCookie = new com.clubpenguin.world.rooms2024.fools.vo.FoolsPartyCookieVO(PARTY_COOKIE_ID);
	}
    ...
    static function get partyCookie() {
        return (com.clubpenguin.world.rooms2024.fools.vo.FoolsPartyCookieVO(_serverCookie));
    }
	...
	static function onRoomInitialized() {
		...
		if (_shell.getCurrentRoomId() == 110) {
			_engine.avatarManager.transformationManager.sendTransformPlayer(2001);
		} else if (_shell.getMyPlayerObject().avatar_id == 2001) {
    ...
    static function get interfaceOverrides() {
        if (_interfaceOverrides == null) {
            _interfaceOverrides = new com.clubpenguin.world.rooms2024.fools.FoolsParty_InterfaceOverrides();
        }
        return (_interfaceOverrides);
    }
    static function get engineOverrides() {
        if (_engineOverrides == null) {
            _engineOverrides = new com.clubpenguin.world.rooms2024.fools.FoolsParty_EngineOverrides();
        }
    ...
    static function get questCom() {
        return com.clubpenguin.world.rooms2024.fools.FoolsPartyQuestCom;
    }
    ...
    static var CONSTANTS = com.clubpenguin.world.rooms2024.fools.FoolsPartyConstants;
    static var CLASS_NAME = "FoolsParty";
    static var PARTY_COOKIE_ID = CONSTANTS.PARTY_COOKIE_ID;
    static var _this = com.clubpenguin.world.rooms2024.fools.FoolsParty;
