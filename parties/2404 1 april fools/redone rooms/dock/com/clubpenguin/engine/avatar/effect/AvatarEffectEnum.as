//Created by Action Script Viewer - https://www.buraks.com/asv
    class com.clubpenguin.engine.avatar.effect.AvatarEffectEnum
    {
        ...
        static var MUPPETS_PIE_JOIN_ICON = new com.clubpenguin.engine.avatar.effect.AvatarEffectEnum(LIB_AVATAR_NAME, "pieJoinIcon", FLAG_ATTACH_TO_PLAYER | FLAG_STOP_ON_LAST_FRAME);
        static var MUPPETS_MIC_JOIN_ICON = new com.clubpenguin.engine.avatar.effect.AvatarEffectEnum(LIB_AVATAR_NAME, "micJoinIcon", FLAG_ATTACH_TO_PLAYER | FLAG_STOP_ON_LAST_FRAME);
        static var MUPPETS_CAPE_JOIN_ICON = new com.clubpenguin.engine.avatar.effect.AvatarEffectEnum(LIB_AVATAR_NAME, "capeJoinIcon", FLAG_ATTACH_TO_PLAYER | FLAG_STOP_ON_LAST_FRAME);
        static var MUPPETS_TONGS_JOIN_ICON = new com.clubpenguin.engine.avatar.effect.AvatarEffectEnum(LIB_AVATAR_NAME, "tongsJoinIcon", FLAG_ATTACH_TO_PLAYER | FLAG_STOP_ON_LAST_FRAME);
        static var MUPPETS_CANE_JOIN_ICON = new com.clubpenguin.engine.avatar.effect.AvatarEffectEnum(LIB_AVATAR_NAME, "caneJoinIcon", FLAG_ATTACH_TO_PLAYER | FLAG_STOP_ON_LAST_FRAME);
        static var MUPPETS_BEAKERS_JOIN_ICON = new com.clubpenguin.engine.avatar.effect.AvatarEffectEnum(LIB_AVATAR_NAME, "beakersJoinIcon", FLAG_ATTACH_TO_PLAYER | FLAG_STOP_ON_LAST_FRAME);
        static var MUPPETS_DRUM_JOIN_ICON = new com.clubpenguin.engine.avatar.effect.AvatarEffectEnum(LIB_AVATAR_NAME, "drumJoinIcon", FLAG_ATTACH_TO_PLAYER | FLAG_STOP_ON_LAST_FRAME);
        static var MUPPETS_MARACAS_JOIN_ICON = new com.clubpenguin.engine.avatar.effect.AvatarEffectEnum(LIB_AVATAR_NAME, "maracasJoinIcon", FLAG_ATTACH_TO_PLAYER | FLAG_STOP_ON_LAST_FRAME);
