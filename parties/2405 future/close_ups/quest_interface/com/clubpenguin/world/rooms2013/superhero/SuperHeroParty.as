//Created by Action Script Viewer - https://www.buraks.com/asv
    class com.clubpenguin.world.rooms2013.superhero.SuperHeroParty
    {
        ...
        function init() {
            ...
            _shell.addListener(_shell.JOIN_ROOM, showLoginScreen, this);
            opcodeJournal = new com.clubpenguin.world.rooms2013.superhero.OpcodeJournal();
        }
        function showLoginScreen() {
            _shell.removeListener(_shell.JOIN_ROOM, showLoginScreen);
            var _local_2 = _shell.getRoomObject();
            if (_local_2.room_id != 112) {
        ...
        function isItemAPowerGlove(itemID) {
            ...
            trace("SUPERHEROPARTY: item isn't one of the main powergloves");
