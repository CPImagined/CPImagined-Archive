//Created by Action Script Viewer - https://www.buraks.com/asv
    ...
    {
        static var _shell, _airtower, _interface, _engine, _party, _serverCookieService, _serverCookie, MECHCONTROLLER, _quests, _engineOverrides, _interfaceOverrides, _shellOverrides, _snowballCoolDownExpirationDate;
        ...
        static function init() {
            ...
            activateShellOverrides();
            activateFutureSnowballManagerOverride();
            com.clubpenguin.world.rooms2014.future.FuturePartySounds.init();
        }
        ...
        static function get shellOverrides() {
            if (_shellOverrides == null) {
                _shellOverrides = new com.clubpenguin.world.rooms2014.future.FutureParty_ShellOverrides();
            }
        ...
        static function checkPlayerBlastoff(player_id) {
            ...
            } else if (player_id == _shell.getMyPlayerId()) {
        ...
        static function initPartyAvatars() {
            ...
            _local_3.speechBubbleOffsetY = -30;
        ...
        static function activateShellOverrides() {
            _shell.sendUpdatePlayerNeck = com.clubpenguin.util.Delegate.create(_shell, shellOverrides.sendUpdatePlayerNeck);
        }
        ...
        static function activateHUDIconOverrides() {
            _interface.showIcons = com.clubpenguin.util.Delegate.create(_interface, interfaceOverrides.showIcons);
        }
        static function deactivateHUDIconOverrides() {
            _interface.showIcons = com.clubpenguin.util.Delegate.create(_interface, interfaceOverrides.defaultShowIcons);
        }
        ...
        static function sendPurchaseFutureItem(itemId) {
            ...
            sendPurchaseFutureItemBI(itemId);
        }
