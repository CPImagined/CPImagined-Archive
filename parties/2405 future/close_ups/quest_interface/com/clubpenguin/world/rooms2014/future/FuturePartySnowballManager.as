//Created by Action Script Viewer - https://www.buraks.com/asv
    ...
    {
        var _INTERFACE, _ENGINE, maxSnowballs, _SHELL, throwItemCounter, snowballData, _stageMaskRectForCollision;
        function FuturePartySnowballManager (shell, engine, _interface) {
            super(shell, engine, _interface);
            _INTERFACE = _interface;
            _ENGINE = engine;
            var _local_3 = new com.clubpenguin.world.rooms2014.future.FuturePartySnowballHitCheck();
            maxSnowballs = 20;
        ...
        function throwBall(playerId, target_x, target_y, snowballVO) {
            ...
            if (playerId == _SHELL.getMyPlayerId()) {
                ...
                com.clubpenguin.world.rooms2014.future.FuturePartySounds.playSnowballSFX(playerId);
            }
        }
        function update() {
            ...
            for (var _local_13 in snowballData) {
                ...
                if (_local_2.w > _local_2.wait) {
                    ...
                    _local_2.t++;
                    if ((!(((((_local_3._x < 0) || (_local_3._x > Stage.width)) || (_local_3._x < 0)) || (_local_3._y > Stage.height)) || (_local_3.hit))) && (_local_2.t < (_local_2.duration * 2))) {
                        ...
                        if (_local_3._currentframe != 1) {
                            ...
                            if (_local_2.snowballType.hasTail) {
                                _local_3.art._rotation = com.clubpenguin["math"].MathHelper.getAngleBetweenCoordinates(_local_2.start_x, _local_2.start_y, _local_2.target_x, _local_2.target_y);
                            }
                        }
        ...
        function checkForCollision(p_clip1, p_clip2, p_alphaTolerance) {
            var _local_15 = p_clip1.hitTest(p_clip2);
            if (!_local_15) {
                return(_local_15);
            }
            ...
            var _local_6 = 400;
            var _local_7 = System.capabilities.screenResolutionX / 1920;
            if (_stageMaskRectForCollision) {
                _stageMaskRectForCollision._width = (Stage.width + _local_6) * _local_7;
                _stageMaskRectForCollision._height = (Stage.height + _local_6) * _local_7;
                ...
                _stageMaskRectForCollision.beginFill(16711680, 0.25);
                _stageMaskRectForCollision.moveTo(0, 0);
                var _local_13 = (Stage.width + _local_6) * _local_7;
                var _local_16 = (Stage.height + _local_6) * _local_7;
                _stageMaskRectForCollision.lineTo(_local_13, 0);
                _stageMaskRectForCollision.lineTo(_local_13, _local_16);
                _stageMaskRectForCollision.lineTo(0, _local_16);
            ...
            var _local_9 = new flash.display.BitmapData(_stageMaskRectForCollision._width, _stageMaskRectForCollision._height, false);
            var _local_10 = p_clip1.transform.concatenatedMatrix;
            _local_10.tx = _local_10.tx - _local_3.xMin;
            _local_10.ty = _local_10.ty - _local_3.yMin;
            _local_9.draw(p_clip1, _local_10, new flash.geom.ColorTransform(1, 1, 1, 1, 255, -255, -255, p_alphaTolerance));
            var _local_8 = p_clip2.transform.concatenatedMatrix;
            _local_8.tx = _local_8.tx - _local_3.xMin;
            _local_8.ty = _local_8.ty - _local_3.yMin;
            _local_9.draw(p_clip2, _local_8, new flash.geom.ColorTransform(1, 1, 1, 1, 255, 255, 255, p_alphaTolerance), "difference");
            var _local_17 = _local_9.getColorBoundsRect(4294967295, 4278255615);
            if (_local_17.width == 0) {
                return(null);
            }
            return(true);
        }
