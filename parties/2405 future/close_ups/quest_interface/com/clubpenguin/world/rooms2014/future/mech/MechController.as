//Created by Action Script Viewer - https://www.buraks.com/asv
    class com.clubpenguin.world.rooms2014.future.mech.MechController
    {
        ...
        static function triggerBlastoff(player_id) {
            if (((_shell.getMyPlayerId() == player_id) && (_party.FutureParty.isBlastingOff != undefined)) && (_party.FutureParty.isBlastingOff)) {
            ...
            if (_shell.getMyPlayerId() == player_id) {
                ...
                _party.FutureParty.isBlastingOff = true;
                setTimeout(com.clubpenguin.util.Delegate.create(_this, unlockBlastoffAction), 2000);
            }
            ...
            if (isPlayerMech(player_id)) {
                ...
                com.clubpenguin.world.rooms2014.future.FuturePartySounds.playMechBlastoffStart(player_id);
                return(undefined);
            }
            if (isPlayerOnJetpack(player_id)) {
                com.clubpenguin.world.rooms2014.future.FuturePartySounds.playJetpackBlastoff(player_id);
                tweenPlayer(player_id);
            }
        }
        static function unlockBlastoffAction() {
            _party.FutureParty.isBlastingOff = false;
        }
        static function tweenPlayer(player_id) {
            ...
            var _local_2 = _local_3._y / MECH_BLASTOFF_SPEED;
            com.clubpenguin.util.Log.debug("MechController.tweenSpeed " + _local_2);
            if (_party.FutureParty.inSpaceRoom) {
                _local_2 = _local_2 * 2;
            }
            com.greensock.TweenMax.to(_local_3, _local_2, {_x:_local_3._x, _y:_local_4, _xscale:(_party.FutureParty.inSpaceRoom ? 1 : 100), _yscale:(_party.FutureParty.inSpaceRoom ? 1 : 100), overwrite:true, onComplete:com.clubpenguin.util.Delegate.create(_this, sendContextualJoinRoom, _local_3._x, player_id)});
            com.greensock.TweenMax.to(_local_5, _local_2, {_x:_local_5._x, _y:_local_4});
            com.clubpenguin.world.rooms2014.future.FuturePartySounds.playMechBlastOff(player_id);
            if (!_party.FutureParty.inSpaceRoom) {
        ...
        static function sendContextualJoinRoom(xPos, player_id) {
            ...
            _engine.enableMouseMovement();
            _interface.startQuickKeys();
            var _local_7 = (_local_1 >= _party.FutureParty.CONSTANTS.FIRST_PARTY_ROOM_ID) && (_local_1 <= _party.FutureParty.CONSTANTS.FIFTH_PARTY_ROOM_ID);
            var _local_8 = (_local_1 > _party.FutureParty.CONSTANTS.FIFTH_PARTY_ROOM_ID) && (_local_1 <= _party.FutureParty.CONSTANTS.EIGHTH_PARTY_ROOM_ID);
            var _local_6 = (_local_1 == _party.FutureParty.CONSTANTS.SPACE_ROOM_1_ID) || (_local_1 == _party.FutureParty.CONSTANTS.SPACE_ROOM_2_ID);
            var _local_9 = _local_1 == _party.FutureParty.CONSTANTS.SPACE_ROOM_3_ID;
            var _local_2;
            if (_local_7) {
                _local_2 = _party.FutureParty.CONSTANTS.SPACE_ROOM_2_ID;
            } else if (_local_8) {
                _local_2 = _party.FutureParty.CONSTANTS.SPACE_ROOM_1_ID;
            } else if (_local_6) {
                var _local_3 = _shell.getLastRoomId();
                var _local_5 = ((_local_3 == _party.FutureParty.CONSTANTS.SPACE_ROOM_1_ID) || (_local_3 == _party.FutureParty.CONSTANTS.SPACE_ROOM_2_ID)) || (_local_3 == _party.FutureParty.CONSTANTS.SPACE_ROOM_3_ID);
                if (_local_5) {
                    _local_2 = _party.FutureParty.CONSTANTS.FIRST_PARTY_ROOM_ID;
                } else {
            ...
            var _local_4 = _shell.getRoomNameById(_local_2);
            _shell.sendJoinRoom(_local_4);
