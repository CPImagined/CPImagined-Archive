//Created by Action Script Viewer - https://www.buraks.com/asv
    class com.clubpenguin.party.BaseParty
    {
        ...
        static function playSound(ui, soundId, volume, looping) {
            ...
            if (looping) {
                _local_1.start(0, 99999999);
            } else {
                _local_1.start();
            }
            SOUND_CONTAINER[soundId] = _local_1;
        }
        static function stopSound(ui, soundId) {
            if (SOUND_CONTAINER[soundId] != undefined) {
                SOUND_CONTAINER[soundId].stop();
                SOUND_CONTAINER[soundId] = undefined;
            }
        }
        ...
        static var SOUND_CONTAINER = new Object();
