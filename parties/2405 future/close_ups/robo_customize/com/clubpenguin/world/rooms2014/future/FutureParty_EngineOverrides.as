//Created by Action Script Viewer - https://www.buraks.com/asv
    class com.clubpenguin.world.rooms2014.future.FutureParty_EngineOverrides
    {
        ...
        function movePlayer(player_id, target_x, target_y, is_trigger, frame) {
            ...
            com.clubpenguin.util.Log.debug("can blast off " + _global.getCurrentParty().FutureParty.MECHCONTROLLER.canPlayerBlastOff);
            com.clubpenguin.util.Log.debug("space room " + _global.getCurrentParty().FutureParty.inSpaceRoom);
            com.clubpenguin.util.Log.debug("room " + _global.getCurrentShell().getRoomObject().room_id);
