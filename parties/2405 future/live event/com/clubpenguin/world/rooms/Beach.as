...
{
   var _stage, localize, setupNavigationButtons, _SHELL, _liveEvent, _INTERFACE, _destroyDelegate, wem, _abductionDelegate, aliendAbduction;
   function Beach(stageReference)
   {
      ...
      _stage.bucket_mc.bucket_mc.bucket_btn.onRollOver = com.clubpenguin.util.Delegate.create(this, bucketAnimate);
      _stage.bucket_mc.bucket_mc.bucket_btn.onRelease = com.clubpenguin.util.Delegate.create(this, moveToMouse);
      _stage.bucket_mc.bucket_mc.bucket_btn.useHandCursor = false;
   ...
   {
      _stage.bucket_mc.bucket_mc.play();
   }
