package com.clubpenguin.games.bounce{
    ...
    import com.clubpenguin.games.bounce.movies.ParallaxMC;
    import com.clubpenguin.games.bounce.*;

    internal class Parallax extends MovieClip {
        ...
        public function Parallax(_arg_1:MovieClip, _arg_2:Number, _arg_3:Number, _arg_4:String, _arg_5:String){
            this.game = _arg_1;
            this.kind = "parallax";
            this.game.objectsN++;
            this.gameplayHolder = this.game.gameplayHolder;
            this.movie = new ParallaxMC();
