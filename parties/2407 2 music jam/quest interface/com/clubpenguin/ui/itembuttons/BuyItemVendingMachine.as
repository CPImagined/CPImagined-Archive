//Created by Action Script Viewer - https://www.buraks.com/asv
    class com.clubpenguin.ui.itembuttons.BuyItemVendingMachine
    {
        ...
        function onPurchaseButtonClicked(id) {
            ...
            if (_local_3[LOADING_MC_LINKAGE_NAME] != undefined) {
                _local_3[LOADING_MC_LINKAGE_NAME]._visible = true;
            } else {
                _local_3.attachMovie(LOADING_MC_LINKAGE_NAME, LOADING_MC_LINKAGE_NAME, _local_3.getNextHighestDepth(), {_x:_local_3._width / 2, _y:_local_3._height / 2});
            }
        ...
        function handleItemPurchased(id) {
            ...
            if (_local_2.type == "puffle") {
                ...
                _local_3[LOADING_MC_LINKAGE_NAME]._visible = false;
            } else {
                _local_3[LOADING_MC_LINKAGE_NAME].removeMovieClip();
                _local_3[LOADING_MC_LINKAGE_NAME] = undefined;
            }
        ...
        static var LOADING_MC_LINKAGE_NAME = "loadingMC";
