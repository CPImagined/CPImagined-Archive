//Created by Action Script Viewer - https://www.buraks.com/asv
    ...
    {
        var _customPurchase, __get__customPurchase, _itemID, _itemMC, checkPurchaseOfItem, CLAIM_BUTTON_INSTANCE_NAME, CLAIM_BUTTON_TEXT_LABEL, ITEM_PURCHASE_EVENT, addItemPurchasedListener, _prompt, __get__itemID, onInventoryBoughtSignal, _callback, _purchaseCallback;
        ...
        function onInventoryBought(event) {
            ...
            onInventoryBoughtSignal.dispatch(event.success);
            if (event.success) {
                _itemMC.gotoAndStop(_itemMC._totalframes);
