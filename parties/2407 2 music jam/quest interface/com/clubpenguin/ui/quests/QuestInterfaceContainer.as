//Created by Action Script Viewer - https://www.buraks.com/asv
    class com.clubpenguin.ui.quests.QuestInterfaceContainer
    {
        ...
        function configurePanelScrolling() {
            if ((_view.button_left != null) && (_view.button_left != undefined)) {
                _buttonLeft = _view.button_left;
            } else {
                _buttonLeft = _view._parent.button_left;
            }
            if ((_view.button_right != null) && (_view.button_right != undefined)) {
                _buttonRight = _view.button_right;
            } else {
                _buttonRight = _view._parent.button_right;
            }
            if ((_view.statusdisplay != null) && (_view.statusdisplay != undefined)) {
                _statusDisplay = _view.statusdisplay;
            } else {
                _statusDisplay = _view._parent.statusdisplay;
            }
