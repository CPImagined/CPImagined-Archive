//Created by Action Script Viewer - https://www.buraks.com/asv
    class com.clubpenguin.ui.itembuttons.BuyPuffleItemButton extends com.clubpenguin.ui.itembuttons.BuyItemButtonBase
    {
        ...
        var _customPurchase, __get__customPurchase, __get__puffleItemsInView, __get__quantityTextName, _itemID, _itemMC, checkPurchaseOfItem, CLAIM_BUTTON_INSTANCE_NAME, ITEM_PURCHASE_EVENT, addItemPurchasedListener, _callback, _purchaseCallback;
        ...
        function buyItem() {
            ...
            trace("BuyPuffleItemButton.buyItem _itemID " + _itemID);
        ...
        function onInventoryBought(event) {
            ...
            if (event.success) {
                trace("BuyPuffleItemButton.onInventoryBought event.quantity" + event.quantity);
                ...
                trace("BuyPuffleItemButton.onInventoryBought _callback" + _callback);
                _purchaseCallback();
                _callback();
            }
        }
