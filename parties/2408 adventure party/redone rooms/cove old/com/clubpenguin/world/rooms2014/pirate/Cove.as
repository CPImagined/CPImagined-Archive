//Created by Action Script Viewer - https://www.buraks.com/asv
    ...
    {
        var _stage, _SHELL, localize, setupHint, _destroyDelegate, _triggerWatcher, showContent, _triggerWatcherInterval, setupNavigationButtons, _ENGINE, _roomUpdateInterval;
        ...
        function configureNavigation() {
            setupNavigationButtons([new com.clubpenguin.world.rooms.common.NavigationButtonVO(_stage.forestNav_btn, 130, 178), new com.clubpenguin.world.rooms.common.NavigationButtonVO(_stage.chestNav_btn, 287, 207), new com.clubpenguin.world.rooms.common.NavigationButtonVO(_stage.waves_mc.waves_btn, 187, 347)]);
