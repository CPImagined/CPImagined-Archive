//Created by Action Script Viewer - https://www.buraks.com/asv
    class hockey.BallGroup
    {
        ...
        function makeLineBetweenMCs(mc1, mc2) {
            var _local_4 = new com.robertpenner.Line(mc1._x, mc1._y, mc2._x, mc2._y);
            lines.push(_local_4);
            mc1._visible = false;
            mc2._visible = false;
        }
        ...
        function collideWithNets() {
            ...
            if (puck.sprite.hitTest(netLeft_mc)) {
                _local_2 = true;
                var _local_5 = puck.pos.y;
                var _local_4 = _local_5 - netLeft_mc._y;
                if (((-maxVerticalFromNetCenter) < _local_4) && (_local_4 < maxVerticalFromNetCenter)) {
        ...
        function collideWithWalls() {
            var _local_6 = 0;
            while (_local_6 < items.length) {
                var _local_7 = false;
                var _local_2 = items[_local_6];
                var _local_4 = 0;
        ...
        var maxVerticalFromNetCenter = 15;
