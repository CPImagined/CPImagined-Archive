...
class com.clubpenguin.party.template.TemplatedParty {
	...
	static function setServerCookie() {
		_serverCookie = new com.clubpenguin.party.template.vo.TemplatedPartyCookieVO(PARTY_COOKIE_ID);
	}
    ...
    static function get partyCookie() {
        return (com.clubpenguin.party.template.vo.TemplatedPartyCookieVO(_serverCookie));
    }
	...
	*/
    ...
    static function get interfaceOverrides() {
        if (_interfaceOverrides == null) {
            _interfaceOverrides = new com.clubpenguin.party.template.TemplatedParty_InterfaceOverrides();
        }
        return (_interfaceOverrides);
    }
    static function get engineOverrides() {
        if (_engineOverrides == null) {
            _engineOverrides = new com.clubpenguin.party.template.TemplatedParty_EngineOverrides();
        }
    ...
    static function get questCom() {
        return com.clubpenguin.party.template.TemplatedPartyQuestCom;
    }
    ...
    static var CONSTANTS = com.clubpenguin.party.template.TemplatedPartyConstants;
    static var CLASS_NAME = "TemplatedParty";
    static var PARTY_COOKIE_ID = CONSTANTS.PARTY_COOKIE_ID;
    static var _this = com.clubpenguin.party.template.TemplatedParty;
