...
class com.clubpenguin.world.rooms2024.medieval.MedievalParty {
	...
	static function setServerCookie() {
		_serverCookie = new com.clubpenguin.world.rooms2024.medieval.vo.MedievalPartyCookieVO(PARTY_COOKIE_ID);
	}
    ...
    static function get partyCookie() {
        return (com.clubpenguin.world.rooms2024.medieval.vo.MedievalPartyCookieVO(_serverCookie));
    }
    ...
    static function checkForLoginDialogue(_arg_1) {
		...
		} else if (partyCookie[CONSTANTS.MESSAGE_KEY][1] == 0 && partyCookie[CONSTANTS.TASK_KEY][7] == 1) {
			_interface.showContent("w.p2024.medieval.week2.login");
		};
    }
    ...
    static function get interfaceOverrides() {
        if (_interfaceOverrides == null) {
            _interfaceOverrides = new com.clubpenguin.world.rooms2024.medieval.MedievalParty_InterfaceOverrides();
        }
        return (_interfaceOverrides);
    }
    static function get engineOverrides() {
        if (_engineOverrides == null) {
            _engineOverrides = new com.clubpenguin.world.rooms2024.medieval.MedievalParty_EngineOverrides();
        }
    ...
    static function get questCom() {
        return com.clubpenguin.world.rooms2024.medieval.MedievalPartyQuestCom;
    }
    ...
    static var CONSTANTS = com.clubpenguin.world.rooms2024.medieval.MedievalPartyConstants;
    static var CLASS_NAME = "TemplatedParty";
    static var PARTY_COOKIE_ID = CONSTANTS.PARTY_COOKIE_ID;
    static var _this = com.clubpenguin.world.rooms2024.medieval.MedievalParty;
