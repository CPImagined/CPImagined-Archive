//Created by Action Script Viewer - https://www.buraks.com/asv
    class com.clubpenguin.world.rooms2012.medieval.Mountain extends com.clubpenguin.world.rooms.BaseRoom
    {
        ...
        function init() {
            ...
            _stage.triggers_mc.bridge_mc.triggerFunction = com.clubpenguin.util.Delegate.create(this, exit, "party25", 20, 446);
        ...
        function checkGateRequirements() {
            ...
            if (_PARTY.getTaskComplete(7) || (_PARTY.getTaskComplete(4) && _PARTY.getTaskComplete(5) && _PARTY.getTaskComplete(6))) {
                ...
                _INTERFACE.showContent(com.clubpenguin.world.rooms2012.medieval.MedievalParty.OOPS_MEMBER_MOUNTAIN_GATE);
            }
        }
        function closeGate() {
