package com.clubpenguin.lib.util.math
{
	...
	public class MathUtil
	{
		...
		public static function findAngle(fromX:Number, fromY:Number, toX:Number, toY:Number):Number
		{
			var horiz = toX - fromX;
			var vert = toY - fromY;
			var angle = Math.atan2(vert,horiz);
		...
		public static function findAngleBetweenPoints(from:Point, to:Point):Number
		{
			var dist = to.subtract(from);
		...
		{
			return Math.round(Math.sqrt(triangleWidth * triangleWidth + triangleHeight * triangleHeight));
		}
		...
		public static function findPositionOffsetAfterParentRotation(pointX:Number, pointY:Number, parentX:Number, parentY:Number, parentAngle:Number):Point
		{
			...
			return MathUtil.findMotionFromAngle(angle,dist);
		}
		
		public static function findPositionXAfterParentRotation(pointX:Number, pointY:Number, parentX:Number, parentY:Number, parentAngle:Number):Number
		{
			return parentX + MathUtil.findPositionOffsetAfterParentRotation(pointX, pointY, parentX, parentY, parentAngle).x;
		}
		
		public static function findPositionYAfterParentRotation(pointX:Number, pointY:Number, parentX:Number, parentY:Number, parentAngle:Number):Number
		{
			return parentY + MathUtil.findPositionOffsetAfterParentRotation(pointX, pointY, parentX, parentY, parentAngle).y;
		}
		...
		{
			return new Point(parentX, parentY).add(MathUtil.findPositionOffsetAfterParentRotation(pointX, pointY, parentX, parentY, parentAngle));
		}
