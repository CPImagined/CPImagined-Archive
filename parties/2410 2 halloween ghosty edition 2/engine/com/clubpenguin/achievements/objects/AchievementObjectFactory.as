//Created by Action Script Viewer - https://www.buraks.com/asv
    class com.clubpenguin.achievements.objects.AchievementObjectFactory
    {
        ...
        function createObject(descriptor) {
            var _local_2 = 0;
            while (_local_2 < descriptor.length) {
                descriptor[_local_2] = descriptor[_local_2].split(XML_QUOTATION).join("\"");
                _local_2++;
            }
            debugTrace("createObject - " + descriptor.join(" "));
            if (descriptor[0] == "myIgloo") {
                var _local_4 = new com.clubpenguin.achievements.objects.AchievementObject(descriptor);
                _local_4.addElement(descriptor);
                return(_local_4);
            }
