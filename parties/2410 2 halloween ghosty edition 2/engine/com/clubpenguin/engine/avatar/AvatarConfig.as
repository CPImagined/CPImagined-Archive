//Created by Action Script Viewer - https://www.buraks.com/asv
    class com.clubpenguin.engine.avatar.AvatarConfig
    {
        ...
        static function initMascotAvatars() {
			...
			_global.com.clubpenguin.engine.avatar.AvatarConfig._model.setAvatarTemplate(41, _local_6);
			// temp gary for halloween
			var _local_7 = _global.com.clubpenguin.engine.avatar.AvatarConfig._defaultAvatar.clone();
			_local_7.spritePath = "gariwald_mascot";
			_local_7.isSpriteTransformed = true;
			_local_7.attachItems = false;
			var BALL_GHOST = new com.clubpenguin.engine.projectiles.SnowballEnum("ballghostcanister", com.clubpenguin.engine.projectiles.SnowballEnum.FLAG_NONE);
			_local_7.snowball = new _global.com.clubpenguin.engine.projectiles.vo.SnowballVO(BALL_GHOST, -100, 20);
			com.clubpenguin.engine.avatar.AvatarConfig._model.setSnowballHitCheck(BALL_GHOST, new com.clubpenguin.engine.projectiles.SnowballHitCheck());
			_global.com.clubpenguin.engine.avatar.AvatarConfig._model.setAvatarTemplate(4, _local_7);
        }
    }
