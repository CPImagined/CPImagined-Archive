class com.disney.dlearning.managers.DLSManager
{
   ...
   {
      var _loc6_ = new Date();
      var _loc3_ = Math.round(_loc6_.getTime() / 1000);
      ...
      var _loc8_ = this.encryptURL(_loc4_,_loc3_.toString(),com.disney.dlearning.managers.DLSManager.__developerID) + "|" + this.encryptTime(_loc3_.toString());
   ...
   {
      var _loc7_ = new Date();
      var _loc4_ = Math.round(_loc7_.getTime() / 1000);
      var _loc3_ = undefined;
   ...
   {
      var _loc1_ = new com.disney.dlearning.security.Md5();
      var _loc3_ = url + timestamp + developerId + "_Salt";
      var _loc2_ = _loc1_.hash(_loc3_);
      return _loc2_;
   }
