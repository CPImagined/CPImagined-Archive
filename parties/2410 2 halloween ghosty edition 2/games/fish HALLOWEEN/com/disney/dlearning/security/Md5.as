class com.disney.dlearning.security.Md5
{
   ...
   function core_md5(x, len)
   {
      ...
      while(_loc6_ < x.length)
      {
         ...
         _loc4_ = this.safe_add(_loc4_,_loc8_);
   ...
   function binl2b64(binarray)
   {
      ...
      {
         var _loc6_ = (binarray[_loc2_ >> 2] >> 8 * (_loc2_ % 4) & 255) << 16 | (binarray[_loc2_ + 1 >> 2] >> 8 * ((_loc2_ + 1) % 4) & 255) << 8 | binarray[_loc2_ + 2 >> 2] >> 8 * ((_loc2_ + 2) % 4) & 255;
         var _loc3_ = 0;
         while(_loc3_ < 4)
         {
            ...
            {
               _loc5_ += _loc7_.charAt(_loc6_ >> 6 * (3 - _loc3_) & 63);
            }
            _loc3_ += 1;
         }
         _loc2_ += 3;
