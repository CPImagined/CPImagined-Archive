      ...
      switch(typeof arg)
      {
         case "object":
            if(arg)
            {
               ...
               {
                  _loc4_ = 0;
                  while(_loc4_ < arg.length)
                  {
                     _loc5_ = this.stringify(arg[_loc4_]);
                     if(_loc2_)
                     {
                        _loc2_ += ",";
                     }
               ...
               if(typeof arg.toString != "undefined")
               {
                  for(_loc4_ in arg)
                  {
                     ...
                     if(typeof _loc5_ != "undefined" && typeof _loc5_ != "function")
                     {
                        ...
                        _loc2_ += this.stringify(_loc4_) + ":" + _loc5_;
                     }
                  }
                  return "{" + _loc2_ + "}";
               }
               ...
               else
               {
                  switch(_loc3_)
                  {
                     ...
                     default:
                        ...
                        _loc2_ += "\\u00" + Math.floor(_loc3_ / 16).toString(16) + (_loc3_ % 16).toString(16);
                  }
               }
               _loc4_ += 1;
            }
