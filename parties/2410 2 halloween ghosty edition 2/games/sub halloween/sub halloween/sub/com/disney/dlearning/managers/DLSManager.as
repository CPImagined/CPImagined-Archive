class com.disney.dlearning.managers.DLSManager
{
   ...
   function pushOpcode(opcode, guid, callback, register1, register2, register3, register4)
   {
      ...
      var _loc7_ = new Date();
      var _loc5_ = Math.round(_loc7_.getTime() / 1000);
      ...
      _loc3_ = "http://" + com.disney.dlearning.managers.DLSManager.__host + "/v1/opcode/pushOpcode/" + opcode + "/" + com.disney.dlearning.managers.DLSManager.__learnerID + "/" + _loc5_ + "/" + guid + "/" + register1 + "/" + register2 + "/" + register3 + "/" + register4 + "/";
      var _loc6_ = this.encryptURL(_loc3_,_loc5_.toString(),com.disney.dlearning.managers.DLSManager.__developerID) + "|" + this.encryptTime(_loc5_.toString());
   ...
   function pushOpcodeToHost(host, opcode, guid, callback, register1, register2, register3, register4)
   {
      ...
      _loc3_ = "http://" + host + "/v1/opcode/pushOpcode/" + opcode + "/" + com.disney.dlearning.managers.DLSManager.__learnerID + "/" + _loc5_ + "/" + guid + "/" + register1 + "/" + register2 + "/" + register3 + "/" + register4 + "/";
      var _loc6_ = this.encryptURL(_loc3_,_loc5_.toString(),com.disney.dlearning.managers.DLSManager.__developerID) + "|" + this.encryptTime(_loc5_.toString());
      var _loc2_ = new LoadVars();
      _loc2_.callback = callback;
      this.configureListeners(_loc2_);
