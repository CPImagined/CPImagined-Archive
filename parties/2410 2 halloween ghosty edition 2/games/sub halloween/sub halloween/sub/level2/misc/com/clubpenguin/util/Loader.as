class com.clubpenguin.util.Loader
{
   ...
   static function loadAllMovies($parent, $movieLocations)
   {
      ...
      else
      {
         ...
         com.clubpenguin.util.LocaleText.init($parent,_loc7_,_loc4_,_loc6_);
      }
      _loc1_ = 0;
   ...
   {
      com.clubpenguin.util.Loader.debugTrace("initialise loader");
      if($parent == undefined)
      {
