...
//Created by Action Script Viewer - http://www.buraks.com/asv
    class com.clubpenguin.world.rooms2024.halloween.vo.HalloweenPartyCookieVO extends com.clubpenguin.services.vo.JsonServerCookieVO
    {
        var _jsonObject;
        function HalloweenPartyCookieVO() {
            super();
        }
        function getCookieHandlerName() {
            return(com.clubpenguin.world.rooms2024.halloween.HalloweenPartyConstants.TEMPLATED_COOKIE_HANDLER_NAME);
        }
        function getSendCommandName() {
            return(com.clubpenguin.world.rooms2024.halloween.HalloweenPartyConstants.TEMPLATED_RECEIVE_COMMAND_NAME);
        }
