//Created by Action Script Viewer - https://www.buraks.com/asv
    class as_files.Forts extends as_files.ScavengerHuntRoom
    {
        var _stage, IS_24_HOUR_CLOCK, _SHELL, _destroyDelegate, _triggerWatcher, _now, _triggerWatcherInterval, _secondCheckIntervalID, _houseTrigger1, _houseTrigger2, _houseTrigger3, _houseTrigger4, setupNavigationButtons, _setQuestBtnsIntervalID, localize, _ct_minutes, _ct_hours, _pm_trigger, _ct_day, _today, registerScavengerHuntItem, registerRedherringItems, _INTERFACE;
        ...
        function configureTriggers() {
            ...
            _stage.triggers_mc.rinkTrigger_mc.triggerFunction = com.clubpenguin.util.Delegate.create(this, exit, "rink", 380, 130);
            _stage.triggers_mc.plazaTrigger_mc.triggerFunction = com.clubpenguin.util.Delegate.create(this, exit, "plaza", 90, 360);
        ...
        function configureNavigation() {
            setupNavigationButtons([new com.clubpenguin.world.rooms.common.NavigationButtonVO(_stage.townNav_btn, 80, 135), new com.clubpenguin.world.rooms.common.NavigationButtonVO(_stage.rinkNav_btn, 218, 122), new com.clubpenguin.world.rooms.common.NavigationButtonVO(_stage.plazaNav_btn, 690, 110)]);
        }
        function configureRoomElements() {
            localize([_stage.house3.lang_G_mc, _stage.house3.lang_timezone_mc]);
            _stage.customPenguinSize = 100;
            _stage.townNav_btn.useHandCursor = false;
            _stage.rinkNav_btn.useHandCursor = false;
            _stage.plazaNav_btn.useHandCursor = false;
        }
