//Created by Action Script Viewer - https://www.buraks.com/asv
    class com.clubpenguin.world.rooms2015.october.Lounge extends com.clubpenguin.world.rooms.BaseRoom
    {
        ...
        function Lounge (stageReference) {
            ...
            _stage.start_x = 375;
            _stage.start_y = 375;
            localize([_stage.thinIceMachine, _stage.astroMachine, _stage.bitsBoltsMachine, _stage.vendingMachine, _stage.foreground_mc, _stage.background_mc.targetGame.gameLogo, _stage.background_mc.picture_mc]);
        ...
        function exit() {
            _SHELL.sendJoinRoom("dance", 680, 395);
        }
