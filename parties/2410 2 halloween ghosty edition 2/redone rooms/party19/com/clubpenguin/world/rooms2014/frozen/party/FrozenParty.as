//Created by Action Script Viewer - https://www.buraks.com/asv
    ...
    {
        static var _shell, _airtower, _interface, _engine, _party, _handleUpdateRoomStateDelegate, _handleBallLandedDelegate, _partycookieUpdateHandlerDelegate, _quest, _interfaceOverrides, _handleCollectFurniturePackDelegate, _snowballCoolDownExpirationDate;
        ...
        static function checkForFirstTimeLogin(playerObj) {
            ...
            pebug("checkForFirstTimeLogin partycookie " + partyCookie);
            if (((_shell.getMyPlayerId() != playerObj.player_id) || (_shell.getRoomObject().room_id == 112)) || (partyCookie == undefined)) {
                return(undefined);
            }
        ...
        static function activateFirstTimeUserPartyFunctionality() {
            ...
            sendRequestPartyCookie();
            _engine.getRoomMovieClip().room.configureFrozenRoomElements();
        }
        ...
        static function playPartyIconSparkles() {
            ...
            sendSnowflakeCollectedBI(_shell.getRoomObject().room_id, "frozen_snowflake");
        }
        ...
        static function activateInterfaceOverrides() {
            _interface.PARTY_ICON.icon_Btn.onRelease = com.clubpenguin.util.Delegate.create(_interface, interfaceOverrides.partyIconOnRelease);
        ...
        static function sendRequestPartyCookie() {
            _airtower.send(_airtower.PLAY_EXT, com.clubpenguin.world.rooms2014.frozen.vo.FrozenPartyCookieVO.FROZEN_COOKIE_HANDLER_NAME + "#partycookie", [0], "str", _shell.getCurrentServerRoomId());
        }
        ...
        static function sendSnowflakeCollectedBI(questID, taskName) {
            var _local_2 = questID;
            var _local_1 = {message:taskName};
            com.clubpenguin.util.TrackerAS2.getInstance().trackGameAction(_local_2, "quest_task", _local_1);
        }
