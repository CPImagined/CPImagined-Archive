//Created by Action Script Viewer - https://www.buraks.com/asv
    ...
    {
        static var _this, _shell, _interface, _engine, _sfxLayer_snowballs, _sfxLayer_freezing, _sfxLayer_melting, _sfxLayer_snowflakeCollect, _sfx_impact_1, _sfx_impact_2, _sfx_throw_1, _sfx_throw_2, _sfx_melt_1, _sfx_melt_2, _sfx_freeze_1, _sfx_freeze_2, _sfx_freeze_3, _sfx_freeze_4, _sfx_collect_snowflake, _sfx_transform;
        ...
        static function playSnowballThrow() {
            ...
            var _local_1 = ((com.clubpenguin.world.rooms2014.frozen.party.FrozenParty.localPlayerAvatarID == com.clubpenguin.world.rooms2014.frozen.party.FrozenParty.CONSTANTS.MARSHMALLOW_TRANSFORMATION_ID) ? 40 : 10);
            soundManager.playSoundAfterDelay(_this["_sfx_throw_" + Number(random(2) + 1)], _sfxLayer_snowballs, _local_1, LOCAL_PLAYER_SFX_VOLUME);
        }
        ...
        static function playTransformSFX() {
            ...
            soundManager.playSound(_sfx_transform, _sfxLayer_snowflakeCollect, LOCAL_PLAYER_SFX_VOLUME);
        }
