    ...
    class com.clubpenguin.world.rooms2014.halloween.party.HalloweenPartyQuestCommunicator
    {
        ...
        static function checkDisplayGenericFloorHint() {
            ...
            if ((!_party.getTaskStatus(_party.getQuestVOByRoomID(_shell.getRoomObject().room_id))) && (!_party.partyCookie.didCompleteAtLeastOneTask)) {
                ...
                _genericRoomHintTimeout = setTimeout(com.clubpenguin.util.Delegate.create(_this, displayGenericFloorHint), 30 * SECOND);
            }
        }
        ...
        static function checkDisplaySittingRoomHint() {
            if (!_party.getTaskStatus(_party.getQuestVOByRoomID(_party.CONSTANTS.ROOM_ID_SITTING_ROOM))) {
                ...
                _questCommunicatorTimeout = setTimeout(com.clubpenguin.util.Delegate.create(_this, displaySittingRoomHint), 60 * SECOND);
            }
        }
        ...
        static function checkDisplayBallroomHint() {
            if (!_party.getTaskStatus(_party.getQuestVOByRoomID(_party.CONSTANTS.ROOM_ID_BALL_ROOM))) {
                ...
                _questCommunicatorTimeout = setTimeout(com.clubpenguin.util.Delegate.create(_this, displayBallroomHint), 60 * SECOND);
            }
        }
        ...
        static function checkDisplayBallroomHint2() {
            if (!_party.getTaskStatus(_party.getQuestVOByRoomID(_party.CONSTANTS.ROOM_ID_BALL_ROOM))) {
                ...
                _questCommunicatorTimeout = setTimeout(com.clubpenguin.util.Delegate.create(_this, displayBallroomHint2), 60 * SECOND);
            }
        }
        ...
        static function checkDisplayDiningRoomHint() {
            if (!_party.getTaskStatus(_party.getQuestVOByRoomID(_party.CONSTANTS.ROOM_ID_DINING_ROOM))) {
                ...
                _questCommunicatorTimeout = setTimeout(com.clubpenguin.util.Delegate.create(_this, displayDiningRoomHint), 60 * SECOND);
            }
        }
        ...
        static function checkDisplayDiningRoomHint2() {
            if (!_party.getTaskStatus(_party.getQuestVOByRoomID(_party.CONSTANTS.ROOM_ID_DINING_ROOM))) {
                ...
                _questCommunicatorTimeout = setTimeout(com.clubpenguin.util.Delegate.create(_this, displayDiningRoomHint2), 30 * SECOND);
            }
        }
        ...
        static function checkDisplayDiningRoomHint3() {
            if (!_party.getTaskStatus(_party.getQuestVOByRoomID(_party.CONSTANTS.ROOM_ID_DINING_ROOM))) {
                ...
                _questCommunicatorTimeout = setTimeout(com.clubpenguin.util.Delegate.create(_this, displayDiningRoomHint3), 30 * SECOND);
            }
        }
        ...
        static function checkDisplayEmptyRoomMessage() {
            ...
            _questCommunicatorTimeout = setTimeout(com.clubpenguin.util.Delegate.create(_this, displayEmptyRoomMessage), 30 * SECOND);
        }
        ...
        static function checkDisplayPoolRoomHint() {
            if (!_party.getTaskStatus(_party.getQuestVOByRoomID(_party.CONSTANTS.ROOM_ID_POOL_ROOM))) {
                ...
                _questCommunicatorTimeout = setTimeout(com.clubpenguin.util.Delegate.create(_this, displayPoolRoomHint), 60 * SECOND);
            }
        }
        ...
        static function checkDisplayLibraryRoomHint() {
            if (!_party.getTaskStatus(_party.getQuestVOByRoomID(_party.CONSTANTS.ROOM_ID_LIBRARY))) {
                ...
                _questCommunicatorTimeout = setTimeout(com.clubpenguin.util.Delegate.create(_this, displayLibraryRoomHint), 60 * SECOND);
            }
        }
        ...
        static function checkDisplayEmptyRoomMessage2() {
            _party.pebug("HalloweenPartyQuestCommunicator (7F 1) checkDisplayEmptyRoomMessage()");
            _questCommunicatorTimeout = setTimeout(com.clubpenguin.util.Delegate.create(_this, displayEmptyRoomMessage2), 30 * SECOND);
        }
        ...
        static function checkDisplayBalconyRoomHint() {
            if (!_party.getTaskStatus(_party.getQuestVOByRoomID(_party.CONSTANTS.ROOM_ID_BALCONY))) {
                ...
                _questCommunicatorTimeout = setTimeout(com.clubpenguin.util.Delegate.create(_this, displayBalconyRoomHint), 20 * SECOND);
            }
        }
        ...
        static function checkDisplayBalconyRoomHint2() {
            if (!_party.getTaskStatus(_party.getQuestVOByRoomID(_party.CONSTANTS.ROOM_ID_BALCONY))) {
                ...
                _questCommunicatorTimeout = setTimeout(com.clubpenguin.util.Delegate.create(_this, displayBalconyRoomHint2), 20 * SECOND);
            }
        }
        ...
        static function checkDisplayFloor12Messages() {
            ...
            if (_party.partyCookie.areItemsCollected()) {
                ...
                _questCommunicatorTimeout = setTimeout(com.clubpenguin.util.Delegate.create(_this, displayFloor12Hint), 30 * SECOND);
            } else {
        ...
        static function checkDisplayFloor12PlatformHint() {
            ...
            _questCommunicatorTimeout = setTimeout(com.clubpenguin.util.Delegate.create(_this, displayFloor12PlatformHint), 30 * SECOND);
        }
        ...
        static function checkDisplayFloor13Hint() {
            ...
            _questCommunicatorTimeout = setTimeout(com.clubpenguin.util.Delegate.create(_this, displayFloor13Hint), 30 * SECOND);
        }
        ...
        static function checkDisplayFloor13Hint3() {
            ...
            _questCommunicatorTimeout = setTimeout(com.clubpenguin.util.Delegate.create(_this, displayFloor13Hint3), 30 * SECOND);
        }
