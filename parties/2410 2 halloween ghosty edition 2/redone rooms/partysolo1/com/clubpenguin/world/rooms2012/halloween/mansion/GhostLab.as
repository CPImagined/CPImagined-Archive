    ...
    class com.clubpenguin.world.rooms2012.halloween.mansion.GhostLab extends com.clubpenguin.world.rooms.BaseRoom
    {
        ...
        function checkDestructableIsHit(snowballInfo) {
			...
			if (snowballInfo.player_id == _SHELL.getMyPlayerId()) {
				if (_stage.skip1_mc.hitTest(snowballInfo.x, snowballInfo.y, true)) {
					_stage.stuff_mc.gotoAndPlay(105);
					_stage.skip1_mc.gotoAndStop("caught");
				} else if (_stage.skip2_mc.hitTest(snowballInfo.x, snowballInfo.y, true)) {
					_stage.stuff_mc.gotoAndPlay(105);
					_stage.skip2_mc.gotoAndStop("caught");
				} else if (_stage.skip3_mc.hitTest(snowballInfo.x, snowballInfo.y, true)) {
					_stage.stuff_mc.gotoAndPlay(105);
					_stage.skip3_mc.gotoAndStop("caught");
				};
			};
            if (_local_4) {
                if (snowballInfo.player_id == _SHELL.getMyPlayerId()) {
