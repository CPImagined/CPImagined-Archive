//Created by Action Script Viewer - https://www.buraks.com/asv
    ...
    {
        var _stage, localize, setupNavigationButtons, _INTERFACE, _SHELL, _destroyDelegate, wem, _abductionDelegate, aliendAbduction;
        function Village (stageReference) {
            super(stageReference);
            _stage.start_x = 380;
            _stage.start_y = 340;
            localize([_stage.tour_mc.tour_mc.langTour_mc, _stage.background_mc.epfsign_mc]);
            setupNavigationButtons([new com.clubpenguin.world.rooms.common.NavigationButtonVO(_stage.background_mc.lodge_btn, 504, 201), new com.clubpenguin.world.rooms.common.NavigationButtonVO(_stage.background_mc.epf_btn, 660, 260), new com.clubpenguin.world.rooms.common.NavigationButtonVO(_stage.background_mc.blackoutlodge_btn, 531, 242), new com.clubpenguin.world.rooms.common.NavigationButtonVO(_stage.background_mc.blackoutepf_btn, 676, 303)]);
            _stage.tour_mc.tour_mc.tour_btn.onRelease = com.clubpenguin.util.Delegate.create(this, onTourButtonClicked);
			...
			_stage.background_mc.blackoutlodge_btn.onRollOver = com.clubpenguin.util.Delegate.create(this, lodgeRollOver2);
            _stage.background_mc.blackoutlodge_btn.onRollOut = com.clubpenguin.util.Delegate.create(this, lodgeRollOut2);
            _stage.background_mc.blackoutlodge_btn.onReleaseOutside = com.clubpenguin.util.Delegate.create(this, lodgeRollOut2);
            _stage.background_mc.blackoutepf_btn.onRollOver = com.clubpenguin.util.Delegate.create(this, epfRollOver2);
            _stage.background_mc.blackoutepf_btn.onRollOut = com.clubpenguin.util.Delegate.create(this, epfRollOut2);
            _stage.background_mc.blackoutepf_btn.onReleaseOutside = com.clubpenguin.util.Delegate.create(this, epfRollOut2);
            _stage.tour_mc.tour_mc.tour_btn.onRollOver = com.clubpenguin.util.Delegate.create(this, tourRollOver);
            _stage.tour_mc.tour_mc.tour_btn.onRollOut = com.clubpenguin.util.Delegate.create(this, tourRollOut);
            _stage.tour_mc.tour_mc.tour_btn.onReleaseOutside = com.clubpenguin.util.Delegate.create(this, tourRollOut);
        }
		...
		function lodgeRollOver2() {
            _stage.background_mc.background_mc.lodgeDoor.gotoAndStop(2);
        }
        function lodgeRollOut2() {
            _stage.background_mc.background_mc.lodgeDoor.gotoAndStop(1);
        }
        function epfRollOver2() {
            _stage.background_mc.background_mc.epfBuilding.epfDoor.gotoAndStop(2);
        }
        function epfRollOut2() {
            _stage.background_mc.background_mc.epfBuilding.epfDoor.gotoAndStop(1);
        }
        function tourRollOver() {
            _stage.tour_mc.tour_mc.gotoAndStop(2);
        }
        function tourRollOut() {
            _stage.tour_mc.tour_mc.gotoAndStop(1);
        }
