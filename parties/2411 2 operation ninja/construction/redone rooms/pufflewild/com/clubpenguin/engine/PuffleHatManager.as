    ...
    class com.clubpenguin.engine.PuffleHatManager
    {
        ...
        function init() {
            if (_hatLocation == com.clubpenguin.engine.PuffleHatLocEnum.NULL_HAT_LOC) {
                ...
                trace("+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++");
                trace("+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++");
                trace("Error in PuffleHatManager --> no valid hatPath was set, don't know where to load hats from");
                trace("+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++");
                trace("+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++");
                return(undefined);
            }
        ...
        function onLoadErrorHat(event) {
            ...
            trace("*************************************");
            trace("*************************************");
            trace("[ERROR] ---> onLoadErrorHatFront: " + event);
            for (var _local_3 in event) {
                trace((("error property: " + _local_3) + " error value: ") + event[_local_3]);
            }
            trace("*************************************");
            trace("*************************************");
            removeFrontLoadListeners();
