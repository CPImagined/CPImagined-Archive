...
package CardJitsuProgressInventoryAssets_fla
{
    ...
    public dynamic class progressWindowCJ_252 extends MovieClip 
    {

        public var bodyText:LocalTextComponent;//instance name
        public var cornerFlipBtn:MovieClip;//instance name
        public var level1:MovieClip;//instance name
        public var level2:MovieClip;//instance name
        public var progressItem:MovieClip;//instance name
        public var level3:MovieClip;//instance name
        public var progressBar:MovieClip;//instance name
        public var logoClip:MovieClip;//instance name
        public var level4:MovieClip;//instance name
        public var level5:MovieClip;//instance name
        public var level6:MovieClip;//instance name
        public var goBackBtn:MovieClip;//instance name
        public var level7:MovieClip;//instance name
        public var level8:MovieClip;//instance name
        public var level10:MovieClip;//instance name
        public var level9:MovieClip;//instance name
        public var myProgressBtn:MovieClip;//instance name
        public var progressText:LocalTextComponent;//instance name
        public var intro_door_sensei:MovieClip;//instance name
        public var __setPropDict:Dictionary = new Dictionary(true);

        public function progressWindowCJ_252()
        {
            addFrameScript(0, this.frame1, 1, this.frame2, 2, this.frame3, 3, this.frame4, 4, this.frame5);
        }

        internal function __setProp_bodyText_progressWindowCJ_BodyText_0():*
        {
            if (((this.__setPropDict[this.bodyText] == undefined) || (!(int(this.__setPropDict[this.bodyText]) == 1))))
            {
                ...
                this.bodyText.text = "Talk to Sensei to begin";
        ...
        internal function __setProp_progressText_progressWindowCJ_progresstext_1():*
        {
        ...
        internal function __setProp_bodyText_progressWindowCJ_Titletext_1():*
        {
            if (((this.__setPropDict[this.bodyText] == undefined) || (!(int(this.__setPropDict[this.bodyText]) == 2))))
            {
                ...
                this.bodyText.text = "Next Reward";
                this.bodyText.textColor = 2361859;
                this.bodyText.token = "";
                this.bodyText.textVerticalAlignment = "top";
                this.bodyText.visible = true;
        ...
        internal function __setProp_bodyText_progressWindowCJ_BodyText_2():*
        {
        ...
        internal function __setProp_bodyText_progressWindowCJ_Titletext_3():*
        {
            if (((this.__setPropDict[this.bodyText] == undefined) || (!(int(this.__setPropDict[this.bodyText]) == 4))))
            {
                this.__setPropDict[this.bodyText] = 4;
                try
                {
                    this.bodyText["componentInspectorSetting"] = true;
                }
        ...
        internal function __setProp_progressText_progressWindowCJ_progresstext_4():*
        {
            if (((this.__setPropDict[this.progressText] == undefined) || (!(int(this.__setPropDict[this.progressText]) == 5))))
            {
                this.__setPropDict[this.progressText] = 5;
                try
                {
                    this.progressText["componentInspectorSetting"] = true;
                }
        ...
        {
            this.__setProp_bodyText_progressWindowCJ_BodyText_0();
            stop();
        }

        internal function frame2():*
        {
            this.__setProp_bodyText_progressWindowCJ_Titletext_1();
            this.__setProp_progressText_progressWindowCJ_progresstext_1();
            stop();
        }

        internal function frame3():*
        {
            this.__setProp_bodyText_progressWindowCJ_BodyText_2();
            stop();
        }

        internal function frame4():*
        {
            this.__setProp_bodyText_progressWindowCJ_Titletext_3();
            stop();
        }

        internal function frame5():*
        {
            this.__setProp_progressText_progressWindowCJ_progresstext_4();
            stop();
        }
