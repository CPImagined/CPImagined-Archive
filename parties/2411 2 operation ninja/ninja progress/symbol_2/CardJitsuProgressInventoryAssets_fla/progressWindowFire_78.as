...
package CardJitsuProgressInventoryAssets_fla
{
    ...
    public dynamic class progressWindowFire_78 extends MovieClip 
    {

        public var bodyText:LocalTextComponent;//instance name
        public var cornerFlipBtn:MovieClip;//instance name
        public var intro_door_fire:MovieClip;//instance name
        ...
        public var challengeSenseiBtn:MovieClip;//instance name
        ...
        public function progressWindowFire_78()
        {
            addFrameScript(0, this.frame1, 1, this.frame2, 2, this.frame3, 3, this.frame4, 4, this.frame5);
        }

        internal function __setProp_bodyText_progressWindowFire_Bodytext_0():*
        {
            if (((this.__setPropDict[this.bodyText] == undefined) || (!(int(this.__setPropDict[this.bodyText]) == 1))))
            {
                ...
                this.bodyText.text = "Become a Fire Ninja";
        ...
        internal function __setProp_progressText_progressWindowFire_Layer4_1():*
        {
        ...
        internal function __setProp_bodyText_progressWindowFire_progress_1():*
        {
        ...
        internal function __setProp_bodyText_progressWindowFire_Bodytext_2():*
        {
            if (((this.__setPropDict[this.bodyText] == undefined) || (!(int(this.__setPropDict[this.bodyText]) == 3))))
            {
                ...
                this.bodyText.showBounds = false;
                this.bodyText.textSize = 12;
                this.bodyText.text = "Excellent! Challenge Sensei to become a Fire Ninja!";
                this.bodyText.textColor = 2361859;
                this.bodyText.token = "";
                this.bodyText.textVerticalAlignment = "top";
                this.bodyText.visible = true;
        ...
        internal function __setProp_bodyText_progressWindowFire_title_3():*
        {
        ...
        internal function __setProp_progressText_progressWindowFire_Layer4_4():*
        {
        ...
        {
            this.__setProp_bodyText_progressWindowFire_Bodytext_0();
            stop();
        }

        internal function frame2():*
        {
            this.__setProp_bodyText_progressWindowFire_progress_1();
            this.__setProp_progressText_progressWindowFire_Layer4_1();
            stop();
        }

        internal function frame3():*
        {
            this.__setProp_bodyText_progressWindowFire_Bodytext_2();
            stop();
        }

        internal function frame4():*
        {
            this.__setProp_bodyText_progressWindowFire_title_3();
            stop();
        }

        internal function frame5():*
        {
            this.__setProp_progressText_progressWindowFire_Layer4_4();
            stop();
        }
