...
//Created by Action Script Viewer - http://www.buraks.com/asv
    class com.clubpenguin.util.JSONParser
    {
        ...
        static function stringify(_arg_5) {
            var _local_3;
            var _local_2;
            var _local_6;
            var _local_1 = "";
            var _local_4;
            switch (typeof(_arg_5)) {
                case "object" : 
                    if (_arg_5) {
                        if (_arg_5 instanceof Array) {
                            _local_2 = 0;
                            while (_local_2 < _arg_5.length) {
                                _local_4 = stringify(_arg_5[_local_2]);
                                if (_local_1) {
                                    _local_1 = _local_1 + ",";
                                }
                            ...
                            return(("[" + _local_1) + "]");
                        } else if (typeof(_arg_5.toString) != "undefined") {
                            for (_local_2 in _arg_5) {
                                _local_4 = _arg_5[_local_2];
                    ...
                    return("null");
                case "number" : 
                    return((isFinite(_arg_5) ? (String(_arg_5)) : "null"));
                case "string" : 
                    _local_6 = _arg_5.length;
                    _local_1 = "\"";
                    _local_2 = 0;
                    while (_local_2 < _local_6) {
                        _local_3 = _arg_5.charAt(_local_2);
                        if (_local_3 >= " ") {
        ...
        static function parse(text) {
            ...
            var ch = " ";
            var _value;
            var _error = function (_arg_5) {
                throw {name:"JSONError", message:_arg_5, at:at - 1, text:(text.substr(at - 20, 40) + newline) + text};
            };
