...
class com.clubpenguin.world.rooms2024.ninja.NinjaParty {
	...
	static function setServerCookie() {
		_serverCookie = new com.clubpenguin.world.rooms2024.ninja.vo.NinjaPartyCookieVO(PARTY_COOKIE_ID);
	}
    ...
    static function get partyCookie() {
        return (com.clubpenguin.world.rooms2024.ninja.vo.NinjaPartyCookieVO(_serverCookie));
    }
    ...
    static function checkForLoginDialogue(_arg_1) {
        ...
        if (partyCookie[CONSTANTS.MESSAGE_KEY][0] == 0) {
			if (_shell.isEPFAgent()) {
				...
				_interface.showContent(CONSTANTS.LOGIN_PROMPT_PATH_CIVILIAN);
			};
		};
    }
    ...
    static function get interfaceOverrides() {
        if (_interfaceOverrides == null) {
            _interfaceOverrides = new com.clubpenguin.world.rooms2024.ninja.NinjaParty_InterfaceOverrides();
        }
        return (_interfaceOverrides);
    }
    static function get engineOverrides() {
        if (_engineOverrides == null) {
            _engineOverrides = new com.clubpenguin.world.rooms2024.ninja.NinjaParty_EngineOverrides();
        }
    ...
    static function get questCom() {
        return com.clubpenguin.world.rooms2024.ninja.NinjaPartyQuestCom;
    }
    ...
    static var CONSTANTS = com.clubpenguin.world.rooms2024.ninja.NinjaPartyConstants;
    static var CLASS_NAME = "NinjaParty";
    static var PARTY_COOKIE_ID = CONSTANTS.PARTY_COOKIE_ID;
    static var _this = com.clubpenguin.world.rooms2024.ninja.NinjaParty;
