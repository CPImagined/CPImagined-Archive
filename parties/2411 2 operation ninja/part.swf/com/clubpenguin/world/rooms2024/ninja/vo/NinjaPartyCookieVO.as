...
//Created by Action Script Viewer - http://www.buraks.com/asv
    class com.clubpenguin.world.rooms2024.ninja.vo.NinjaPartyCookieVO extends com.clubpenguin.services.vo.JsonServerCookieVO
    {
        var _jsonObject;
        function NinjaPartyCookieVO() {
            super();
        }
        function getCookieHandlerName() {
            return(com.clubpenguin.world.rooms2024.ninja.NinjaPartyConstants.TEMPLATED_COOKIE_HANDLER_NAME);
        }
        function getSendCommandName() {
            return(com.clubpenguin.world.rooms2024.ninja.NinjaPartyConstants.TEMPLATED_RECEIVE_COMMAND_NAME);
        }
