class com.clubpenguin.games.cannon.Anvil extends com.clubpenguin.games.cannon.GameplayObstacle
{
   ...
   var gameplayWorld;
   var game;
   function Anvil($game, $gameplayWorld, $gameplayHolder, $obstacleHolder, $idn, $posX, $posY, $posR, $settingN)
   {
   ...
   function updateGameplay()
   {
      ...
      {
         var _loc4_ = com.clubpenguin.math.AaronsPhysics.findDistance(this.movie._x,this.movie._y,this.game.playerObj.getPosX(),this.game.playerObj.getPosY());
         if(_loc4_ < 100)
         {
            var _loc7_ = this.game.playerObj.getPosX();
            var _loc8_ = this.game.playerObj.getPosY();
            if(this.movie.art.hitBox1.hitTest(this.game.playerObj.movie) || this.movie.art.hitBox2.hitTest(this.game.playerObj.movie) || _loc4_ < 40)
            {
               ...
               var _loc6_ = com.clubpenguin.math.AaronsPhysics.findMotionXFromAngle(_loc3_,50);
               var _loc5_ = com.clubpenguin.math.AaronsPhysics.findMotionYFromAngle(_loc3_,50);
               this.game.playerObj.motionX = _loc6_ * 0.8;
