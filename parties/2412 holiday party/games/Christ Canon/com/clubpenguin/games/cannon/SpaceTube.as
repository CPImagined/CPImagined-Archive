class com.clubpenguin.games.cannon.SpaceTube extends com.clubpenguin.games.cannon.GameplayObstacle
{
   var groundX;
   var movie;
   var groundY;
   ...
   var gameplayWorld;
   var game;
   function SpaceTube($game, $gameplayWorld, $gameplayHolder, $obstacleHolder, $idn, $posX, $posY, $posR, $settingN)
   {
