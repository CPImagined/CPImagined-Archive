//Created by Action Script Viewer - https://www.buraks.com/asv
    class as_files.Mountain extends com.clubpenguin.world.rooms.BaseRoom
    {
        var _stage, _SHELL, _destroyDelegate, _triggerWatcher, _triggerWatcherInterval, localize, setupNavigationButtons, showContent, setupHint, wem, _ENGINE;
        ...
        function init() {
            ...
            localize([_stage.coffeeAndCocoaShack]);
        }
        ...
        function joinSledGame(gameNumber) {
            trace(((CLASS_NAME + ": joinSledGame(") + gameNumber) + ")");
