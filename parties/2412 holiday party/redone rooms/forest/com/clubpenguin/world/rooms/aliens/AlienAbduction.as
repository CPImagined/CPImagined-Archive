//Created by Action Script Viewer - https://www.buraks.com/asv
    class com.clubpenguin.world.rooms.aliens.AlienAbduction
    {
        ...
        function startBeam() {
            var tween1_y = (_penguin_mc._y / 2);
            _roomMC.tractorBeam_mc.gotoAndPlay(2);
            com.greensock.TweenMax.to(_penguin_mc, 3.46, {_y:tween1_y, _rotation:-30, delay:0.7, ease:com.greensock.easing.Sine.easeIn, onComplete:tween1Complete, onCompleteParams:[_penguin_mc], onCompleteScope:this});
        ...
        function changeColor() {
            var UFOBeamColorTransform = (new flash.geom.ColorTransform(1, 1, 1, 1, 0, 55, 0, 0));
            var myTransform = (new flash.geom.Transform(_penguin_mc));
            myTransform.colorTransform = UFOBeamColorTransform;
        }
