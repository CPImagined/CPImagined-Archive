//Created by Action Script Viewer - https://www.buraks.com/asv
    class com.clubpenguin.engine.tweener.Equations
    {
        ...
        static function easeInElastic(t, b, c, d, p_params) {
            ...
            var _local_2 = ((p_params.period == undefined) ? (d * 0.3) : (p_params.period));
            var _local_5;
            var _local_1 = p_params.amplitude;
            if ((!_local_1) || (_local_1 < Math.abs(c))) {
                _local_1 = c;
                _local_5 = _local_2 / 4;
            } else {
                _local_5 = (_local_2 / (Math.PI*2)) * Math.asin(c / _local_1);
            }
            t = t - 1;
            return((-((_local_1 * Math.pow(2, 10 * t)) * Math.sin((((t * d) - _local_5) * (Math.PI*2)) / _local_2))) + b);
        }
        static function easeOutElastic(t, b, c, d, p_params) {
            ...
            var _local_3 = ((p_params.period == undefined) ? (d * 0.3) : (p_params.period));
            var _local_5;
            var _local_1 = p_params.amplitude;
            if ((!_local_1) || (_local_1 < Math.abs(c))) {
                _local_1 = c;
                ...
                _local_5 = (_local_3 / (Math.PI*2)) * Math.asin(c / _local_1);
            }
            return((((_local_1 * Math.pow(2, -10 * t)) * Math.sin((((t * d) - _local_5) * (Math.PI*2)) / _local_3)) + c) + b);
        }
        static function easeInOutElastic(t, b, c, d, p_params) {
            ...
            var _local_3 = ((p_params.period == undefined) ? (d * 0.45) : (p_params.period));
            var _local_5;
            var _local_1 = p_params.amplitude;
            if ((!_local_1) || (_local_1 < Math.abs(c))) {
                _local_1 = c;
            ...
            if (t < 1) {
                t = t - 1;
                return((-0.5 * ((_local_1 * Math.pow(2, 10 * t)) * Math.sin((((t * d) - _local_5) * (Math.PI*2)) / _local_3))) + b);
            }
            t = t - 1;
            return(((((_local_1 * Math.pow(2, -10 * t)) * Math.sin((((t * d) - _local_5) * (Math.PI*2)) / _local_3)) * 0.5) + c) + b);
        }
        ...
        static function easeInBack(t, b, c, d, p_params) {
            var _local_1 = ((p_params.overshoot == undefined) ? 1.70158 : (p_params.overshoot));
            t = t / d;
            return((((c * t) * t) * (((_local_1 + 1) * t) - _local_1)) + b);
        }
        static function easeOutBack(t, b, c, d, p_params) {
            var _local_2 = ((p_params.overshoot == undefined) ? 1.70158 : (p_params.overshoot));
            t = (t / d) - 1;
            return((c * (((t * t) * (((_local_2 + 1) * t) + _local_2)) + 1)) + b);
        }
        static function easeInOutBack(t, b, c, d, p_params) {
            ...
            if (t < 1) {
                ...
                return(((c / 2) * ((t * t) * (((_local_2 + 1) * t) - _local_2))) + b);
            }
            t = t - 2;
            _local_2 = _local_2 * 1.525;
            return(((c / 2) * (((t * t) * (((_local_2 + 1) * t) + _local_2)) + 2)) + b);
        }
