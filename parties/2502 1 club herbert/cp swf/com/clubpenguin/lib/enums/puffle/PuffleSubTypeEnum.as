...
package com.clubpenguin.lib.enums.puffle
{
    ...
    public class PuffleSubTypeEnum extends Enum 
    {
		...
		public static const GREEN_GHOST_PUFFLE:PuffleSubTypeEnum = new PuffleSubTypeEnum(1028, 3, "greenghost", "", true, true);
		public static const RED_CRYSTAL_PUFFLE:PuffleSubTypeEnum = new PuffleSubTypeEnum(1029, 5, "redcrystal", "", true, true);
		public static const MAROON_ALIEN_PUFFLE:PuffleSubTypeEnum = new PuffleSubTypeEnum(1030, 13, "maroonalien", "", true, true);
