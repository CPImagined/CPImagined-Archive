...
package com.playdom.tracker
{
    ...
    public class Tracker extends Actor 
    {
        ...
        public static const DEFAULT_URL_STRING:String = "/flash_log?";//"http://log.data.disney.com/flash_log?"
        ...
        protected static const TRACKER_VIEW:String = "cp";
        protected static const TRACKER_NETWORK:String = "c";
        ...
        public function initialize(userID:String, appString:String, appVersion:String="", sendStartInFlash:Boolean=false, flushOnInterval:Boolean=false, language:String="en_US", sessionUuid:String="", browserID:String=""):void
        {
            this._initialized = true;
            this._sessionUuid = sessionUuid;
            this._browserID = browserID;
            this.logManager = new LogManager(flushOnInterval);
            this.gameDataNVC = new NameValuesContainer();
            this.appVersion = appVersion;
            this._networkID = TRACKER_NETWORK;
            this._viewNetworkID = TRACKER_VIEW;
            this.gameDataNVC.addPair(APP_ATTRIBUTE, appString);
            this.gameDataNVC.addPair(USER_ID_ATTRIBUTE, userID);
            this.gameDataNVC.addPair(NETWORK_ATTRIBUTE, this._networkID);
            this.gameDataNVC.addPair(VIEW_NETWORK_ATTRIBUTE, this._viewNetworkID);
