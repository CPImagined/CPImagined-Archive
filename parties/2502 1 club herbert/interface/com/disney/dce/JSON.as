                ...
                case "object" : 
                    if (arg) {
                        if (arg instanceof Array) {
                            _local_3 = 0;
                            while (_local_3 < arg.length) {
                                _local_4 = stringify(arg[_local_3]);
                                if (_local_2) {
                                    _local_2 = _local_2 + ",";
                                }
