//Created by Action Script Viewer - https://www.buraks.com/asv
    class com.clubpenguin.world.rooms2025.doom.DoomPartySnowballManager extends com.clubpenguin.engine.projectiles.SnowballManager
    {
        var _SHELL, _ENGINE, _INTERFACE, snowballHitController, maxSnowballs, resetData, onBallLand, throwItemCounter, snowballData;
        function DoomPartySnowballManager (shell, engine, _interface) {
            super();
            _SHELL = shell;
            _ENGINE = engine;
        ...
        function throwBall(playerId, target_x, target_y, snowballVO) {
            if ((playerId == _SHELL.getMyPlayerId()) && (!_global.getCurrentParty().BaseParty.CURRENT_PARTY.isSnowballEnabled)) {
                return(undefined);
            }
            ...
            if (playerId == _SHELL.getMyPlayerId()) {
                _global.getCurrentParty().BaseParty.CURRENT_PARTY.startSnowballCoolDown();
            }
        }
    }
