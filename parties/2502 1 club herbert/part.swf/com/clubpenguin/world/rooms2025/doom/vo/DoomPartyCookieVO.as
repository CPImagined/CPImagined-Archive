...
//Created by Action Script Viewer - http://www.buraks.com/asv
    class com.clubpenguin.world.rooms2025.doom.vo.DoomPartyCookieVO extends com.clubpenguin.services.vo.JsonServerCookieVO
    {
        var _jsonObject;
        function DoomPartyCookieVO() {
            super();
        }
        function getCookieHandlerName() {
            return(com.clubpenguin.world.rooms2025.doom.DoomPartyConstants.TEMPLATED_COOKIE_HANDLER_NAME);
        }
        function getSendCommandName() {
            return(com.clubpenguin.world.rooms2025.doom.DoomPartyConstants.TEMPLATED_RECEIVE_COMMAND_NAME);
        }
