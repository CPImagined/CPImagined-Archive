//Created by Action Script Viewer - https://www.buraks.com/asv
    class com.clubpenguin.world.rooms.Dock extends com.clubpenguin.world.rooms.BaseRoom
    {
        ...
        function Dock (stageReference) {
            ...
            _stage.start_y = 220;
            localize([]);
            setupNavigationButtons([new com.clubpenguin.world.rooms.common.NavigationButtonVO(_stage.background_mc.beach_btn, 90, 190), new com.clubpenguin.world.rooms.common.NavigationButtonVO(_stage.epf_mc.door_btn, 480, 340), new com.clubpenguin.world.rooms.common.NavigationButtonVO(_stage.background_mc.village_btn, 245, 145), new com.clubpenguin.world.rooms.common.NavigationButtonVO(_stage.background_mc.town_btn, 700, 175), new com.clubpenguin.world.rooms.common.NavigationButtonVO(_stage.dock_mc.boat_btn, 110, 320)]);
			...
			_stage.triggers_mc.epf_mc.triggerFunction = com.clubpenguin.util.Delegate.create(this, exit, "party7", 340, 110);
        }
		function epfTube() {
