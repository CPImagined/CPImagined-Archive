//Created by Action Script Viewer - https://www.buraks.com/asv
    class mx.core.UIObject extends MovieClip
    {
        ...
        function setSize(w, h, noEvent) {
            var _local_3 = __width;
            var _local_2 = __height;
            __width = w;
            __height = h;
            this.size();
            if (noEvent != true) {
                dispatchEvent({type:"resize", oldWidth:_local_3, oldHeight:_local_2});
            }
        }
        function size(Void) {
            _width = __width;
        ...
        function createClassObject(className, id, depth, initobj) {
            ...
            var _local_4 = mx.core.UIObject(createObject(className.symbolOwner.symbolName, id, depth, initobj));
            if (_local_3) {
