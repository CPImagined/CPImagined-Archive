//Created by Action Script Viewer - https://www.buraks.com/asv
    class com.clubpenguin.engine.avatar.effect.AvatarEffectEnum
    {
        ...
        static var FREEZE_BURST = new com.clubpenguin.engine.avatar.effect.AvatarEffectEnum(LIB_AVATAR_NAME, "freeze_burst", FLAG_ATTACH_TO_PLAYER);
        ...
        static var JANUARY_BATTLE_ICON = new com.clubpenguin.engine.avatar.effect.AvatarEffectEnum(LIB_AVATAR_NAME, "iconBattle", FLAG_ATTACH_TO_PLAYER | FLAG_STOP_ON_LAST_FRAME);
        static var JANUARY_BATTLE_POINTS_WIN = new com.clubpenguin.engine.avatar.effect.AvatarEffectEnum(LIB_AVATAR_NAME, "battlePointsWin", FLAG_NONE);
        static var JANUARY_BATTLE_POINTS_LOSS = new com.clubpenguin.engine.avatar.effect.AvatarEffectEnum(LIB_AVATAR_NAME, "battlePointsLoss", FLAG_NONE);
        static var JANUARY_BATTLE_LOW_ICON = new com.clubpenguin.engine.avatar.effect.AvatarEffectEnum(LIB_AVATAR_NAME, "battleLowIcon", FLAG_ATTACH_TO_PLAYER | FLAG_STOP_ON_LAST_FRAME);
        static var JANUARY_BATTLE_MID_ICON = new com.clubpenguin.engine.avatar.effect.AvatarEffectEnum(LIB_AVATAR_NAME, "battleMidIcon", FLAG_ATTACH_TO_PLAYER | FLAG_STOP_ON_LAST_FRAME);
        static var JANUARY_BATTLE_HIGH_ICON = new com.clubpenguin.engine.avatar.effect.AvatarEffectEnum(LIB_AVATAR_NAME, "battleHighIcon", FLAG_ATTACH_TO_PLAYER | FLAG_STOP_ON_LAST_FRAME);
        static var TICKETS_EARNED_ICON = new com.clubpenguin.engine.avatar.effect.AvatarEffectEnum(LIB_AVATAR_NAME, "ticketPoint", FLAG_ATTACH_TO_PLAYER);
