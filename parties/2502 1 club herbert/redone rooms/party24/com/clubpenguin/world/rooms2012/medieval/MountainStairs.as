//Created by Action Script Viewer - https://www.buraks.com/asv
    ...
    {
        var _stage, _destroyDelegate, _SHELL, setupNavigationButtons, _triggerWatcher, _cave1Trigger, _cave2Trigger, _fallingRockInteval, _roomUpdateInterval, _ENGINE;
        ...
        function init() {
            ...
            _stage.triggers_mc.exit_skihill_mc.triggerFunction = com.clubpenguin.util.Delegate.create(this, exit, "party23", 562, 342);
            _stage.triggers_mc.exit_ruins_mc.triggerFunction = com.clubpenguin.util.Delegate.create(this, exit, "mtn", 255, 200);
            setupNavigationButtons([new com.clubpenguin.world.rooms.common.NavigationButtonVO(_stage.cave1_btn, 213, 202), new com.clubpenguin.world.rooms.common.NavigationButtonVO(_stage.cave2_btn, 588, 119)]);
        ...
        function destroy() {
			_global.getCurrentParty().BaseParty.CURRENT_PARTY.deactivateSnowballManagerOverride();
