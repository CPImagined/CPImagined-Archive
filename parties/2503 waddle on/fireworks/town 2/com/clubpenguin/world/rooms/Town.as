//Created by Action Script Viewer - https://www.buraks.com/asv
    ...
    {
        var _stage, localize, setupNavigationButtons, _SHELL, _destroyDelegate, wem, _abductionDelegate, aliendAbduction, _INTERFACE;
        function Town (stageReference) {
            super(stageReference);
            _stage.start_x = 355;
            _stage.start_y = 310;
            localize([_stage.background_mc.signs_mc]);
            setupNavigationButtons([new com.clubpenguin.world.rooms.common.NavigationButtonVO(_stage.jacket_mc.jacket_btn, 260, 375), new com.clubpenguin.world.rooms.common.NavigationButtonVO(_stage.background_mc.dock_btn, 65, 290), new com.clubpenguin.world.rooms.common.NavigationButtonVO(_stage.background_mc.coffee_btn, 215, 235), new com.clubpenguin.world.rooms.common.NavigationButtonVO(_stage.background_mc.dance_btn, 425, 220), new com.clubpenguin.world.rooms.common.NavigationButtonVO(_stage.background_mc.shop_btn, 545, 230), new com.clubpenguin.world.rooms.common.NavigationButtonVO(_stage.background_mc.forts_btn, 700, 295), new com.clubpenguin.world.rooms.common.NavigationButtonVO(_stage.background_mc.seat01_btn, 272, 234), new com.clubpenguin.world.rooms.common.NavigationButtonVO(_stage.background_mc.seat02_btn, 347, 232)]);
			...
			_stage.triggers_mc.jacket_mc.triggerFunction = com.clubpenguin.util.Delegate.create(this, showJacket);
        }
		function showJacket() {
			_INTERFACE.showContent("w.app.p2025.waddleon.jacket");
		}
