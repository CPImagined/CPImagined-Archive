//Created by Action Script Viewer - https://www.buraks.com/asv
    class com.clubpenguin.world.rooms2025.waddleon.DinoSounds
    {
        static var _shell, _interface, _engine, _sfxLayer_dinoWalk, _sfxLayer_dinoAction, _sfxLayer_dinoSnowball, _sfxLayer_puffle, _sfx_puffleCrack1, _sfx_puffleCrack2, _sfx_pteranodonDance, _sfx_pteranodonEat, _sfx_pteranodonSnowball, _sfx_pteranodonWalk, _sfx_pteranodonWave, _sfx_raptorDance, _sfx_raptorEat, _sfx_raptorSnowball, _sfx_raptorWalk, _sfx_raptorWave, _sfx_stegosaurusDance, _sfx_stegosaurusEat, _sfx_stegosaurusSnowball, _sfx_stegosaurusWalk, _sfx_stegosaurusWave, _sfx_stegosaurusHatch, _sfx_trexDance, _sfx_trexEat, _sfx_trexSnowball, _sfx_trexWalk, _sfx_trexWave, _sfx_trexHatch, _sfx_triceratopsDance, _sfx_triceratopsEat, _sfx_triceratopsSnowball, _sfx_triceratopsWalk, _sfx_triceratopsWave, _sfx_triceratopsHatch;
        function DinoSounds () {
        }
        static function init() {
            ...
            _shell.addListener(_shell.ROOM_INITIATED, com.clubpenguin.util.Delegate.create(com.clubpenguin.world.rooms2025.waddleon.DinoSounds, onRoomInitialized));
            _shell.addListener(_shell.PLAYER_MOVE_START, onPlayerMoveStart, com.clubpenguin.world.rooms2025.waddleon.DinoSounds);
            _shell.addListener(_shell.PLAYER_MOVE_DONE, onPlayerMoveEnd, com.clubpenguin.world.rooms2025.waddleon.DinoSounds);
            _shell.addListener(_shell.PLAYER_DANCE_START, onPlayerDanceStart, com.clubpenguin.world.rooms2025.waddleon.DinoSounds);
            _shell.addListener(_shell.PLAYER_WAVE_START, onPlayerWaveStart, com.clubpenguin.world.rooms2025.waddleon.DinoSounds);
            _shell.addListener(_shell.PLAYER_SIT_START, onPlayerSitStart, com.clubpenguin.world.rooms2025.waddleon.DinoSounds);
        }
        ...
        static function onRoomInitialized() {
            com.clubpenguin.world.rooms.BaseRoom.current.soundManagerReady.addOnce(onSoundManagerReady, com.clubpenguin.world.rooms2025.waddleon.DinoSounds);
        }
        static function onSoundManagerReady() {
            ...
            _sfxLayer_puffle = soundManager.addLayer("puffle", 2);
            var _local_1 = function (symbolName) {
                return(com.clubpenguin.world.rooms2025.waddleon.DinoSounds.soundManager.registerSymbolName(symbolName));
            };
            _sfx_puffleCrack1 = _local_1("sfx_puffle_crack_1");
            _sfx_puffleCrack2 = _local_1("sfx_puffle_crack_2");
            ...
            _sfx_stegosaurusHatch = _local_1("sfx_stegosaurus_hatch");
            ...
            _sfx_trexHatch = _local_1("sfx_trex_hatch");
            ...
            _sfx_triceratopsHatch = _local_1("sfx_triceratops_hatch");
        }
        static function onPlayerSitStart(player) {
        ...
        static function startSfxDinoWalk(avatarId) {
            stopSfxDinoWalk();
            var _local_1 = null;
            if (com.clubpenguin.world.rooms2025.waddleon.WaddleOnParty.isTrex(avatarId)) {
                _local_1 = _sfx_trexWalk;
            } else if (com.clubpenguin.world.rooms2025.waddleon.WaddleOnParty.isTriceratops(avatarId)) {
                _local_1 = _sfx_triceratopsWalk;
            } else if (com.clubpenguin.world.rooms2025.waddleon.WaddleOnParty.isPteranodon(avatarId)) {
                _local_1 = _sfx_pteranodonWalk;
            } else if (com.clubpenguin.world.rooms2025.waddleon.WaddleOnParty.isStegosuarus(avatarId)) {
                _local_1 = _sfx_stegosaurusWalk;
            } else if (com.clubpenguin.world.rooms2025.waddleon.WaddleOnParty.isRaptor(avatarId)) {
        ...
        static function playSfxDinoEat(avatarId, volume, tag) {
            ...
            if (com.clubpenguin.world.rooms2025.waddleon.WaddleOnParty.isTrex(avatarId)) {
                ...
                soundManager.playSoundAfterDelay(_local_1[0], _sfxLayer_dinoAction, 5, volume, tag);
                soundManager.playSoundAfterDelay(_local_1[1], _sfxLayer_dinoAction, 50, volume, tag);
            } else if (com.clubpenguin.world.rooms2025.waddleon.WaddleOnParty.isTriceratops(avatarId)) {
        ...
        static function playPuffleCracking(playerID, crackStep) {
            var _local_2 = REMOTE_PLAYER_SFX_VOLUME;
            ...
            switch (crackStep) {
                case 1 : 
                    _local_1 = _sfx_puffleCrack1;
                    break;
                case 2 : 
                    _local_1 = _sfx_puffleCrack2;
                    break;
                default : 
                    return(undefined);
            }
            soundManager.playSoundAfterDelay(_local_1, _sfxLayer_puffle, 1, _local_2, playerID);
            return(undefined);
        }
        static function playPuffleHatching(playerID, handItemId) {
            var _local_2 = REMOTE_PLAYER_SFX_VOLUME;
            if (playerID == _shell.getMyPlayerId()) {
                _local_2 = LOCAL_PLAYER_SFX_VOLUME;
            }
            var _local_1;
            switch (handItemId) {
                case com.clubpenguin.world.rooms2025.waddleon.WaddleOnParty.CONSTANTS.PUFFLEGG_TRICERATOPS_BLUE_ID : 
                case com.clubpenguin.world.rooms2025.waddleon.WaddleOnParty.CONSTANTS.PUFFLEGG_TRICERATOPS_RED_ID : 
                    _local_1 = _sfx_triceratopsHatch;
                    break;
                case com.clubpenguin.world.rooms2025.waddleon.WaddleOnParty.CONSTANTS.PUFFLEGG_TREX_GREY_ID : 
                case com.clubpenguin.world.rooms2025.waddleon.WaddleOnParty.CONSTANTS.PUFFLEGG_TREX_PURPLE_ID : 
                    _local_1 = _sfx_trexHatch;
                    break;
                case com.clubpenguin.world.rooms2025.waddleon.WaddleOnParty.CONSTANTS.PUFFLEGG_STEGO_PINK_ID : 
                case com.clubpenguin.world.rooms2025.waddleon.WaddleOnParty.CONSTANTS.PUFFLEGG_STEGO_YELLOW_ID : 
                    _local_1 = _sfx_stegosaurusHatch;
                    break;
                default : 
                    return(undefined);
            }
            soundManager.playSoundAfterDelay(_local_1, _sfxLayer_puffle, 2, _local_2, playerID);
            return(undefined);
        }
