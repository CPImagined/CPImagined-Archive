//Created by Action Script Viewer - https://www.buraks.com/asv
    class com.clubpenguin.engine.avatar.effect.AvatarEffectEnum
    {
        ...
        static var SOCCER_FIRE_SHOES_EFFECT = new com.clubpenguin.engine.avatar.effect.AvatarEffectEnum(LIB_AVATAR_NAME, "fire_shoes", FLAG_ATTACH_TO_PLAYER);
        static var SOCCER_WATER_SHOES_EFFECT = new com.clubpenguin.engine.avatar.effect.AvatarEffectEnum(LIB_AVATAR_NAME, "water_shoes", FLAG_ATTACH_TO_PLAYER);
        static var SOCCER_WIND_SHOES_EFFECT = new com.clubpenguin.engine.avatar.effect.AvatarEffectEnum(LIB_AVATAR_NAME, "wind_shoes", FLAG_ATTACH_TO_PLAYER);
        static var SOCCER_LIGHTNING_SHOES_EFFECT = new com.clubpenguin.engine.avatar.effect.AvatarEffectEnum(LIB_AVATAR_NAME, "lightning_shoes", FLAG_ATTACH_TO_PLAYER);
        static var SOCCER_JOIN_ICON = new com.clubpenguin.engine.avatar.effect.AvatarEffectEnum(LIB_AVATAR_NAME, "soccerJoinIcon", FLAG_ATTACH_TO_PLAYER | FLAG_STOP_ON_LAST_FRAME);
