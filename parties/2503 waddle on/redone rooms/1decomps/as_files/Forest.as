    class as_files.Forest extends com.clubpenguin.world.rooms.BaseRoom
    {
        var _stage, localize, _SHELL, _destroyDelegate, wem, now, _currentParty, _checkTaskAvailableIntervalID, _abductionDelegate, _secondCheckIntervalID, _checkTargetDelegate, aliendAbduction, questionNumber, actualAnswer, acceptUserInput, playerAnswer;
        ...
        function exitPlaza() {
            trace(CLASS_NAME + ": exitPlaza()");
            _SHELL.sendJoinRoom("plaza", 620, 330);
        }
        function exitCove() {
            trace(CLASS_NAME + ": exitCove()");
            _SHELL.sendJoinRoom("cove", 260, 208);
        }
        function exitShack() {
            trace(CLASS_NAME + ": exitShack()");
            _SHELL.sendJoinRoom("shack", 200, 330);
        }
        function exitLake() {
            trace(CLASS_NAME + ": exitLake()");
        ...
        static var START_TASK_ID = 1;
        static var ONE_SECOND = 1000;
        var _TriviaBoardTurnedOn = false;
    }
