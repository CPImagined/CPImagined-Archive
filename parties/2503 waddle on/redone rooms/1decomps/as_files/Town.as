    class as_files.Town extends com.clubpenguin.world.rooms.BaseRoom
    {
        ...
        function Town (stageReference) {
            ...
            _stage.jacketStandee.jacketPickup_btn.onRelease = com.clubpenguin.util.Delegate.create(this, showJacketPrompt);
            _stage.pavilion_btn.onRelease = com.clubpenguin.util.Delegate.create(this, showJacketPrompt);
        }
        function showJacketPrompt() {
            _INTERFACE.showContent("w.app.p2017.dialogprompt.january.town.jacket", popupCallback, null, null, null, 17);
        }
