    ...
    {
        var _stage, localize, setupNavigationButtons, _setQuestBtnsIntervalID, registerScavengerHuntItem, _INTERFACE, _SHELL, _destroyDelegate, wem, _abductionDelegate, aliendAbduction;
        function Village (stageReference) {
            ...
            _stage.triggers_mc.mtn_mc.triggerFunction = com.clubpenguin.util.Delegate.create(this, exit, "mtn", 550, 220);
            ...
            _stage.triggers_mc.dock_mc.triggerFunction = com.clubpenguin.util.Delegate.create(this, exit, "dock", 232, 171);
        ...
        function setQuestBtns() {
            ...
            registerScavengerHuntItem("quest_2");
        }
