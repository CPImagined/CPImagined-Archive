    class com.clubpenguin.world.rooms.common.triggers.PlayerTrigger
    {
        ...
        function getBounds(mc) {
            ...
            if (DEBUG) {
                var _local_2 = _triggerArea.getBounds(mc);
                DEBUG_CANVAS2.lineStyle(1, 65535, 100);
                DEBUG_CANVAS2.moveTo(_local_2.xMin, _local_2.yMin);
                DEBUG_CANVAS2.lineTo(_local_2.xMax, _local_2.yMin);
                DEBUG_CANVAS2.lineTo(_local_2.xMax, _local_2.yMax);
                DEBUG_CANVAS2.lineTo(_local_2.xMin, _local_2.yMax);
                DEBUG_CANVAS2.lineTo(_local_2.xMin, _local_2.yMin);
            }
            if (mc) {
        ...
        function endSnapshot() {
            for (var _local_6 in _prevPlayerSnapshot) {
                ...
                if (((_prevPlayerSnapshot[_local_6] == STOPPED) || (_prevPlayerSnapshot[_local_6] == STANDING)) && (_playerSnapshot[_local_6] == STOPPED)) {
        ...
        function clothingRequirementMet(player) {
            ...
            while (_local_2 < _clothingRequirements.length) {
                if (!com.clubpenguin.world.rooms.common.triggers.ClothingRequirement(_clothingRequirements[_local_2]).isWornBy(player)) {
                    return(false);
                }
                _local_2++;
            }
