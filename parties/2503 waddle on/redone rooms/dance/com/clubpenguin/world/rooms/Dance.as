//Created by Action Script Viewer - https://www.buraks.com/asv
    class com.clubpenguin.world.rooms.Dance extends com.clubpenguin.world.rooms.BaseRoom
    {
        ...
        function Dance (stageReference) {
            ...
            setupNavigationButtons([new com.clubpenguin.world.rooms.common.NavigationButtonVO(_stage.background_mc.town_btn, 110, 245), new com.clubpenguin.world.rooms.common.NavigationButtonVO(_stage.background_mc.lounge_btn, 675, 255), new com.clubpenguin.world.rooms.common.NavigationButtonVO(_stage.corner_mc.boiler_btn, 505, 190), new com.clubpenguin.world.rooms.common.NavigationButtonVO(_stage.corner_mc.dance_mc.dance_btn, 545, 220), new com.clubpenguin.world.rooms.common.NavigationButtonVO(_stage.dj_mc.dj_btn, 350, 165)]);
        ...
        function musicService_getBroadcastMusicTracks_Handler(data) {
            ...
            if (_local_7 == undefined) {
                ...
                _stage.foreground_mc.tvscreenMC.playerNameLabel.text = String(_local_7);
