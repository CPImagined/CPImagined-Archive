//Created by Action Script Viewer - https://www.buraks.com/asv
    class com.clubpenguin.world.rooms2013.ninja.Dojo extends com.clubpenguin.world.rooms.BaseRoom
    {
        ...
        function exitSensei() {
			if (!_global.getCurrentParty().BaseParty.CURRENT_PARTY.getTaskComplete(4)) {
				_INTERFACE.showContent("w.app.p2025.waddleon.sensei");
				_stage.sensei_mc.bubble_mc._visible = false;
			} else {
