//Created by Action Script Viewer - https://www.buraks.com/asv
    class com.clubpenguin.world.rooms2012.common.triggers.TriggerWatcher
    {
        ...
        function TriggerWatcher (stageMC, shell) {
            if (!stageMC) {
                throw new Error("**ERROR** The trigger stageMC is undefined. Without a stage reference TriggerWatcher triggers will not fire.");
            }
        ...
        function addTrigger(triggerToAdd) {
            ...
            trace((("bounds.xMin: " + _local_10.xMin) + " bounds.xMax: ") + _local_10.xMax);
            ...
            trace((("TriggerWatcher.addTrigger x1: " + _local_9) + " x2: ") + _local_8);
            trace((("TriggerWatcher.addTrigger y1: " + _local_7) + " y2: ") + _local_6);
            ...
            while (_local_3 <= _local_8) {
                ...
                while (_local_2 <= _local_6) {
                    if (!_targetGrid[_local_3][_local_2]) {
                        var _local_4 = new com.clubpenguin.world.rooms2012.common.triggers.GridTile(_xOffset + (_local_3 * GRID_SIZE), _yOffset + (_local_2 * GRID_SIZE), GRID_SIZE, GRID_SIZE);
        ...
        function checkTriggers(object) {
            var _local_4 = _ENGINE.getPlayerMovieClip(object.player_id);
            var _local_3 = Math.floor(_local_4._x / GRID_SIZE);
            var _local_2 = Math.floor(_local_4._y / GRID_SIZE);
            trace((("x1:" + _local_3) + " y1:") + _local_2);
            if (_targetGrid[_local_3][_local_2]) {
                trace("found target");
                return(_targetGrid[_local_3][_local_2].hitTest(object, _local_4));
            }
        }
        function toString() {
