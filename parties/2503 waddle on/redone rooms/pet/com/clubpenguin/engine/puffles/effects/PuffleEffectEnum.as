//Created by Action Script Viewer - https://www.buraks.com/asv
    class com.clubpenguin.engine.puffles.effects.PuffleEffectEnum
    {
        ...
        function PuffleEffectEnum (_arg_2, _arg_3, _arg_4) {
            _assetPath = _arg_2;
            _layeringType = _arg_3;
            _effectTypeId = _arg_4;
        ...
        static function getPuffleEffectByTypeId(_arg_2) {
            var _local_1 = 0;
            while (_local_1 < PUFFLE_EFFECT_ENUMS_LIST.length) {
                if (_arg_2 == PUFFLE_EFFECT_ENUMS_LIST[_local_1].getEffectTypeId()) {
