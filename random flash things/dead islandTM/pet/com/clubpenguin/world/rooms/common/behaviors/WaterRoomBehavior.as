//Created by Action Script Viewer - https://www.buraks.com/asv
    class com.clubpenguin.world.rooms.common.behaviors.WaterRoomBehavior extends com.clubpenguin.world.rooms.common.behaviors.RoomBehavior implements com.clubpenguin.world.rooms.common.behaviors.IRoomBehavior
    {
        ...
        function applyEffect(_arg_4) {
            _playerId = _arg_4;
            _puffleModel = _SHELL.getPlayerObjectById(_arg_4).attachedPuffle;
            if (_puffleModel) {
                ...
                if (_local_3 < 1) {
                    ...
                    _loader = new com.clubpenguin.engine.puffles.animations.PuffleAnimationLoader(_arg_4, _puffleModel.id, _SHELL, _ENGINE, true);
        ...
        function onAnimationCompleted(_arg_4) {
            if (_isShowStatsBarWidget && (_SHELL.isMyPlayer(_arg_4.playerID))) {
