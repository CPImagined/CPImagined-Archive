//Created by Action Script Viewer - https://www.buraks.com/asv
    class com.clubpenguin.world.rooms2013.ninja.Dojo extends com.clubpenguin.world.rooms.BaseRoom
    {
        ...
        function init() {
			...
			_stage.interface_mc.shadow_btn.enabled = true;
        ...
        function configureTriggers() {
			...
			_stage.triggers_mc.shadowDojoTrigger_mc.triggerFunction = com.clubpenguin.util.Delegate.create(this, exit, "dojoext", 389, 350);
		...
		function handleGetNinjaRanks(event) {
			...
			if (event.playerID == _SHELL.getMyPlayerId() && event.firePathRank >= 5 && event.waterPathRank >= 5 && event.snowPathRank >= 13) {
				_stage.interface_mc.shadow_btn._visible = true;
				_stage.interface_mc.shadow_btn.enabled = true;
			}
		}
