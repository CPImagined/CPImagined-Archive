...
package com.clubpenguin.lib.vo
{
    ...
    public class EnvironmentDataVO 
    {
        ...
        public var baseConfigPath:String = "";
        ...
        {
            this._connectionID = ("testConnectionID_" + Math.floor((Math.random() * 0x0100)));
        ...
        public function setDataFromObject(obj:Object):void
        {
            ...
            this.baseConfigPath = ((obj.config) ? obj.config : this.baseConfigPath);
