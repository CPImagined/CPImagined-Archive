...
package com.clubpenguin.puffles.adoption.mediators
{
    ...
    public class CrystalAdoptionMediator extends Mediator 
    {
        ...
        [Inject]
        public var view:CrystalAdoptionView;
        [Inject]
        ...
        private var _puffleCongrats:CrystalCongratsView;
        ...
        {
            this.adoptionModel.setPuffleName(String(this.view.inputTextField.text));
            this._puffleCongrats = new CrystalCongratsView(EmbeddedAdoptionAssets.CrystalCongratsAsset);
