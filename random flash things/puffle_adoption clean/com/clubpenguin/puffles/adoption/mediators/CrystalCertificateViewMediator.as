...
package com.clubpenguin.puffles.adoption.mediators
{
    ...
    public class CrystalCertificateViewMediator extends Mediator 
    {
        ...
        [Inject]
        public var view:CrystalCongratsView;
        [Inject]
        ...
        private function replaceHeadline():void
        {
            ...
            var headlineTitleMC:MovieClip = this.view.crystalAdoptionCertificateTitle;
