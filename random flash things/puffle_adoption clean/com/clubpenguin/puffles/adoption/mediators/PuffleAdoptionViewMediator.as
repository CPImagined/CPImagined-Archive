...
package com.clubpenguin.puffles.adoption.mediators
{
    ...
    public class PuffleAdoptionViewMediator extends Mediator 
    {
        ...
        [Inject]
        public var view:PuffleAdoptionView;
        [Inject]
        ...
        {
            var puffleFrameLabel:String = ("puffle_" + String(this.adoptionModel.puffleAdoptionTypeId));
            this.view.getPuffleView.gotoAndStop(puffleFrameLabel);
        ...
        private function setupSelectedPuffle():void
        {
            ...
            var cost:uint;
            if (chosenPuffleVO.subType != null)
            {
                cost = puffleSubTypeEnum.price;
            }
            else
            {
                cost = puffleTypeEnum.price;
            };
            this.view.coinAmountText.text = "";
            this.view.coinGraphic.visible = false;
            if (cost > 0)
            {
                this.view.coinAmountText.text = String(cost);
                this.view.coinGraphic.visible = true;
            };
        }
        ...
        private function setupTextFields():void
        {
            ...
            this.localText.setText(this.view.errorFieldText, this.localization.getLocalizedString(this.ERROR_DESCRIPTION_TOKEN));
