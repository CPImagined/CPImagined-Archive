...
package com.clubpenguin.puffles.adoption.mediators
{
    ...
    public class SnowAdoptionMediator extends Mediator 
    {
        ...
        [Inject]
        public var view:SnowAdoptionView;
        [Inject]
        ...
        private var _puffleCongrats:SnowCongratsView;
        ...
        {
            this.adoptionModel.setPuffleName(String(this.view.inputTextField.text));
            this._puffleCongrats = new SnowCongratsView(EmbeddedAdoptionAssets.SnowCongratsAsset);
