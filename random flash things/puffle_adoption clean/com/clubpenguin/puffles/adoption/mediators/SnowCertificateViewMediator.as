...
package com.clubpenguin.puffles.adoption.mediators
{
    ...
    public class SnowCertificateViewMediator extends Mediator 
    {
        ...
        [Inject]
        public var view:SnowCongratsView;
        [Inject]
        ...
        private function replaceHeadline():void
        {
            ...
            var headlineTitleMC:MovieClip = this.view.snowAdoptionCertificateTitle;
