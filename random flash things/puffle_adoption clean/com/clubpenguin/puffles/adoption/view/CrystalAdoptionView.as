...
package com.clubpenguin.puffles.adoption.view
{
    ...
    public class CrystalAdoptionView extends BaseEmbeddedAssetView 
    {

        public const CRYSTAL_ADOPTION_VIEW:String = "crystalAdoption";

        public function CrystalAdoptionView(AssetClass:Class)
        {
            super(AssetClass, this.CRYSTAL_ADOPTION_VIEW);
        }
