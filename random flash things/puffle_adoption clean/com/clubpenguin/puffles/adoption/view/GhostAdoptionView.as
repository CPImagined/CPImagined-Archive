...
package com.clubpenguin.puffles.adoption.view
{
    ...
    public class GhostAdoptionView extends BaseEmbeddedAssetView 
    {

        public const GHOST_ADOPTION_VIEW:String = "ghostAdoption";

        public function GhostAdoptionView(AssetClass:Class)
        {
            super(AssetClass, this.GHOST_ADOPTION_VIEW);
        }
