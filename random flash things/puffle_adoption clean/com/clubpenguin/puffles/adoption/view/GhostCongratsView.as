...
package com.clubpenguin.puffles.adoption.view
{
    ...
    public class GhostCongratsView extends BaseEmbeddedAssetView 
    {

        public const GHOST_ADOPTION_CERTIFICATE:String = "ghostAdoptionCertificate";

        public function GhostCongratsView(AssetClass:Class)
        {
            super(AssetClass, this.GHOST_ADOPTION_CERTIFICATE);
        }
        ...
        public function get ghostAdoptionCertificateTitle():MovieClip
        {
