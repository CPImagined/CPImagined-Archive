...
package com.clubpenguin.puffles.adoption.view
{
    ...
    public class SnowCongratsView extends BaseEmbeddedAssetView 
    {

        public const SNOW_ADOPTION_CERTIFICATE:String = "snowAdoptionCertificate";

        public function SnowCongratsView(AssetClass:Class)
        {
            super(AssetClass, this.SNOW_ADOPTION_CERTIFICATE);
        }
        ...
        public function get snowAdoptionCertificateTitle():MovieClip
        {
