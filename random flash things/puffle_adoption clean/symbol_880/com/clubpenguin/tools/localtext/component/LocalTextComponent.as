...
package com.clubpenguin.tools.localtext.component
{
    ...
    public class LocalTextComponent extends UIComponent implements IFontLibraryDependant, ILocalTextComponent 
    {
        ...
        [Inspectable(name="debugColor", variable="debugColor", type="Color", defaultValue="00CC00")]
        ...
        [Inspectable(name="font", variable="font", type="List", defaultValue="cpBurbankSmall", enumeration="Candombe Cyr,Catseye Cyrillic Bold,Chantal Cyrillic Bold,Chantal Cyrillic Light,Chantal Cyrillic Medium,cpBurbankBgWdBold,cpBurbankSmall,cpBurbankSmallBold,cpBurbankSmallBoldItal,cpBurbankSmallItal,cpBurbankSmallLgt,cpBurbankSmallLgtItal,cpCCComicrazy,cpCCComicrazyBoldItal,cpFeltTipRoman,cpFeltTipRomanHvy,cpGeorgia,cpGeorgiaBold,cpGeorgiaBoldItal,cpGeorgiaItal,cpMyriadProBlkSmCnd,cpMyriadProBold,cpMyriadProItal,cpMyriadProReg,cpMyriadProSmBold,cpRasterGothTwelveCnd,cpRasterGothTwelveCndBold,cpRasterGothTwentyEightCnd,cpRasterGothTwentyEightCndBold,Draculon-Regular,Stopwatch,Stopwatch Italic,Structia Rg")]
        ...
        [Inspectable(name="groupName", variable="groupName", type="String", defaultValue="[none]")]
        ...
        [Inspectable(name="Horizontal Align", variable="textHorizontalAlignment", type="String", defaultValue="left", enumeration="center,left,right")]
        ...
        [Inspectable(name="size", variable="textSize", type="Number", defaultValue="12")]
        ...
        [Inspectable(name="text", variable="text", type="String", defaultValue="This is a Localized Textfield")]
        ...
        [Inspectable(name="text color", variable="textColor", type="Color", defaultValue="000000")]
        ...
        [Inspectable(name="token", variable="token", type="String", defaultValue="")]
        ...
        [Inspectable(name="Vertical Align", variable="textVerticalAlignment", type="String", defaultValue="center", enumeration="top,center,bottom")]
        ...
        [Inspectable(name="ltcFilters", type="String", defaultValue="")]
        ...
        [Inspectable(name="zrevision", variable="zrevision", type="String", defaultValue="v2.0.8")]
        ...
        [Inspectable(name="langControl", variable="langControl", type="Boolean", defaultValue="false")]
        ...
        [Inspectable(name="currentLang", variable="currentLang", type="String", defaultValue="en", enumeration="en,es,de,fr,pt,ru")]
        ...
        [Inspectable(name="wordWrapData", variable="wordWrapData", type="String")]
        ...
        [Inspectable(name="globalWordWrap", variable="globalWordWrap", type="Boolean", defaultValue="true")]
        ...
        [Inspectable(name="scalingData", variable="scalingData", type="String")]
        ...
        [Inspectable(name="globalScaling", variable="globalScaling", type="Boolean", defaultValue="false")]
        ...
        [Inspectable(name="minFontSizeData", variable="minFontSizeData", type="String")]
        ...
        [Inspectable(name="globalMinFontSize", variable="globalMinFontSize", type="Number", defaultValue="8")]
        ...
        [Inspectable(name="showBounds", variable="showBounds", type="Boolean", defaultValue="false")]
