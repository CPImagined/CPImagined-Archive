This folder contains files created by ASV (https://www.buraks.com/asv) that will help you rebuild a .FLA file for the SWF file "C:\Users\Devon\Desktop\SledRacer.swf". Flash CS6 is required. Please refer to ASV help for more information.

You need to do the following:

1- Run Flash and open the file "SledRacer_rebuild.fla" using File|Open command (at least Flash CS6 is required). (You can avoid this step by not selecting 'use relative paths' JSFL preference in ASV).
...
3 fonts saved. [If a saved font is not already installed on your system, open the saved font file by double-clicking on it (which will temporarily install the font), then keep the font file open during rebuild].

Warning: Converting html to plain text for Editable text 19 on frame 1 in movieclip 20.
Warning: Converting html to plain text for Editable text 54 on frame 1 in movieclip 58.
