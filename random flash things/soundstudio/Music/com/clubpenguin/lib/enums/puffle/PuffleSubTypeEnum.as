...
package com.clubpenguin.lib.enums.puffle
{
    ...
    public class PuffleSubTypeEnum extends Enum 
    {
        ...
        public static const GHOST_PUFFLE:PuffleSubTypeEnum = new PuffleSubTypeEnum(1022, 2, "ghost", "", true, true);
        public static const YELLOW_UNICORN_PUFFLE:PuffleSubTypeEnum = new PuffleSubTypeEnum(1020, 6, "yellowunicorn", "", true, true);
        public static const PURPLE_DEER_PUFFLE:PuffleSubTypeEnum = new PuffleSubTypeEnum(1019, 4, "purpledeer", "", true, true);
        public static const RED_DEER_PUFFLE:PuffleSubTypeEnum = new PuffleSubTypeEnum(1018, 5, "reddeer", "", true, true);
        public static const BLACK_DEER_PUFFLE:PuffleSubTypeEnum = new PuffleSubTypeEnum(1017, 2, "blackdeer", "", true, true);
        public static const BLUE_DEER_PUFFLE:PuffleSubTypeEnum = new PuffleSubTypeEnum(1016, 0, "bluedeer", "", true, true);
        public static const RED_RABBIT_PUFFLE:PuffleSubTypeEnum = new PuffleSubTypeEnum(1015, 5, "redrabbit", "", true, true);
        public static const WHITE_RABBIT_PUFFLE:PuffleSubTypeEnum = new PuffleSubTypeEnum(1014, 7, "whiterabbit", "", true, true);
        public static const PINK_RABBIT_PUFFLE:PuffleSubTypeEnum = new PuffleSubTypeEnum(1013, 1, "pinkrabbit", "", true, true);
        public static const GREEN_RABBIT_PUFFLE:PuffleSubTypeEnum = new PuffleSubTypeEnum(1012, 3, "greenrabbit", "", true, true);
        public static const BLUE_RACCOON_PUFFLE:PuffleSubTypeEnum = new PuffleSubTypeEnum(1011, 0, "blueraccoon", "", true, true);
        public static const PINK_RACCOON_PUFFLE:PuffleSubTypeEnum = new PuffleSubTypeEnum(1010, 1, "pinkraccoon", "", true, true);
        public static const ORANGE_RACCOON_PUFFLE:PuffleSubTypeEnum = new PuffleSubTypeEnum(1009, 8, "orangeraccoon", "", true, true);
        public static const GREEN_RACCOON_PUFFLE:PuffleSubTypeEnum = new PuffleSubTypeEnum(1008, 3, "greenraccoon", "", true, true);
