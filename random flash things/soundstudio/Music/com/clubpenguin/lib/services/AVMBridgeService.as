...
package com.clubpenguin.lib.services
{
    ...
    import com.clubpenguin.lib.services.bi.RawBiService;
    ...
    public class AVMBridgeService extends Actor implements IAVMBridgeService 
    {
        ...
        [Inject]
        public var rawBIService:RawBiService;
        [Inject]
        ...
        public function messageFromAS2(messageObject:Object):void
        {
            ...
            switch (messageObject.type)
            {
                ...
                case AVMBridgeMessage.MSG_START_ASSET_LOAD:
                    ...
                    break;
                case AVMBridgeMessage.MSG_END_ASSET_LOAD:
                    Signal(this.signalBus.getTrackerEvent()).dispatch(messageObject, AVMBridgeMessage.MSG_END_ASSET_LOAD);
                    break;
                case AVMBridgeMessage.MSG_START_SUBCONTEXT_ASSET_LOAD:
                    Signal(this.signalBus.getTrackerEvent()).dispatch(messageObject, AVMBridgeMessage.MSG_START_SUBCONTEXT_ASSET_LOAD);
                    break;
                case AVMBridgeMessage.MSG_END_SUBCONTEXT_ASSET_LOAD:
                    Signal(this.signalBus.getTrackerEvent()).dispatch(messageObject, AVMBridgeMessage.MSG_END_SUBCONTEXT_ASSET_LOAD);
                    break;
                case AVMBridgeMessage.MSG_TRACK_GAME_ACTION:
                    Signal(this.signalBus.getTrackerEvent()).dispatch(messageObject, AVMBridgeMessage.MSG_TRACK_GAME_ACTION);
                    break;
                case AVMBridgeMessage.MSG_LOG_ERROR:
                    Signal(this.signalBus.getTrackerEvent()).dispatch(messageObject, AVMBridgeMessage.MSG_LOG_ERROR);
                    break;
                case AVMBridgeMessage.MSG_LOG_MOVIECLIP_LOAD_TIMEOUT:
                    Signal(this.signalBus.getTrackerEvent()).dispatch(messageObject, AVMBridgeMessage.MSG_LOG_MOVIECLIP_LOAD_TIMEOUT);
                    break;
                case AVMBridgeMessage.MSG_LOG_MOVIECLIP_LOAD_ERROR:
                    Signal(this.signalBus.getTrackerEvent()).dispatch(messageObject, AVMBridgeMessage.MSG_LOG_MOVIECLIP_LOAD_ERROR);
                    break;
                case AVMBridgeMessage.MSG_TRACK_LOGIN_ERROR:
                    Signal(this.signalBus.getTrackerEvent()).dispatch(messageObject, AVMBridgeMessage.MSG_TRACK_LOGIN_ERROR);
                    break;
                case AVMBridgeMessage.MSG_SEND_PLAYDOM_TRACKING:
                    Signal(this.signalBus.getTrackerEvent()).dispatch(messageObject, AVMBridgeMessage.MSG_SEND_PLAYDOM_TRACKING);
                    break;
