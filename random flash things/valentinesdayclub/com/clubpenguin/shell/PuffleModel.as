class com.clubpenguin.shell.PuffleModel
{
    ...
    {
        var _loc2 = isNaN(puffleSubTypeID) || puffleSubTypeID == 0 ? ("") : (String(puffleSubTypeID));
        assetURL = com.clubpenguin.util.StringUtils.replaceString("%color%", String(puffleColor), assetURL);
        assetURL = com.clubpenguin.util.StringUtils.replaceString("%wildTypeId%", String(_loc2), assetURL);
        return (assetURL);
    } // End of the function
    var id = -1;
    var typeID = -1;
