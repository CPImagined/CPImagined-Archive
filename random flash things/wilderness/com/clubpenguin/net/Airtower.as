class com.clubpenguin.net.Airtower
{
    ...
    function handleOnLogin(serverResponse)
    {
        ...
        _loc9.type = 15;
        _loc9.playerSWID = loginObject.swid;
        _loc9.playerID = loginObject.playerID;
        shell.sendPlaydomTracking(_loc9);
        this.on_login_response(true);
        is_logged_in = true;
        com.clubpenguin.login.LoginFloodManager.clearFloodControl();
        var _loc10 = shell.getLanguageBitmask();
        com.clubpenguin.util.Log.debug("\t-loginObject.languageRejected: " + loginObject.languageRejected);
        com.clubpenguin.util.Log.debug("\t-lang: " + _loc10);
        com.clubpenguin.util.Log.debug(" -loginObject.languageRejected & lang: " + loginObject.languageRejected + _loc10);
        if (loginObject.languageRejected & _loc10)
        {
