class com.clubpenguin.party.BaseParty
{
    ...
    {
        com.clubpenguin.party.BaseParty.pebug("PARTY ICON STATE");
    ...
    {
        var _loc1 = {message: messageString};
